...
path_downloads='C:\Users\jlyma\CIMAR Dropbox\John Lyman\PC\Downloads\';
...
lat=lat_tpx;
lon=lon_tpx;
save([path_downloads,'greg_0_2000_ohca_2020.mat'],'ohca_0_2000','lat','lon','-v7.3')
...
% % %     subplot(3,1,2)
% % %     
% % %     load([path_tree,'error_var_mean_0_700_combined_2021.mat'], 'time_aviso', ...
...
% % %     eval(['print -dpng -r600 -f1 ',path_figs,'oco_heat_tree_error_new2_publish_',num2str(year_of_oco_pub),'_for_',num2str(fyear)])
