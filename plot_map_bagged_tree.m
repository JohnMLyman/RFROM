...
%     save 'OHCA_2019_tpx.mat' lon lat corrhc
    ...
    hold on
    m_coast('patch',[1 1 1]);
    t1=m_text(30,100,['(b) ' num2str(syear) ' minus ' num2str(fyear)],'fontsize',12);
 ...
 greg_map_hc_20_year_tree_scatter_plot_oco_tuna
    ...
    eval(['print -dpng -f1 ',path_figs,'oco_heat_tree_publish_',num2str(year_of_oco_pub),'_for_',num2str(fyear)])
