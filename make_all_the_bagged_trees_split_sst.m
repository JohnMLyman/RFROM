...
% baggedtree_hold_out_all_year_seasonal_split_sst(TreeSetUp)
read_ssh_matfiles_all_year_seasonal_split_sst(TreeSetUp)
make_seasonal_cycle_tree_split_sst(TreeSetUp)
make_model_stats_all_year_seasonal_split(TreeSetUp)


% % % % %% Make the yearlly anomally tree
% % % % 
% % % % baggedtree_hold_out_yearly_overlap_seasonal_anom_split_sst(TreeSetUp)
% % % % read_ssh_matfiles_yearly_overlap_seasonal_anom_split_sst(TreeSetUp)
% % % % make_model_stats_yearly_overlap_seasonal_anom_split_sst(TreeSetUp)


%% Make the anomaly tree for all years

baggedtree_hold_out_all_years_seasonal_anom_split_sst(TreeSetUp)
read_ssh_matfiles_all_years_seasonal_anom_split_sst(TreeSetUp)
make_model_stats_all_years_seasonal_anom_split_sst(TreeSetUp)

% % 
% % %% Make combines ohca maps for all_years and yearly
% % 
% % 
bagged_tree_ohca_combine_split_sst(TreeSetUp)
% % 
% % 
% % %% make asses the error
% % % 
% % make_error_holdout_estimate_files_yearly_season_anom_split_sst(TreeSetUp)
% % make_error_holdout_files_all_years_season_anom_split_sst(TreeSetUp)
% % 
% % % 
...
% % bagged_tree_ohca_curve_7_day_error_weight_split(TreeSetUp)
% % 
% % 
...
% % 
make_bagged_tree_ohca_maps_7_day_seasonal_split(TreeSetUp)

% % % % % make the curve

bagged_tree_ohca_curve_7_day_with_cycle_combined_split(TreeSetUp)
% % 
