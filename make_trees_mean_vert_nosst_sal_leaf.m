function [model_all]=make_trees_mean_vert_nosst_sal_leaf(use,ht_use,tpx,temp_use,ht_perdict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,large_scale,leaf_base)
...
ntree_fact=ntree_fact.*leaf_base./10;
