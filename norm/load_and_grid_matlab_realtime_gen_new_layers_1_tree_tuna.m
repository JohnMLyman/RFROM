...
function [iyear]=load_and_grid_matlab_realtime_gen_new_layers_1_tree_tuna(file_path,file_name,tree_model_file_name,depth_layer,lat_grid,lon_grid,time_grid)
...
eval(['save ',file_path,file_name_out,'_',depth_layer,'_tree.mat ht htdiff htdiff_tree tpx one lon lat time'])
