function [TreeSetUp]=TreeSetUp_2023_orca_heat_novert_test_NCAR_paige
nbasins_use=[1:10];
...
file_WOD_suf=[];
var_type='h';
tree_prefix='tree_heat_novert_NCAR_paige';% change to 'tree_heat_vert_Karina' if you change the layers

% tree_prefix='tree_temp_vert_nosshsst';
path_ERDDAP='L:\erddap\heat_novert_paige';
path_Figs='L:\Figs\OHC\';
path_Fig_data='L:\Figs\OHC\data\';
...
file_name_season_anom=[file_name_season,'_anom_paige'];% change if you change the method to make the seasonal cycle
...
path_new_tree_all_year_season=[path_tree,tree_model_file_name_all_year_season,'\'];
...
path_new_tree_combined_withcycle=[path_tree,'all_year_withcycle\'];
...
max_year_fit=2018;% keep these away from the ends of start_year_mean and end_year mean wo theat you have overlaping years to compute the mean from.
min_year_fit=2010;
...
TreeSetUp.tree_model_file_name_all_year_season=tree_model_file_name_all_year_season;
...
TreeSetUp.path_new_tree_all_year_season=path_new_tree_all_year_season;
