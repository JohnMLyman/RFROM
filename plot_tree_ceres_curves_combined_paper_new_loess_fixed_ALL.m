...
path_figs='C:\data\OHCA\figs\tree_paper\';
 path_file='C:\Users\jlyma\OneDrive - University of Hawaii\data\OHCA\OPEN\';
...
load([path_figs,'tree_gilson_ceres_rate.mat'])
...
% corr(toa_gilson(plot_pos_gilson_year),gilson_rate_year_no_cycle(plot_pos_gilson_year))
 ...
 eval(['print -dpng -r600 -f1 ',path_figs,'toa_tree_',name_comp_all,'_ceres2_loess'])
...
path_figs='C:\data\OHCA\figs\tree_paper\'
 eval(['print -dpng -r600 -f2 ',path_figs,'toa_tree_',name_comp_all,'_ceres_cycle_new_loess'])
