function [TreeSetUp]=TreeSetUp_2024_orca_heat_novert_test_mid_paige_final
nbasins_use=[1:10];
...
var_type='h';
tree_prefix='tree_heat_novert_test';% change to 'tree_heat_vert_Karina' if you change the layers

% tree_prefix='tree_temp_vert_nosshsst';
path_ERDDAP='H:\erddap\heat_novert_paige_final';
