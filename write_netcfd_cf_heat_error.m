function []=write_netcfd_cf_heat_error(ht_error,lon_tpx,lat_tpx,time_aviso,...
...
%     good=[100 200 300];
    ...
    ohca_att(2).Value=ohca_error_description;
    
    mySchema.Variables(4).Name='ocean_heat_content_anomaly_error';
    ...
    ncwrite(file,'ocean_heat_content_anomaly_error',ht_error_out,[1,1,1]);  
