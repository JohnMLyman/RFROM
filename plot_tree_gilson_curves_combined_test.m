...
good_gilson_cycle=find(time_gilson>=min_year_cycle );
...
good_all=find(tgrid_all>=min_year & tgrid_all<=max_year & isfinite(ht_curve_all'));
 ...
 good_all_cycle=find(tgrid_all>=min_year_cycle   );
...
path_figs='C:\data\OHCA\figs\tree_paper\'
 eval(['print -dpng -r600 -f7 ',path_figs,'curve_tree_gilson_new_m2_test'])

pos_warm_pmel=time_pmel>2008;
 [warming_rate_pmel]=compute_warming_no_weight_3(ohca_pmel(pos_warm_pmel)'./10,hc_one_deep(pos_warm_pmel)'/1000,time_pmel(pos_warm_pmel));

 pos_warm_tree=time_tree_all>2008;
 [warming_rate_tree]=compute_warming_no_weight_3(ht_all_no_cyce(pos_warm_tree)./(10.*1e21),ht_all_no_cyce(pos_warm_tree)/(1e21.*1000),time_tree_all(pos_warm_tree));

 pos_warm_gilson=time_gilson>2008;
 [warming_rate_gilson]=compute_warming_no_weight_3(ht_gilson_no_cyce(pos_warm_gilson)'./(10.*1e21),ht_gilson_no_cyce(pos_warm_gilson)'/(1e21.*1000),time_gilson(pos_warm_gilson)');


  pos_warm_tree=time_tree_all>1993 &time_tree_all<2005;
 [warming_rate_tree_preargo]=compute_warming_no_weight_3(ht_all_no_cyce(pos_warm_tree)./(10.*1e21),ht_all_no_cyce(pos_warm_tree)/(1e21.*1000),time_tree_all(pos_warm_tree));
 ...
 %%
 pos_warm_pmel=time_pmel>=2008.5 & time_pmel<=2021.5;
 [warming_rate_pmel]=compute_warming_no_weight_3(ohca_pmel(pos_warm_pmel)'./10,hc_one_deep(pos_warm_pmel)'/1000,time_pmel(pos_warm_pmel));
 

 pos_warm_tree=time_tree_all>=2008.5 & time_tree_all<2021.5;
 [warming_rate_tree]=compute_warming_no_weight_3(ht_all_year_no_cyce(pos_warm_tree)./(10.*1e21),ht_all_no_cyce(pos_warm_tree)/(1e21.*1000),time_tree_all(pos_warm_tree));

 pos_warm_gilson=time_gilson>=2008.5 & time_gilson<=2021.5;
 [warming_rate_gilson]=compute_warming_no_weight_3(ht_gilson_year_no_cyce(pos_warm_gilson)'./(10.*1e21),ht_gilson_no_cyce(pos_warm_gilson)'/(1e21.*1000),time_gilson(pos_warm_gilson)');
warming_rate_gilson
warming_rate_pmel
warming_rate_tree

 %%
 pos_warm_pmel=time_pmel>1993.5 & time_pmel<=2021.5;;
 [warming_rate_pmel]=compute_warming_no_weight_3(ohca_pmel(pos_warm_pmel)'./10,hc_one_deep(pos_warm_pmel)'/1000,time_pmel(pos_warm_pmel));

 pos_warm_tree=time_tree_all>1993.5 & time_tree_all<2021.5;;
 [warming_rate_tree]=compute_warming_no_weight_3(ht_all_year_no_cyce(pos_warm_tree)./(10.*1e21),ht_all_no_cyce(pos_warm_tree)/(1e21.*1000),time_tree_all(pos_warm_tree));
% 
%  pos_warm_gilson=time_gilson>1993.5 & time_tree_all<2021.5;;
%  [warming_rate_gilson]=compute_warming_no_weight_3(ht_gilson_year_no_cyce(pos_warm_gilson)'./(10.*1e21),ht_gilson_no_cyce(pos_warm_gilson)'/(1e21.*1000),time_gilson(pos_warm_gilson)');
...
warming_rate_tree
 ...
 %%
 pos_warm_pmel=time_pmel>1993.5 & time_pmel<=2008.5;;
 [warming_rate_pmel]=compute_warming_no_weight_3(ohca_pmel(pos_warm_pmel)'./10,hc_one_deep(pos_warm_pmel)'/1000,time_pmel(pos_warm_pmel));

 pos_warm_tree=time_tree_all>1993.5 & time_tree_all<2008.5;;
 [warming_rate_tree]=compute_warming_no_weight_3(ht_all_year_no_cyce(pos_warm_tree)./(10.*1e21),ht_all_no_cyce(pos_warm_tree)/(1e21.*1000),time_tree_all(pos_warm_tree));
% 
%  pos_warm_gilson=time_gilson>1993.5 & time_tree_all<2021.5;;
%  [warming_rate_gilson]=compute_warming_no_weight_3(ht_gilson_year_no_cyce(pos_warm_gilson)'./(10.*1e21),ht_gilson_no_cyce(pos_warm_gilson)'/(1e21.*1000),time_gilson(pos_warm_gilson)');
