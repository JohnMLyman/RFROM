...
argo_2023_03_23_QC_press_temp_NCAR_profile_data
argo_2023_03_23_QC_press_temp_NCAR_profile_metadata
...
file_path_NCAR=[file_path_out,'NCAR\'];
file_name_NCAR=[file_path_NCAR,file_name,'_temp_NCAR_profile_metadata.mat'];

if ~exist(file_path_NCAR,'dir')
    mkdir(file_path_NCAR)
end
...
OcoSetUp.file_name_NCAR=file_name_NCAR;
...
mapdiff_seasonal_orca_temp_NCAR(OcoSetUp)
