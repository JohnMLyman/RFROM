...
file_sum_name=[path_tree,'greg_seasonal_cycle_2000_minus_max_maps_sum.mat'];
...
if ~exist(file_sum_name,'file')
    ...
    period5=1/5;
    period6=1/6;
     time_aviso=[1/365:1/365:1];
     tbig=reshape(time_aviso,[1,1,365]);
...
v=VideoWriter([path_figs,'ohca_greg_cycle.avi']);
open(v)
...
%     save 'OHCA_2019_tpx.mat' lon lat corrhc
    ...
    hold on
    m_coast('patch',[1 1 1]);
    t1=m_text(30,100,[' ', num2str(time_aviso(iframe)*12+1)],'fontsize',12);
