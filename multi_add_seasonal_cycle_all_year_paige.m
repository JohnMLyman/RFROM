function []=multi_add_seasonal_cycle_all_year_paige(TreeSetUp)
...
parfor year_load=time_ssh_load
    ...
    for ilayer=2:nlayer
        ...
        parsave_tree_year([path_new_tree_withcycle,tree_file_name_out_withcycle,'_split_7day.mat'] ,ht_estimate_year,lon_tpx, lat_tpx,time_aviso)
    end
end
