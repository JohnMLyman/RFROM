function []=multi_write_nc_monthly_sal_yearly_mean_t_nossh_nolatlon(TreeSetUp)
...
path_mat_erddap=[path_ERDDAP,'matlab\yearly_mean_t_nossh_nolatlon\'];
path_nc_erddap=[path_ERDDAP,'netcdf\yearly_mean_t_nossh_nolatlon\'];
