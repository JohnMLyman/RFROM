function baggedtree_hold_out_yearly_overlap_seasonal_anom_split_hyp(TreeSetUp)
...
path_new_tree_hyp=[path_hyp,tree_model_file_name,'\'];
...
if ~exist(path_new_tree_hyp,'dir')
    mkdir(path_new_tree_hyp)
end
...
% 
%             file_hold_out=[path_new_tree_hyp,tree_model_file_name,'_hold_out_data_',layer_name,'_split.mat'];
%             
%             
%             
...
%         end
    ...
    for nleaf=[5 10 15 20]
    
        test_tree_year_mean_split_hyp
        
        file_big_model=[path_new_tree_hyp,tree_model_file_name,'_model_',layer_name,'_',year_file_name,...
            '_leaf',num2str(nleaf),'_split.mat']
...
%         save(file_compact_model,'compact_model_all','-v7.3')
        save(file_big_model,'model_all','nleaf','-v7.3')
