...
ht_estimate_mean_john=ht_estimate_mean;

ht_estimate_mean=(ht_estimate_mean_john-ht_estimate_mean_greg);
%%


v=VideoWriter([path_figs,'tree_a16_sal_greg_diff_john.avi']);
v.FrameRate = 10;
open(v)
