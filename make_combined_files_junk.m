function make_combined_files_junk(TreeSetUp)
...
load([path_new_tree_yearly,tree_file_name_in_yearly,'_split_7day.mat'] ,'lon_tpx', 'lat_tpx')
...
% for year_load=time_load
    ...
    for ilayer=2:2
        ...
        file_all_year_extra=[path_new_tree_all_year,tree_file_name_in_all_years,'_extra_split_7day_junk.mat'];
        file_yearly=file_all_year_extra;

%         file_yearly=[path_new_tree_yearly,tree_file_name_in_yearly,'_split_7day.mat'];
        file_combine=[path_new_tree_combined,tree_file_name_out_combine,'_split_7day_junk.mat'];
