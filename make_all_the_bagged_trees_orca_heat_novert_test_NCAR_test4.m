...
baggedtree_hold_out_all_years_orca_novert_NCAR(TreeSetUp)
toc./60./60

'read_ssh_matfiles_all_years_orca_novert'
read_ssh_matfiles_all_years_orca_novert_NCAR(TreeSetUp)
toc./60./60
...
% % % toc./60./60
%% Make the anomaly tree for all years paige
% 
% % Clear out the junkdir
% 'Delete Junk directory'
% delete([TreeSetUp.path_tree_junk,'*.mat']);
