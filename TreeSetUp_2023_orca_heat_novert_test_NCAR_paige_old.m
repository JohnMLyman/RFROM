function [TreeSetUp]=TreeSetUp_2023_orca_heat_novert_test_NCAR_paige_old
nbasins_use=[1:10];
...
file_WOD_suf=[];
var_type='h';
tree_prefix='tree_heat_novert_paige';% change to 'tree_heat_vert_Karina' if you change the layers

% tree_prefix='tree_temp_vert_nosshsst';
path_ERDDAP='L:\erddap\heat_novert';
