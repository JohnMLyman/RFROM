function [ohca,depth]=grab_ohca_meantemp_vert(year_grab)

tic
pathvert='J:\tree_temp_vert\t_trees\tree_temp_vert_yearly_overlap_seasonal\';
...
ohca=[];
 for ilayer=2:nlayers
      ...
      load([pathvert,'tree_temp_vert_yearly_overlap_seasonal_',layer_name,'_',num2str(year_grab),'_split_7day.mat'],'ht_estimate_year')
