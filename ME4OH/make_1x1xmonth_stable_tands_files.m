function []=make_1x1xmonth_stable_tands_files(TreeSetUp)
...
file_name_nc_sal_stable_junk= [path_nc_erddap_sal_stable,'RFROM_SAL_STABLE_2000_05.nc'];
...
write_netcfd_cf_temp_pressure_mon_single(temp_out,time_out,lon_out,...
