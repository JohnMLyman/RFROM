function interptpx_seasonal_orca_heat_NCAR(OcoSetUp)
...
fname_nc=[file_path_hdata,'hdata_new_layers_',file_WOD_suf,'_',file_name_season,'.mat'];

%%



eval(['load ',fname_nc,' yr coords layer_bounds_NCAR_out ',h_var_name])
...
eval(['save ',fname_nc,' tpx yr coords layer_bounds_NCAR_out ',h_var_name])
