...
file_name='ofam3_EN4';
OUTOUT_type='\ME4OH_2023';% could change to 'Karina_2023'
...
file_WOD_suf=['mask'];
var_type='h';
tree_prefix='tree_heat_vert_mask';% change to 'tree_heat_vert_Karina' if you change the layers

% tree_prefix='tree_temp_vert_nosshsst';
path_ERDDAP='H:\ME4OH\heat_vert_mask';
