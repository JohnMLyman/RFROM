function []=write_netcfd_cf_heat_ME4OH_file(ht_estimate,time_1900,lon_tpx,...
    lat_tpx,mean_depth,mean_depth_bnds,start_mean,end_mean,file_name_nc)
    
% time [days since 1900-01-01 00:00:00] CMEMS time I should convert all
% % times to this
% 
...
% sday=days_since_1900+datenum(1900,1,1);
...
%     
    ...
    time_att(1).Value='days since 1900-1-1 0:0:0';
    time_att(2).Name='Description';
    time_att(2).Value='Time in days since January 1st 1900';
...
%     ncwrite(file,'mean_depth_bnds',mean_depth_bnds,[1,1]);
    ncwrite(file,'DATA',ht_estimate,[1,1,1]);  
