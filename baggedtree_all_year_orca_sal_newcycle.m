function baggedtree_all_year_orca_sal_newcycle(TreeSetUp)
...
% for ilayer=2:nlayer
       ...
       layer_offset=layer_off_all_junk{ilayer-1};
        ...
        if ilayer==2
            ...
            [model_all]=make_trees_mean_nosst_sal(use,ht_use,temp_use,sst,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d');
