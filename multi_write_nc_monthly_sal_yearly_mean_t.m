function []=multi_write_nc_monthly_sal_yearly_mean_t(TreeSetUp)
...
path_mat_erddap=[path_ERDDAP,'matlab\yearly_mean_t\'];
path_nc_erddap=[path_ERDDAP,'netcdf\yearly_mean_t\'];
