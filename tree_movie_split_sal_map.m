...
%%
 ...
 % put into the proper coordinates
    ...
    min_val=34;
    max_val=37.5;
v=VideoWriter([path_figs,'tree_sal_map_surface_nosst.avi']);
v.FrameRate = 10;
open(v)
...
%%     
b=figure(1);
set(b, 'Position', [100 100 1200 900])
clf
...
%     del_cont=.25./scale_fac;
    ...
    m_proj('Equidistant cylindrical','long',[280 390],'lat',[-80 65]);
    %colormap(fresh_to_salty_colormap) 
