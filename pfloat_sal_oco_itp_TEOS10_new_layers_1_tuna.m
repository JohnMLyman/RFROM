...
for ilayer=2:length(layer_bounds)
     ...
     eval(['sal_',num2str(layer_bounds(ilayer-1)),'_',num2str(layer_bounds(ilayer)),'=ones(np,1)*NaN;'])
...
tic
                     ...
                     [sal_junk,temp_junk]=compute_depth_sal_depth_range_teos10_2016_tuna(data,sal_junk,temp_junk,coords,layer_bounds(ilayer-1),layer_bounds(ilayer));
