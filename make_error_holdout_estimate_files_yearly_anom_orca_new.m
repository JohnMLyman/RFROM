function []=make_error_holdout_estimate_files_yearly_anom_orca_new(TreeSetUp)
...
%    layer_name=[num2str(layer_bounds(ilayer-1)),'_',num2str(layer_bounds(ilayer))];
%  
%   filename_junk=[path_tree_junk,tree_model_file_name,'_hold_out_estiamte_split_',layer_name,'.mat'];
%    
%    load(filename_junk,'hold_out_mat','ht_estimate','ht_hold_out')
%    delete(filename_junk)
%    
