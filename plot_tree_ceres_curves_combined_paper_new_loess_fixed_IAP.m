...
path_figs='C:\data\OHCA\figs\tree_paper\';
 path_file='C:\Users\jlyma\OneDrive - University of Hawaii\data\OHCA\IAP\';
...
% % IAP is smoothed at 3 months so
ht_gilson_qu=ht_gilson_res+model_gilson'-mean_gilson-slope_gilson.*center_year_gilson;
ht_gilson_qu_no_cycle=ht_gilson_res+(time_gilson-center_year_gilson).*slope_gilson';
...
% % IAP is smoothed at 3 months so
% time_gilson_rate_qu=time_gilson_rate;
% gilson_rate_qu=gilson_rate;
% gilson_rate_qu_no_cycle=gilson_rate_no_cycle;
