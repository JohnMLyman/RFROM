...
save ([path_tree_junk,'junk_ssh.mat'],'ssh_total','sst_total','time_aviso','-v7.3')
...
for ilayer=2:2
    ...
    eval(['save -v7.3 ',path_tree,tree_file_name,'_7day_test3.mat ht_estimate lon_tpx lat_tpx time_aviso'])
