...
function contour_mean_sal_no_label_WOA2023_tuna
path_woa2013v2='D:\WOA2013v2\';
path_woa2023='C:\data\WOA2023\';
...
lat=ncread([path_woa2023,'woa23_decav_s00_01.nc'],'lat');
lon=ncread([path_woa2023,'woa23_decav_s00_01.nc'],'lon');
depth=ncread([path_woa2023,'woa23_decav_s00_01.nc'],'depth');
sal=ncread([path_woa2023,'woa23_decav_s00_01.nc'],'s_an');
