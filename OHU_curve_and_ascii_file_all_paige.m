function OHU_curve_and_ascii_file_all_paige(TreeSetUp,min_depth,max_depth)
...
curve_name=['curve_',tree_prefix,'_',depth_range_name,'_ohca_nomean_',OUTOUT_type,'_test.mat'];
file_new=[path_Fig_data,curve_name];

file_txt=[path_Fig_data,'RFROMv21_OHU_',num2str(end_year.*10),'_all_Paige.txt'];
...
good_tree=tgrid_rate_12mon>=1993.5;
