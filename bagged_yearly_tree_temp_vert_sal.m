function [ht_estimate]=bagged_yearly_tree_temp_vert_sal(iyear_mod,...
                time_aviso,temp_use,...
 ...
 if ibasin<= n_mod_basin
     ...
     if ~isempty(M)
        ...
        jw=repmat(weight_cross(pos_2d),nfiles,1);
            ...
            good=isfinite(jyr) & good_yr&isfinite(jhtvert);
            pos_use=find(pos_3d);
            pos_3d_use=pos_3d;
            ...
            input_mat(:,4)=jhtvert(good);
            input_mat(:,5)=jtemp(good);
            jw_use=jw(good);
