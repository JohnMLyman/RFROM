...
var_type='s';
tree_prefix='tree_sal_greg_atlatic';
...
baggedtree_hold_out_yearly_overlap_seasonal_split_new_sal_greg(TreeSetUp)
multi_write_mat_monthly_temp_mean_t(TreeSetUp)
read_ssh_matfiles_yearly_overlap_seasonal_split_new_sal_greg(TreeSetUp)
...
% 
baggedtree_hold_out_yearly_overlap_seasonal_anom_split_new_sal(TreeSetUp)
read_ssh_matfiles_yearly_overlap_seasonal_anom_split_new_sal(TreeSetUp)
