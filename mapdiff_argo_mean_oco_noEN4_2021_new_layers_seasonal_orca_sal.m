function mapdiff_argo_mean_oco_noEN4_2021_new_layers_seasonal_orca_sal(OcoSetUp)
...
eval(['load ',file_path_out,'allsal_new_layers_argo_noEN4_new_',file_name_season,...
...
fname_nc=[file_path_hdata,'sdata_new_layers_noEN4_',file_WOD_suf,'_',file_name_season];
