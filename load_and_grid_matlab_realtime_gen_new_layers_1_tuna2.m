...
function [iyear]=load_and_grid_matlab_realtime_gen_new_layers_1(file_path,file_name,depth_layer,lat_grid,lon_grid,time_grid)

eval(['load ',file_path,file_name,' htdiff_',depth_layer,' tpx yr coords ht_',depth_layer])
...
%     data(:,2)=htdiff_100(good_data);
    ...
    [data_grid]=objective_map_annual_tuna2(lon_grid,lat_grid,data,cds_junk);
...
eval(['save ',file_path,file_name_out,'_',depth_layer,'_real_new_layers ht htdiff tpx one lon lat time'])
