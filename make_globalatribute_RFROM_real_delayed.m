function [globalat]=make_globalatribute_RFROM_real_delayed()
    ...
    globalat(2).Value='RFROM v2.1 Real Time and Delayed Mode';
    globalat(3).Name='institution';
    globalat(3).Value='NOAA PMEL, CIMAR';
    globalat(4).Name='source';
    globalat(4).Value='Argo float data, EN4.2.2, CMEMES SSH, NOAA OI SST V2';
    ...
    globalat(6).Value='02/01/2023 v2.1';
