...
% % % toc./60./60
% % % baggedtree_hold_out_yearly_overlap_seasonal_orca_vert(TreeSetUp)
% % % 'read_ssh_matfiles_yearly_overlap_seasonal_orca'
% % % read_ssh_matfiles_yearly_overlap_seasonal_orca_vert(TreeSetUp)
% % % toc./60./60
...
% % % make_model_stats_yearly_overlap_seasonal_split_orca_vert(TreeSetUp)
% % % toc./60./60
% % % 
% % % 
...
% % % baggedtree_hold_out_yearly_overlap_seasonal_anom_orca_vert(TreeSetUp)
% % % toc./60./60

'read_ssh_matfiles_yearly_overlap_seasonal_anom_vert'
read_ssh_matfiles_yearly_overlap_seasonal_anom_orca_vert(TreeSetUp)
toc./60./60
