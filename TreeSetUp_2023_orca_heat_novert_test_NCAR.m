function [TreeSetUp]=TreeSetUp_2023_orca_heat_novert_test_NCAR
nbasins_use=[1:10];
...
file_WOD_suf=[];
var_type='h';
tree_prefix='tree_heat_novert_NCAR';% change to 'tree_heat_vert_Karina' if you change the layers
