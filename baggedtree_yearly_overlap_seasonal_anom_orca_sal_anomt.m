function baggedtree_yearly_overlap_seasonal_anom_orca_sal_anomt(TreeSetUp)
...
%             ht_predict=ht_all_junk{ilayer-2}; 
            ...
            good_prof=isfinite(ht_use)&isfinite(ht_predict)&isfinite(tpx)&isfinite(temp_use);
...
%             ht_predict=ht_all_junk{ilayer-2}; 
            ...
            good_prof=isfinite(ht_use)&isfinite(ht_predict)&isfinite(temp_use);
