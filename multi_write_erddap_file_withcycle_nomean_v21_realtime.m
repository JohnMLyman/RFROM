function []=multi_write_erddap_file_withcycle_nomean_v21_realtime(TreeSetUp)
            ...
            elseif var_type=='s'
                break ;'NOT WRITTEN FOR SALINITY'
                 write_netcfd_cf_sal_pressure_mon_single(mon_estimate,time_1950,lon_tpx,...
                       lat_tpx,mean_pressure,mean_pressure_bnds,file_name_nc)
            elseif var_type=='h'
                write_netcfd_cf_heat_depth_mon_single_nomean_real(mon_estimate,time_1950,lon_tpx,...
