function []=stablize_t_and_sl_loess_errdap_fast_v2(TreeSetUp)
...
%            file_name_nc= [path_nc_erddap,'RFROM_OHCA_',num2str(iyear),'_',num2str(imonth),'.nc'];
               ...
               if imonth>=10
                      file_name_nc_sal= [path_nc_erddap_sal,'RFROMV2_SAL_LOESS_',num2str(iyear),'_',num2str(imonth),'.nc'];
                      file_name_nc_temp= [path_nc_erddap_temp,'RFROMV2_TEMP_',num2str(iyear),'_',num2str(imonth),'.nc'];
                      file_name_nc_sal_stable= [path_nc_erddap_sal_stable,'RFROMV2_SAL_STABLE_',num2str(iyear),'_',num2str(imonth),'.nc'];
                      file_name_nc_temp_stable= [path_nc_erddap_sal_stable,'RFROMV2_TEMP_STABLE_',num2str(iyear),'_',num2str(imonth),'.nc'];


                   else
                      file_name_nc_sal= [path_nc_erddap_sal,'RFROMV2_SAL_LOESS_',num2str(iyear),'_0',num2str(imonth),'.nc'];
                      file_name_nc_temp= [path_nc_erddap_temp,'RFROMV2_TEMP_',num2str(iyear),'_0',num2str(imonth),'.nc'];
                      file_name_nc_sal_stable= [path_nc_erddap_sal_stable,'RFROMV2_SAL_STABLE_',num2str(iyear),'_0',num2str(imonth),'.nc'];
                      file_name_nc_temp_stable= [path_nc_erddap_sal_stable,'RFROMV2_TEMP_STABLE_',num2str(iyear),'_0',num2str(imonth),'.nc'];


               end
%               if ~exist(file_name_nc_temp_stable,'file')
