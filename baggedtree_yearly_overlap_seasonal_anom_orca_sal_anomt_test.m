function baggedtree_yearly_overlap_seasonal_anom_orca_sal_anomt_test(TreeSetUp)
...
path_new_tree1=path_tree_junk;
path_new_tree2=path_tree_junk2;
tree_model_file_name=tree_model_file_name_yearly;
...
% for ilayer=2:nlayer
    for iyear_mod=start_year:.5:end_year
        ...
        if iyear_mod <= sal_yearly_year_junk2
            path_new_tree=path_new_tree1;
        else
             path_new_tree=path_new_tree2;
        end

        year_file_name=num2str(10*iyear_mod);

        file_big_model_test=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
        
        if ~exist(file_big_model_test,'file')
           ...
           layer_offset=layer_off_all_junk{ilayer-1};
            ...
            if ilayer==2
                [model_all]=make_trees_mean_nosst_sal(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a');
                ...
                [model_all]=make_trees_mean_nosst_sal(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                [model_all]=make_trees_mean_nosst_sal(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                [model_all]=make_trees_mean_nosst_sal(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d');
    ...
    %             ht_predict=ht_all_junk{ilayer-2}; 
                [ht_predict]=par_htpredict(ht_all_junk,Nold,ilayer);
                
                good_prof=isfinite(ht_use)&isfinite(ht_predict);
            
                [model_all]=make_trees_mean_vert_nosst_sal(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                 [model_all]=make_trees_mean_vert_nosst_sal(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                 [model_all]=make_trees_mean_vert_nosst_sal(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                 [model_all]=make_trees_mean_vert_nosst_sal(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            else
    %             ht_predict=ht_all_junk{ilayer-2}; 
                ...
                [model_all]=make_trees_mean_vert_nosst_nossh_sal(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                 [model_all]=make_trees_mean_vert_nosst_nossh_sal(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                 [model_all]=make_trees_mean_vert_nosst_nossh_sal(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
            
                 [model_all]=make_trees_mean_vert_nosst_nossh_sal(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d');
                file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
                parsave_model_all(file_big_model,model_all)
...
function [ht_predict]=par_htpredict(ht_all_junk,Nold,ilayer)
    N_thislayer=length(ht_all_junk{ilayer-1});
    ht_predict=ht_all_junk{ilayer-2}; 
    N_predict=length(ht_predict);
    if N_predict>N_thislayer
        ht_predict=ht_predict(1:N_thislayer);
    elseif N_predict<N_thislayer
        ht_use_junk=ht_predict(1:Nold);
        ht_predict=cat(1,ht_predict,ht_use_junk);
    end
