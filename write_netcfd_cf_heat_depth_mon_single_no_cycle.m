function []=write_netcfd_cf_heat_depth_mon_single_no_cycle(ht_estimate,time_1950,lon_tpx,...
...
%     good=floor(time_aviso)==iyear;
    ...
    [globalat]=make_globalatribute_RFROM_no_cycle();
    ...
    ohca_att(2).Value=['mapped ocean heat content anomaly (TEOS-10) integrated ',...
        'from upper to lower bounds of mean depth with the seasonal cycle removed ',...
        'relivite to 2008 to 2020 mean'];
