...
path_file= 'D:\data\Roemmich_Gilson_Clim\';
...
load([path_tree,'test_tree_curve_yearly_7day_2000_yearly_new_cycle_combined_2_fixed_orca.mat'], 'tgrid', 'ht_curve');
...
%%
save([path_figs,'tree_gilson_ceres_rate_orca.mat'],'toa_qu_all',"toa_yearly",'cycle_toa',...
    'toa_time','toa','rate_mon_all','rate_qu_all','rate_year_all_no_cycle',...
    'time_rate_tree_all_year',"time_rate_tree_all_mon","time_rate_tree_all_qu",...
    'gilson_rate','gilson_rate_qu','gilson_rate_year_no_cycle',...
    'time_gilson_rate_year',"time_gilson_rate_qu","time_gilson_rate",...
    'cycle_toa','gilson_rate_cycle','rate_mon_all_cycle',...
    'frac_tree_cycle',"frac_gilson_cycle")
...
set(gca,'tickdir','out','Fontname','Arial','box','on')
text(2009,-.5,['RG09 ratio= ',num2str(round(frac_gilson_year))],'color',mycor(4,:),'fontsize',8)
...
% corr(toa_gilson(plot_pos_gilson_year),gilson_rate_year_no_cycle(plot_pos_gilson_year))
 ...
 eval(['print -dpng -r600 -f1 ',path_figs,'toa_tree_gilson_ceres2_loess_orca'])
%% yearly
...
path_figs='D:\data\OHCA\figs\tree_paper\'
 eval(['print -dpng -r600 -f2 ',path_figs,'toa_tree_gilson_ceres_cycle_new_loess'])
% 
...
d = Document([path_figs,'Tree_corr_table_loess_fixed_orca'],'docx');
append(d,mltableObj);
close(d);
% rptview(d);
...
import mlreportgen.dom.*
mltableObj = MATLABTable(mltable);
d = Document([path_figs,'RG_corr_table_loess_fixed_orca'],'docx');
append(d,mltableObj);
close(d);
% rptview(d);
