function [lon,lat,yr,ohca_out,layer_bounds_NCAR_out]=load_heat_netcdf_NCAR_SMALL_fast(years_load,TreeSetUp)
tic
...
%%
ohca_out=nan(nlon,nlat,nlayers-1,ngood);
...
%%
        ...
        ohca_out(:,:,ilayer-1,ipos)=heat_junk.*scale;
