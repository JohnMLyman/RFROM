function [yr,ohca_curve_out,layer_bounds_NCAR_out]=load_heat_netcdf_NCAR_SMALL_fast_curve(years_load,TreeSetUp,latmax)
tic
...
%%
        ...
        ohca_curve=heat_junk.*scale.*arw_mask;
    ...
    time_total_toc=toc./60
    time_total_toc-time_total_toc_old
    time_total_toc./ngood
    time_total_toc_old=time_total_toc;
