...
function read_netcdf_ncar_and_smooth_curve(file_name)
tic
file_name='g.e20.G.TL319_t13.control.001.pop.h.0183-12-31.nc';

file_name_out=['NCAR_POP_curve',file_name(37:9+37+3)];
...
% write_netcfd_cf_temp_sal_NCAR_rect(ptemp,sal,ssh,time,time_leap,lon_new,...
%     lat_new,depth,dz,file_name_out)
%     
toc./60./60
end
