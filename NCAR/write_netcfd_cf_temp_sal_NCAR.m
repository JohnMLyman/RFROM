function []=write_netcfd_cf_temp_sal_NCAR(ptemp,sal,ssh,time,yr_file,lon,...
...
%      % area
% 
%     area_att(1).Name='units';
%     area_att(1).Value='meters^2';
%     area_att(2).Name='Description';
%     area_att(2).Value='Area of grid cell';
%     area_att(3).Name='standard_name';
%     area_att(3).Value='area';
%     
%     mySchema.Variables(3).Name='area';
%     mySchema.Variables(3).Dimensions=map_dimen(1:2);
%     mySchema.Variables(3).Attributes=area_att;
...
%     mySchema.Variables(3).FillValue='disable';
    ...
    time_yrfrac_att(1).Value='decimal';
