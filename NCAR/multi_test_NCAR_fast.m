...
tic
[yr_truth,ohca_curve_truth,layer_bounds_NCAR_oute]=load_heat_netcdf_NCAR_SMALL_fast_curve(years_load,TreeSetUp,60);
[mean_depth,mean_depth_bnds,yr_new,ohca_curve_new]=load_heat_netcdf_all_year_paige_curve(years_load,TreeSetUp,60);
% [mean_depth_newno,mean_depth_bnds_newno,yr_out_newno,ohca_curve_newno]=load_heat_netcdf_all_year_paige_curve_nocycle(years_load,TreeSetUp,60);


TreeSetUp=TreeSetUp_2023_orca_heat_novert_test_NCAR_old_test4;
...
TreeSetUp=TreeSetUp_2023_orca_heat_novert_test_NCAR_old_test2;
