function [model_all]=make_trees_mean_vert_nosst_nossh_sal_leaf(use,ht_use,temp_use,ht_perdict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,large_scale,leaf_base)
