function read_ssh_matfiles_all_years_orca_vert_sal_exra_junk(TreeSetUp)
...
%         file_name_temp=[path_new_tree_withcycle_temp,tree_file_name_out_withcycle_temp,'_split_7day.mat'] ;
        ...
        ht_estimate_m=nan(nlon_tpx,nlat_tpx,nfiles);        
            ...
            if ilayer==2
                ...
                [ht_estimate_m]=bagged_yearly_tree_temp_SSH_sal_junk(iyear_mod,...
...
%         ht_estimate=ht_estimate_a.*weight_a+ht_estimate_b.*weight_b+ht_estimate_c.*weight_c+ht_estimate_d.*weight_d;
        ...
        parsave_tree_year([path_new_tree,tree_file_name_out,'_extra_split_7day_junk.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)
