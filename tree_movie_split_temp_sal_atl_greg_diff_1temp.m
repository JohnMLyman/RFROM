...
ht_estimate_mean_greg=ht_estimate_mean;
%%
set_up_sal_atl_temp1_diff
...
ht_estimate_mean_1temp=ht_estimate_mean;

ht_estimate_mean=(ht_estimate_mean_1temp-ht_estimate_mean_greg);
%%


v=VideoWriter([path_figs,'tree_a16_sal_greg_diff_1temp.avi']);
v.FrameRate = 10;
open(v)
