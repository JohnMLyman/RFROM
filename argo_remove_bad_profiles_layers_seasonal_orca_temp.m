function argo_remove_bad_profiles_layers_seasonal_orca_temp(OcoSetUp)
...
eval(['load ',file_path_out,file_name,'_bad_oco_100_new_layers_temp.mat ',...
    bad_temp_var_name])
...
for ilayer=2:length(layer_bounds)
     ...
     eval(['temp_',num2str(layer_bounds(ilayer-1)),'_',...
         ...
         'bad_temp_',num2str(layer_bounds(ilayer-1)),'_',...
...
% took out topex from save John Lyman 11/12/2015
 eval(['save ',file_path_out,'alltemp_new_layers_seasonal_',alltemp_extra,...
    t_var_name,...
