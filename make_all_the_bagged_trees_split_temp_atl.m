...
fname_nc_season=[file_path_hdata,'tdata_new_layers_',file_WOD_suf,'_',file_name_season];
fname_nc=[file_path_hdata,'tdata_new_layers_',file_WOD_suf,'_',file_name_season_anom];
