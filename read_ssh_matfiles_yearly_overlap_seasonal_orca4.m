function read_ssh_matfiles_yearly_overlap_seasonal_orca4(TreeSetUp)
...
nsplit=4;
delta_year_mean_maps=(end_year_mean-start_year_mean)./nsplit;
mid_mean1=start_year_mean+delta_year_mean_maps;
mid_mean2=mid_mean1+delta_year_mean_maps;
mid_mean3=mid_mean2+delta_year_mean_maps;
...
for isplit=1:nsplit
        ...
        switch isplit 
            case 1
                  ...
                  max_tpx_year=floor(mid_mean1)+1;
            case 2
                 min_tpx_year=floor(mid_mean1)-1;
                 max_tpx_year=floor(mid_mean2)+1;
            case 3
                 min_tpx_year=floor(mid_mean2)-1;
                 max_tpx_year=floor(mid_mean3)+1;
            case 4
                 min_tpx_year=floor(mid_mean3)-1;
        ...
        switch isplit
            case 1
                ssh_total1=single(ssh_total);
                sst_total1=single(sst_total);
                time_aviso1=time_aviso;
                min_tpx_year1=min_tpx_year;
                max_tpx_year1=max_tpx_year;
                nfiles1=nfiles;
            case 2
                ssh_total2=single(ssh_total);
                sst_total2=single(sst_total);
                time_aviso2=time_aviso;
                min_tpx_year2=min_tpx_year;
                max_tpx_year2=max_tpx_year;
                nfiles2=nfiles;
            case 3
                ssh_total3=single(ssh_total);
                sst_total3=single(sst_total);
                time_aviso3=time_aviso;
                min_tpx_year3=min_tpx_year;
                max_tpx_year3=max_tpx_year;
                nfiles3=nfiles;
            case 4
                ssh_total4=single(ssh_total);
                sst_total4=single(sst_total);
                time_aviso4=time_aviso;
                min_tpx_year4=min_tpx_year;
                max_tpx_year4=max_tpx_year;
                nfiles4=nfiles;
        end
...
% %         sst_total=single(sst_total);
        ...
        % difine constants
% % %         ssh_total_c = parallel.pool.Constant(ssh_total);
% % %         sst_total_c = parallel.pool.Constant(sst_total);
% % %         global_basins_aviso_c = parallel.pool.Constant(global_basins_aviso);
% % %         LAT_c = parallel.pool.Constant(LAT);
% % %         LON_c = parallel.pool.Constant(LON);
%         
%         clearvars sst_total ssh_total LON LATfor isplit=1:2

   
    parfor tlayer=1:(nlayer-1)*nsplit
            total_junk=repmat(2:nlayer,1,nsplit);

            ilayer=total_junk(tlayer);
            isplit=ceil(tlayer./(nlayer-1));
           
            switch isplit
                case 1
                    ssh_total=ssh_total1;
                    sst_total=sst_total1;
                    time_aviso=time_aviso1;
                    min_tpx_year=min_tpx_year1;
                    max_tpx_year=max_tpx_year1;
                    nfiles=nfiles1;
                case 2
                    ssh_total=ssh_total2;
                    sst_total=sst_total2;
                    time_aviso=time_aviso2;
                    min_tpx_year=min_tpx_year2;
                    max_tpx_year=max_tpx_year2;
                    nfiles=nfiles2;
                 case 3
                    ssh_total=ssh_total3;
                    sst_total=sst_total3;
                    time_aviso=time_aviso3;
                    min_tpx_year=min_tpx_year3;
                    max_tpx_year=max_tpx_year3;
                    nfiles=nfiles3;


                otherwise
                    ssh_total=ssh_total4;
                    sst_total=sst_total4;
                    time_aviso=time_aviso4;
                    min_tpx_year=min_tpx_year4;
                    max_tpx_year=max_tpx_year4;
                    nfiles=nfiles4;
            end
            yr_av=time_aviso;
            time_aviso=yr_av;
...
% %             switch isplit
%                 case 1
%                 good_split_1=time_aviso<=floor(max_tpx_year)+.5;
%                 ht_estimate=ht_estimate(:,:,good_split_1);
%                 time_aviso=time_aviso(good_split_1);

                parsave_tree ([path_tree_junk,tree_file_name_season,'_split_7day_junk',num2str(isplit),'.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)
%                 case 2
%                 good_split_2=time_aviso>floor(mid_mean_maps)+.5;
%                 
%                 ht_estimate=ht_estimate(:,:,good_split_2);
%                 time_aviso=time_aviso(good_split_2);
%                 parsave_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk2.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)
% %                 ht_estimate_end=ht_estimate;
% %                 time_aviso_end=time_aviso;
% %                 [ht_estimate,time_aviso]=parload_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk.mat'] );
%                 ht_estimate=cat(3,ht_estimate,ht_estimate_end);
%                 time_aviso=cat(2,time_aviso,time_aviso_end);
%                 
% 
%                 parsave_tree([path_new_tree_season,tree_file_name_season,'_7day.mat'],ht_estimate,lon_tpx, lat_tpx,time_aviso)
% %                 parsave_tree([path_new_tree_season,tree_file_name_season,'__7day.mat'] ,ht_estimate,lon_tpx,lat_tpx,time_aviso)
%                 pardelete_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk.mat'])
%            
% 
%                 end
...
%      layer_name=[num2str(layer_bounds(ilayer-1)),'_',num2str(layer_bounds(ilayer))]
%      tree_file_name_season=[tree_model_file_name_season,'_',layer_name];
%     [ht_estimate_end,time_aviso_end]=parload_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk2.mat']);
%     [ht_estimate,time_aviso]=parload_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk1.mat'] );
%     ht_estimate=cat(3,ht_estimate,ht_estimate_end);
%     time_aviso=cat(2,time_aviso,time_aviso_end);
%                 
% 
%     parsave_tree([path_new_tree_season,tree_file_name_season,'_orca_7day.mat'],ht_estimate,lon_tpx, lat_tpx,time_aviso);
%     pardelete_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk1.mat'])
%     pardelete_tree([path_tree_junk,tree_file_name_season,'_split_7day_junk2.mat'])         
% 
% end
