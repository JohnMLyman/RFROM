function []=baggedtree_yearly_overlap_seasonal_orca_novert(TreeSetUp)
...
%         good_prof=isfinite(ht_use);
     ...
     if ilayer<=ilayer_depth_use_sst
            ...
            [model_all]=make_trees_mean_nosst(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'a');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'b');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
