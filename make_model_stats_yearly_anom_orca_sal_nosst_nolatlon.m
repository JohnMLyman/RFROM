function []=make_model_stats_yearly_anom_orca_sal_nosst_nolatlon(TreeSetUp)
...
file_stats=[path_new_tree,tree_model_file_name,'_all_stats_split_nosst_nolatlon.mat'];
