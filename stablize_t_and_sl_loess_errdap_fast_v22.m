function []=stablize_t_and_sl_loess_errdap_fast_v22(TreeSetUp)
...
%            file_name_nc= [path_nc_erddap,'RFROM_OHCA_',num2str(iyear),'_',num2str(imonth),'.nc'];
               ...
               if imonth>=10
                      file_name_nc_sal= [path_nc_erddap_sal,'RFROMV22_SAL_LOESS_',num2str(iyear),'_',num2str(imonth),'.nc'];
                      ...
                      file_name_nc_sal= [path_nc_erddap_sal,'RFROMV22_SAL_LOESS_',num2str(iyear),'_0',num2str(imonth),'.nc'];
...
%               if ~exist(file_name_nc_temp_stable,'file')
        ...
        %                for itime=1:1
                   ...
                   write_netcfd_cf_sal_pressure_mon_singlev22(sal_out,time_1950,lon,...
                       lat,pres,mean_pressure_bnds,file_name_nc_sal_stable)
                    write_netcfd_cf_temp_pressure_mon_singlev22(temp_out,time_1950,lon,...
