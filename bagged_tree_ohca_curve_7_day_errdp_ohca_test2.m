function bagged_tree_ohca_curve_7_day_errdp_ohca_test2(TreeSetUp,min_depth,max_depth)
...
latmax=60;
if exist('latmax','var')
       bad=lat_tpx<-1.*latmax | lat_tpx>latmax;
       arw(:,bad)=nan;
...
curve_name=['curve_',tree_prefix,'_',depth_range_name,'_ohca_nomean_',OUTOUT_type,'_test2.mat'];
map_name=['map_',tree_prefix,'_',depth_range_name,'_ohca_nomean_',OUTOUT_type,'_test2.mat'];
