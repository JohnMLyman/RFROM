                ...
                sal_junk=ones(length(press_junk),1).*35.0;
                        ...
                        for ilayer=2:length(layer_bounds)
                             ...
                             if max_depth_junk >= layer_bounds(ilayer)
                                ...
                                [temp_junk]=compute_depth_temp_depth_range_teos10_2016_tuna(data,temp_junk,coords(j,:),layer_bounds(ilayer-1),layer_bounds(ilayer));
                                [temp_junk2]=compute_depth_temp_depth_range_teos10_2016_tuna(data,temp_junk2,coords(j,:),0,layer_bounds(ilayer));
