...
% % % multi_write_mat_monthly_sal_mean(TreeSetUp)
% % % 'multi_write_nc_monthly_sal'
% % % multi_write_nc_monthly_sal_mean(TreeSetUp)
...
baggedtree_yearly_anom_orca_sal_new_meant_t_nolatlon(TreeSetUp)
...
read_ssh_matfiles_yearly_anom_orca2_sal_mean_t_nolatlon(TreeSetUp)
...
% make_model_stats_yearly_anom_split_orca_sal_nosst_nossh(TreeSetUp)
% make_model_stats_yearly_anom_orca_sal_nosst_nossh_nolatlon(TreeSetUp)
make_model_stats_yearly_anom_orca_sal_nosst_nolatlon(TreeSetUp)
% 
'write nc files'
...
multi_write_mat_monthly_sal_yearly_mean_t_nolatlon(TreeSetUp)
multi_write_nc_monthly_sal_yearly_mean_t_nolatlon(TreeSetUp)
