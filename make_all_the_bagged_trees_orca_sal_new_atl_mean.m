...
var_type='s';
tree_prefix='tree_sal_atl_3_n_mean';
tree_prefix_temp='tree_temp';
path_mat_nc='D:\monthly_temp\';
path_ERDDAP='H:\erddap\sal_3_n_mean\';
...
% read_yearly_overlap_seasonal_orca_sal_mean_no_sstssh(TreeSetUp)
...
% make_model_stats_yearly_overlap_seasonal_orca_sal_nosstssh(TreeSetUp)
