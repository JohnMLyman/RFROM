...
text(2009,-35,['FM ratio= ',num2str(round(frac_tree_all))],'color','k','fontsize',8)
text(2008.5,36,'a)')
...
plot_pos_tree_year=time_rate_tree_all_year>=min_year+1&time_rate_tree_all_year<=max_year-1;
plot_pos_gilson_year=time_gilson_rate_year>=min_year+1&time_gilson_rate_year<=max_year-1;
plot_pos_toa_year=toa_time>=min_year+.5&toa_time<=max_year-.5;
...
text(2009,-.8,['FM ratio= ',num2str(round(frac_tree_year))],'color','k','fontsize',8)
text(2008.6,1.7,'d)')
ylabel('W m^{-2}','Fontsize',10,'Fontname','Arial')
