...
tree_prefix='tree_sst_tpx_atlatic';
path_hyp='E:\data\OHCA\';
...
% 
% baggedtree_hold_out_yearly_overlap_seasonal_split(TreeSetUp)
...
% 
baggedtree_hold_out_yearly_overlap_seasonal_anom_split_hyp(TreeSetUp)
...
% 
% baggedtree_hold_out_all_years_seasonal_anom_split(TreeSetUp)
