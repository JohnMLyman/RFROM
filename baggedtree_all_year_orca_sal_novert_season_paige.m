function baggedtree_all_year_orca_sal_novert_season_paige(TreeSetUp)
...
% for ilayer=2:nlayer
       ...
       layer_offset=layer_off_all_junk{ilayer-1};
        ...
        if ilayer<=ilayer_depth_use_ssh
            ...
            [model_all]=make_trees_mean_nosst_sal_paige(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a');
            ...
            [model_all]=make_trees_mean_nosst_sal_paige(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_sal_paige(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_sal_paige(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d');
            ...
            [model_all]=make_trees_mean_nosst_nossh_sal_paige(use,ht_use,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_nossh_sal_paige(use,ht_use,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_nossh_sal_paige(use,ht_use,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_nossh_sal_paige(use,ht_use,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
