function Float_Vars=make_machine_table_rm_mean_irr_nosub(float_list)
            ...
            for icycle=1:ncycles
                file_cycle=list_of_cycles(icycle).name;
                 ...
                 % This clearly needs to be
                   ...
                   pos_qc4=find(sal_qc==4 | sal_qc==3  );
                   pos_good=[pos_qc4',pos_qc1']';
                   n=length(pos_good);
