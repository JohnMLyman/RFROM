function bagged_tree_ohca_curve_7_day_errdp_temp_test(TreeSetUp)
...
MIN_LAYER_PRES=MIN_LAYER;
MAX_LAYER_PRES=MAX_LAYER;
...
curve_name=['curve_',tree_prefix,'_0_1800_CT_mask2_test.mat'];

save ([path_tree,curve_name], 'tgrid', 'ht_curve');
% save ([path_tree,'curve_name], 'tgrid', 'ht_out','lat_tpx','lon_tpx','-v7.3');
