...
eval(['time_',name_comp,'=time_gilson;'])
eval(['ht_',name_comp,'_year_no_cyce=ht_gilson_year_no_cyce;'])
eval(['ht_',name_comp,'_no_cyce=ht_gilson_no_cyce;'])


save([path_figs,name_comp,'_ohca_curves.mat'],...
    ['time_',name_comp],['ht_',name_comp,'_year_no_cyce'],['ht_',name_comp,'_no_cyce'])
