function bin_EN4_2021_new_layers_orca_seasonal_temp(OcoSetUp)
...
eval(['load ',path_EN4_out,'alltemp_wod_new_layers_all_conv4',file_name,file_WOD_suf]);

% 
%% load in the Argo fields 
eval(['load ',file_path_out,'alltemp_new_layers_seasonal_',alltemp_extra,...
    t_var_name,...
...
wod_oclnum=[oclnum_wod;nans(size(id))];
 ...
 eval(['save ',file_path_out,'alltemp_new_layers_argo_WOD_new_',file_name_season,...
    t_var_name,...
