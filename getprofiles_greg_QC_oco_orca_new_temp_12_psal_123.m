function getprofiles_greg_QC_oco_orca_new_temp_12_psal_123(OcoSetUp)
file_path_prof=OcoSetUp.file_path_prof;

file_path_in=OcoSetUp.file_path_in;
file_name_argo=[OcoSetUp.file_name_argo,'_123'];
...
bad_temp=~( TEMP_QC=='1' |TEMP_QC=='2' );
bad_sal=~( PSAL_QC=='1' |PSAL_QC=='2'|PSAL_QC=='3'  );
bad_pres=~( PRES_QC=='1'|PRES_QC=='2' );
%  
PRES(bad_pres)=NaN;
PSAL(bad_sal)=NaN;
TEMP(bad_temp)=NaN;
