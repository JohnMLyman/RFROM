...
function []=multi_write_mat_monthly_temp(TreeSetUp)
...
% for ilayers=2
    ...
    file_nc_prefix=['RFROM_TEMP_',layer_name,'_']
     scalej=scale;    
...
%                save([path_mat_nc,file_name_mat_nc],'ht_estimate_mon','time_1950','lon_tpx','lat_tpx')
               save_month_nc([path_mat_erddap,file_name_mat_nc],temp_estimate_mon,time_1950,lon_tpx,lat_tpx)
...
function save_month_nc(filename,temp_estimate_mon,time_1950,lon_tpx,lat_tpx)

 save(filename,'temp_estimate_mon','time_1950','lon_tpx','lat_tpx')
