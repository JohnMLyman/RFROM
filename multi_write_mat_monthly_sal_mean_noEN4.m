...
function []=multi_write_mat_monthly_sal_mean_noEN4(TreeSetUp)
...
path_mat_erddap=[path_ERDDAP,'matlab\mean_noEN4\'];
year_start_nc=2009;
year_end_nc=2011;
...
tree_model_file_name=[tree_model_file_name_season,'\',tree_model_file_name_season];
tree_model_file_name_out=tree_model_file_name_season;
...
scalej(mid)=NaN;
    ...
    tree_file_name=[tree_model_file_name,'_',layer_name];
    tree_file_name_out=[tree_model_file_name_out,'_',layer_name];
   ...
   for iyear=year_start_nc:year_end_nc
       for imonth=1:12
           ...
           if ~isempty(good)
               ...
               file_name_mat_nc=[tree_file_name_out,'_',num2str(iyear),'_',num2str(imonth)];
