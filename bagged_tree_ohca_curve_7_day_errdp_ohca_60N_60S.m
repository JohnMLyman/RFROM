function [ht_curve,vol,tgrid]=bagged_tree_ohca_curve_7_day_errdp_ohca_60N_60S(TreeSetUp,min_depth,max_depth)
...
delta_depth=diff(depth_bounds);
delta_depth=delta_depth(pos_min:pos_max);
...
arw(:,abs(lat_tpx)>65)=nan;


arw=repmat(arw,[1 1 s_good_area(3)]);
delta_depth=reshape(delta_depth,[1 1 s_good_area(3)]);
...
% curve_name=['curve_',tree_prefix,'_',depth_range_name,'_ohca_65nomean_',OUTOUT_type,'.mat'];
% map_name=['map_',tree_prefix,'_',depth_range_name,'_ohca_65nomean_',OUTOUT_type,'.mat'];
% 
