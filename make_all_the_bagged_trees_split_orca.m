...
path_oisst='D:\data\oisst\';
path_OHCA_data_out='D:\data\OHCA\'
path_OHCA_data_in='D:\OHCA\'
file_WOD_suf='_cheng_EN4_2014';
tree_prefix='tree_sst_tpx_test';
...
% 
% % % 'baggedtree_hold_out_yearly_overlap_seasonal_split_orca'
% % % baggedtree_hold_out_yearly_overlap_seasonal_split_orca(TreeSetUp)
...
% % % 'make_model_stats_yearly_overlap_seasonal_split'
% % % make_model_stats_yearly_overlap_seasonal_split(TreeSetUp)
% % % 

%% Make the yearlly anomally tree
% 
% % % 'baggedtree_hold_out_yearly_overlap_seasonal_anom_split_orca'
% % % baggedtree_hold_out_yearly_overlap_seasonal_anom_split_orca(TreeSetUp)
...
% % % baggedtree_hold_out_all_years_seasonal_anom_split_orca(TreeSetUp)
...
make_error_holdout_estimate_files_yearly_season_anom_split_orca(TreeSetUp)
% % % 'make_error_holdout_estimate_files_all_years_anom_split_orca'
% % % make_error_holdout_estimate_files_all_years_anom_split_orca(TreeSetUp)
% % % 'error_holdout_all_years_test_weights_split_orca'
% % % error_holdout_all_years_test_weights_split_orca(TreeSetUp)
'error_holdout_yearly_test_weights_split_orca'
error_holdout_yearly_test_weights_split_orca(TreeSetUp)
'bagged_tree_ohca_error_combine_split_orca'
bagged_tree_ohca_error_combine_split_orca(TreeSetUp)
...
% 
make_bagged_tree_ohca_maps_7_day_seasonal_orca(TreeSetUp)
% clearvars -except file_name max_year_fit min_year_fit center_year ...
%     start_year end_year
% % % % % % make the curve
% 
bagged_tree_ohca_curve_7_day_with_cycle_combined_fixed_orca(TreeSetUp)
% clearvars -except file_name max_year_fit min_year_fit center_year ...
% %     start_year end_year
