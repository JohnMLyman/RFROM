function baggedtree_yearly_anom_orca_sal_new_meant_t_nossh_nolatlon(TreeSetUp)
...
start_year=start_yearly_maps-.5;
end_year=end_yearly_maps+.5;
...
if ~exist(path_new_tree_yearly,'dir')
    mkdir(path_new_tree_yearly)
end
% tpx=tpx(:,1);
...
%%
    ...
    file_hold_out=[path_new_tree_yearly,tree_model_file_name_yearly,'_hold_out_data_',layer_name,'_split.mat'];
...
%         [model_all]=make_trees_mean_sal(use,ht_use,temp_use,layer_offset,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof);
        
%     [model_all]=make_trees_mean_sal_nosst(use,ht_use,temp_use,tpx,layer_offset,coords,yr,nbasins_use,good_yr,good_prof)
        [model_all]=make_trees_mean_sal_nosst_nossh_nolatlon(use,ht_use,temp_use,tpx,layer_offset,coords,yr,nbasins_use,good_yr,good_prof)
