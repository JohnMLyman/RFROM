...
tree_file_name_out=[tree_model_file_name_season,'_',layer_name,'_',num2str(floor(start_year_mean))];
load([path_new_tree_season,tree_file_name_out,'_split_7day.mat'] ,'lon_tpx', 'lat_tpx')
...
%     load([path_new_tree_season,tree_file_name,'_split_7day.mat'], 'ht_estimate','lon_tpx','lat_tpx', 'time_aviso')
    [ht_estimate,lat_tpx,lon_tpx,time_aviso]=...
        make_vertical_layer(path_new_tree_season,tree_model_file_name_season,layer_bounds,start_year_mean,end_year_mean,ilayer);
