...
var_type='s';
tree_prefix='tree_sal_atl_3_n';
tree_prefix_temp='tree_temp';
path_mat_nc='D:\monthly_temp\';
path_ERDDAP='H:\erddap\sal_3_n\';
...
baggedtree_hold_out_yearly_overlap_seasonal_split_orca_sal_new(TreeSetUp)
...
read_ssh_matfiles_yearly_overlap_seasonal_orca_sal(TreeSetUp)
