function []=multi_add_seasonal_cycle_combined_filt_sal_junk(TreeSetUp)
...
%         tree_file_name_out_withoutcycle=[tree_model_withoutcycle,'_',layer_name,'_',num2str(year_load)];
        ...
        [ht_estimate_year,time_aviso,lon_tpx,lat_tpx]=load_ht_estimate([path_new_tree,tree_file_name_out,'_split_7day_junk.mat']);
        ...
        parsave_tree_year([path_new_tree_withcycle,tree_file_name_out_withcycle,'_split_7day_junk.mat'] ,ht_estimate_year_wc,lon_tpx, lat_tpx,time_aviso)
