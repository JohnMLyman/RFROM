tree_model_file_name='nueral_test';
...
good_yr=(floor(yr)>=1993);
good_yr=(floor(yr)==2010);
...
for ilayer=2:nlayer
    ...
    test_tree_year_compact_neuralnet
    ...
    file_hold_out=[path_new_tree,tree_model_file_name,'_hold_out_data_',num2str(layer_bounds(ilayer-1)),'_',...
             num2str(layer_bounds(ilayer)),'.mat'];
