function [model_all]=make_trees_mean_nosst_sal(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,large_scale)
...
for ibasin=nbasins_use
       ...
       basin_regions=map_costal_region(coords(:,1),coords(:,2),ibasin);
