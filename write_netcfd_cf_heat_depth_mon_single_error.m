function []=write_netcfd_cf_heat_depth_mon_single_error(ht_error,time_1950,lon_tpx,...
...
%     good=floor(time_aviso)==iyear;
    ...
    [globalat]=make_globalatribute_ERROR_RFROM();
    ...
    ohca_att(2).Value='mapped ocean heat content anomaly error (TEOS-10) integrated from upper to lower bounds of mean depth';
    
    mySchema.Variables(5).Name='ocean_heat_content_anomaly_error';
   ...
   ht_error=single(ht_error./1e9);
    ...
    ncwrite(file,'ocean_heat_content_anomaly_error',ht_error,[1,1,1,1]);  
