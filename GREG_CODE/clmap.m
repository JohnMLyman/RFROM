...
%       If it is a string it should be one of the following 23 letters:
%         a b c d e f g h i j k l m n o p q r s t u v w x
%         or it may be one of the strings 'std', 'mac' or 'ramp' which
%         correspond to the letters 'g', 'a' and 'u' respectively.
%       If it is a number it must be between 1 and 24 and corresponds to the
%         24 letters above.
...
% q 24  white-grey-black with many colours - Peter Oke? Nice for anomalies
% r  8  Remote sensing
%
% Robin Petterd's maps (see his discussion on www):
% h  9	Blue highlight
% i 10	Midheight in red
% j 11 	Blue green white
% k 12	Bright sat hue
% l 13	green to red
% m 14	purple to blue
% n 15	purple to yellow
% o 16	low ONLY
% 
% Special purpose colourmaps
% p 17  Phil Morgan's bathymetry (blue to white). This has 8 colours, including
...
% s 18	Blue-magenta-red	(Jim Mansbridge "xblue_mag_red")
% t 19	bright purple-yellow	(Jeff Dunn - 2 complementary{?} colours in 
% 				style of some oceanographic atlases)
% u 20	green-blue-purple       (Jeff Dunn - lousy colours but smooth brightness
% 			        ramp from dark to light - good for grey-scales)
% v 21  red-blue-green-red	(Dunn - maybe for circular quantity (phase?))
% w 22  64 colour version of Remote sensing SST colour map ('r' or 8)
% x 23  red-white-blue          (Oke? "R_B" nice anomaly colours)
%
% AUTHORS: Jeff Dunn & Jim Mansbridge

% $Id: clmap.m,v 1.1 2001/10/01 07:40:18 man133 Exp man133 $
...
map_name_long = {...
      ...
      'SST image            (Remote Sensing 255 value SST colour map)', ...
      ...
      'SST image - coarse   (64 colour version of Remote Sensing SST colour map)', ...
      'red-white-blue       (Oke - from R-B.m - nice anomaly colours',...
      'w-grey-k             (Oke - many-coloured, grey-centre, anomalies',...
		};

map_name_short = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'r' , 'h', 'i', 'j', ...
      'k', 'l', 'm', 'n', 'o', 'p', 's', 't', 'u', 'v', 'w', 'x', 'q'];
