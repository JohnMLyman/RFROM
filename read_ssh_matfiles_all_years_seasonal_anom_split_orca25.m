function []=read_ssh_matfiles_all_years_seasonal_anom_split_orca25(TreeSetUp)
load_TreeSetUp
%%
...
mid_all_year=(start_all_year+end_all_year)./2;
mid_all_year=start_all_year;
...
for isplit=1:2
        ...
        if isplit ==1
            ...
            max_tpx_year=floor(mid_all_year)+1;
        else
            min_tpx_year=floor(mid_all_year)-1;
            max_tpx_year=floor(end_all_year);
        end
...
%          
             if isplit==1
                ...
                time_aviso=time_aviso(good_split_1);
                 parsave_tree ([path_tree_junk,tree_file_name,num2str(tlayer),'_split_7day_junk.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)      
% 
...
%                 load ([path_tree_junk,tree_file_name,'_split_7day_junk.mat'] ,'ht_estimate','time_aviso');
                 [ht_estimate,time_aviso]=parload_tree([path_tree_junk,tree_file_name,num2str(tlayer),'_split_7day_junk.mat'] );
...
%                 save ([path_tree,tree_file_name,'_split_7day.mat'] ,'ht_estimate','lon_tpx', 'lat_tpx','time_aviso','-v7.3')
                parsave_tree([path_new_tree_season,tree_file_name,num2str(tlayer),'_split_7day.mat'],ht_estimate,lon_tpx, lat_tpx,time_aviso)
                
%                 delete([path_tree_junk,tree_file_name,'_split_7day_junk.mat'])
               pardelete_tree([path_tree_junk,tree_file_name,num2str(tlayer),'_split_7day_junk.mat'])
