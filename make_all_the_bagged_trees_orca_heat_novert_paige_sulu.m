...
% % % oco_maps_2025_orca_seasonal_heat
% % % 
% % % clearvars
...
% TreeSetUp=TreeSetUp_2024_orca_heat_novert_test_mid_paige_sulu;
...
% % % multi_write_erddap_file_withoutcycle(TreeSetUp)
% % % multi_write_erddap_file_withcycle(TreeSetUp)
% % % toc./60./60
% % % 
% % % 'multi_write_erddap_file_withcycle_nomean_v22'
% % % % must run multi_write_erddap_file_withcycle(TreeSetUp) first.  It makes
% % % % the netcdffiles that mean is comuted from.
% % % multi_write_erddap_file_withcycle_nomean_v22(TreeSetUp) 
% % % toc./60./60
% % % 
% % % 'multi_write_erddap_file_withcycle_nomean_v22_reatime'
% % % % % must run multi_write_erddap_file_withcycle(TreeSetUp) first.  It makes
% % % % % the netcdffiles that mean is comuted from.
% % % multi_write_erddap_file_withcycle_nomean_v22_realtime(TreeSetUp) 
% % % toc./60./60
% % % 
% % % tic
% % % 
% % % bagged_tree_ohca_curve_7_day_errdp_ohca_test(TreeSetUp,0,2000)
% % % 'make_1x1xmonth_files_v22'
...
% % % % mae the ocean heat up take curve
% % % OHU_curve_and_ascii_file(TreeSetUp,0,2000)
% % % toc./60./60
% % % % plot the curves
% % % 'plot_oco_curves'
