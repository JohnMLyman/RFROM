function [temp]=compute_depth_ct_press_range_teos10_2016_tuna(data,temp,coords,depth_int_top, depth_int_bottom)
   ...
   % if press_junk(1) < 15 && depth_junk(end) >= depth_int_bottom && press_junk(1)>=0 && numel(jj) >np_r
    ...
    if good_level==1 && press_junk(1)>=0 
        ...
        % fix bottom 
            ...
            press_depth_int=depth_depth_int;
