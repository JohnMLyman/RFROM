function bagged_tree_ohca_curve_7_day_errdp_ohca_writenc(TreeSetUp,min_depth,max_depth,TreeSetUpMask)
...
if exist('TreeSetUpMask','var')
    good_area=fixed_area_mask(TreeSetUpMask,min_depth,max_depth); 
    OUTOUT_type=[OUTOUT_type,'Mask'];
else
...
curve_name_nc=['curve_',tree_prefix,'_',depth_range_name,'_ohca_nomean_',OUTOUT_type,'.nc'];
...
file_name_nc=[path_Fig_data,curve_name_nc];

write_netcfd_cf_OHCA_curve(tgrid,ht_curve,file_name_nc)
