...
time_aviso=time_tree_all;
ohca=ht_all_no_cyce./1e21;

% get rid of realtime SSH estimates that have less varibility
time_aviso=time_aviso(1:1487);
ohca=ohca(1:1487);
file_name_nc=[path_figs,'OHCA_0_2000.nc'];
write_netcfd_cf_OHCA_curve(time_aviso,ohca,file_name_nc)