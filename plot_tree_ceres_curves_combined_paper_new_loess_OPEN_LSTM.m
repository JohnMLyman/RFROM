...
%Junk
time_rate_tree_all_mon=time_rate_tree_all_qu;
rate_mon_all=rate_qu_all;
rate_mon_all_no_cycle=rate_qu_all_no_cycle;
...
ntree_junk=length(rate_mon_all);
pos_tree_junk=[2:4:ntree_junk];
plot(time_rate_tree_all_mon(pos_tree_junk),rate_mon_all(pos_tree_junk),'k','LineWidth',1.25)
