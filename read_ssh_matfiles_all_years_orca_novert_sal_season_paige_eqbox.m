function read_ssh_matfiles_all_years_orca_novert_sal_season_paige_eqbox(TreeSetUp)
...
%     [ssh_total,time_aviso,nfiles]=read_sshanom_year(s,syr,nlon_tpx,nlat_tpx,year_load,TreeSetUp) ;
        ...
        [ssh_total,time_aviso,nfiles]=read_totalssh_year(s,syr,nlon_tpx,nlat_tpx,year_load,TreePredictInfo);
...
%         file_name_temp=[path_new_tree_withoutcycle_temp,tree_file_name_out_withoutcycle_temp,'_split_7day.mat'] ;
        ...
        ht_estimate_m=nan(nlon_tpx,nlat_tpx,nfiles);        
            ...
            if ilayer<=ilayer_depth_use_ssh
                ...
                [ht_estimate_m]=bagged_yearly_tree_temp_SSH_sal_paige_eqbox_test(iyear_mod,...
               ...
               ht_estimate=ht_estimate_m.*weight_c+ht_estimate;
                ...
                file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_split.mat'];
                [ht_estimate_m]=bagged_yearly_tree_temp_sal_paige_eqbox_test(iyear_mod,...
                    time_aviso,temp_use,...
                    nfiles,ht_estimate_m,TreePredictInfo,file_big_model,'a','all') ;
                ht_estimate=ht_estimate_m.*weight_a;
                ht_estimate_m=nan(nlon_tpx,nlat_tpx,nfiles);
