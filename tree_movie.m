...
v=VideoWriter([path_figs,'ohca_0_2000_combine_4.avi']);
open(v)
...
nfranme_delayed=find(junk_month==6 &junk_year ==2021, 1, 'last' );
for iframe=1:nfranme_delayed
figure(1)
clf
    set(gcf,'color','white');
...
%     save 'OHCA_2019_tpx.mat' lon lat corrhc
    ...
    hold on
    m_coast('patch',[1 1 1]);
    t1=m_text(30,100,[' ', date_name_junk(iframe,:)],'fontsize',12);
