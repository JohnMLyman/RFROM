function []=baggedtree_hold_out_all_years_seasonal_orca_novert_paige_eqbox(TreeSetUp)
...
% if ~exist([fname_nc,'_sst.mat'],'file')
   [sst]=find_oisst_4_mean_orca_model(coords(:,1),coords(:,2),yr,path_oisst,TreeSetUp);
...
parfor ilayer=2:nlayer
        ...
        if ilayer<=ilayer_depth_use_sst
            ...
            [model_all]=make_trees_mean_paige_eqbox(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'a',...
            ...
            [model_all]=make_trees_mean_paige_eqbox(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'b',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_paige_eqbox(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'c',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_paige_eqbox(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'d',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            ...
            [model_all]=make_trees_mean_nosst_paige_eqbox(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'a',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_paige_eqbox(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'b',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_paige_eqbox(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'c',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_paige_eqbox(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'d',...
            scale_box_deg_lat,scale_box_eq,lat_change);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name];
            parsave_model_all(file_big_model,model_all)
