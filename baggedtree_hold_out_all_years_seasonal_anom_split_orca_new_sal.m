function []=baggedtree_hold_out_all_years_seasonal_anom_split_orca_new_sal(TreeSetUp)
...
% % %     eval(['ht_all_junk{ilayer-1}=ht_',layer_name,';'])
...
%     pos_ht_finite=find(good_prof&good_yr);
    pos_ht_finite=find(good_prof&good_yr&main_layer);
    ...
    file_hold_out=[path_new_tree_all_year,tree_model_file_name_all_year,'_hold_out_data_',layer_name,'_split.mat'];
...
%     [model_all]=make_trees_mean(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof);
    ...
    file_big_model=[path_new_tree_all_year,tree_model_file_name_all_year,'_model_',layer_name,'_split.mat'];
