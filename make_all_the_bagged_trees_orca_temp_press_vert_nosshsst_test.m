...
var_type='t';
tree_prefix='tree_temp_vert_nosshsst_test';
...
start_year=1993.5;% these are the years of the data that are used for making the all years bagged trees
end_year=2022.5;

start_year_mean=2012.5; %if you want the weekly maps to start in jan 2007 the start_year is 2007.5
end_year_mean=2014.5;
max_year_fit=2021;
min_year_fit=2008;
...
toc./60./60
baggedtree_hold_out_yearly_overlap_seasonal_orca_vert_nosshsst(TreeSetUp)
'read_ssh_matfiles_yearly_overlap_seasonal_orca'
read_ssh_matfiles_yearly_overlap_seasonal_orca_vert_nosshsst(TreeSetUp)
toc./60./60
...
% make_model_stats_yearly_overlap_seasonal_orca_vert_nosshsst(TreeSetUp)
% toc./60./60
