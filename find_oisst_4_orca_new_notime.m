function [sst]=find_oisst_4_orca_new_notime(lonp,latp,yr,path_oisst)
...
for yr_value=load_years(end-1:end)
...
%   disp(yr_value)
  ...
  file_name_year=[path_oisst,'sst.day.anom.',yr_name,'.nc'];
  ...
  if exist(file_name_year,'file')
      ...
      if first_file==1
         ...
         sst_anom_year=ncread(file_name_year,'anom');
