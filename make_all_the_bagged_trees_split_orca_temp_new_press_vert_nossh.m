...
var_type='t';
tree_prefix='tree_temp_vert_nossh';
path_ERDDAP='H:\erddap\temp\vert\';
...
ilayer_depth_use_sst=43;

start_year=1993.5;
end_year=2022.5;

start_year_mean=2007.5; %if you want the weekly maps to start in jan 2007 the start_year is 2007.5
...
% 
% % % 'baggedtree_hold_out_yearly_overlap_seasonal_split_orca_new'
% % % toc./60./60
% % % baggedtree_hold_out_yearly_overlap_seasonal_orca_vert_nossh(TreeSetUp)
% % % 'read_ssh_matfiles_yearly_overlap_seasonal_orca'
% % % read_ssh_matfiles_yearly_overlap_seasonal_orca_vert_nossh(TreeSetUp)
% % % toc./60./60
...
% % % make_model_stats_yearly_overlap_seasonal_orca_vert_nossh(TreeSetUp)
% % % toc./60./60
...
baggedtree_hold_out_yearlyseasonal_anom_orca_vert_nossh(TreeSetUp)
toc./60./60

'read_ssh_matfiles_yearly_overlap_seasonal_anom_vert'
read_ssh_matfiles_yearly_seasonal_anom_orca_vert_nossh(TreeSetUp)
toc./60./60

'make_model_stats_yearly_overlap_seasonal_anom_split'
make_model_stats_yearly_overlap_seasonal_anom_orca_vert_nossh(TreeSetUp)

toc./60./60

'multi_add_seasonal_cycle'
multi_add_seasonal_cycle(TreeSetUp,TreeSetUp.path_new_tree_yearly,...
    TreeSetUp.tree_model_file_name_yearly,TreeSetUp.start_yearly_maps,...
    TreeSetUp.end_yearly_maps)

toc./60./60

'multi_write_erddap_file'
