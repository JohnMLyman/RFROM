function []=write_netcfd_cf_temp_depth_mon_single(temp_estimate,time_1950,lon_tpx,...
...
%     good=floor(time_aviso)==iyear;
    ...
    mean_depth_bnds_dimen(2).Name='mean_pressure';
    ...
    mean_depth_att(2).Value='The mean pressure';
    mean_depth_att(3).Name='bounds';
    mean_depth_att(3).Value='mean_pressure_bnds';
    ...
    ohca_att(2).Value=['mapped ocean conservative (TEOS-10) averaged ',...
