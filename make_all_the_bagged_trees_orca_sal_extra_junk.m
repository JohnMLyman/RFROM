...
% % % baggedtree_all_year_orca_sal_newcycle_anomt(TreeSetUp)
% % % toc./60./60
% % % 
% % % 'read_ssh_matfiles_all_years_orca_vert_sal_newcycle'
% % % read_ssh_matfiles_all_years_orca_vert_sal_newcycle_anomt(TreeSetUp)
% % % 
% % % toc./60./60
...
% read_ssh_matfiles_all_years_orca_vert_sal_exra_junk(TreeSetUp)
% toc./60./60
% % % 
...
% % % 
% % % stablize_t_and_sl_loess_errdap_fast(TreeSetUp)
% % % 
% % % toc./60./60
% % % 
% % % 
