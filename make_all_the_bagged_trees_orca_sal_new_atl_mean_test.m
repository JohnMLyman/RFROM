...
var_type='s';
tree_prefix='tree_sal_atl_3_n_mean_nosst_half';
tree_prefix_temp='tree_temp';
path_mat_nc='D:\monthly_temp\';
path_ERDDAP='H:\erddap\sal_3_n_mean_nosst_half\';
...
multi_write_mat_monthly_sal_yearly_all(TreeSetUp)
multi_write_nc_monthly_sal_yearly_all(TreeSetUp)
