function []=read_ssh_matfiles_all_years_seasonal_anom_split_orca22t(TreeSetUp)
load_TreeSetUp
%%
...
delta_years=end_all_year-start_all_year;
...
% %         else
%             min_tpx_year=floor(start_all_year)+isplit-1;
%             max_tpx_year=min_tpx_year+1;
% %         end
% 
