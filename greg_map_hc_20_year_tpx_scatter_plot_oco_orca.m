...
% if ~exist([heat_slope_file,'.mat'],'file')
    ...
    heat_slope_oco_realtime_tpx_700_layers_oco_orca
    
% else
%     eval(['load ',heat_slope_file,'.mat'])
% end
...
m_coast('patch',[1 1 1]);
t1=m_text(30,100,['(c) ',num2str(slope_min_year),'-',num2str(slope_max_year),' trend'],'fontsize',12,'fontname','arial','linew',0.1);
