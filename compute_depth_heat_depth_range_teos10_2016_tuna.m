function [heat]=compute_depth_heat_depth_range_teos10_2016_tuna(data,heat,coords,depth_int_top, depth_int_bottom)
   ...
   % if press_junk(1) < 15 && depth_junk(end) >= depth_int_bottom && press_junk(1)>=0 && numel(jj) >np_r
    ...
    if good_level==1 && press_junk(1)>=0 
        ...
        % fix bottom 
            ...
            heat(iprof)=trapz(depth_depth_int, ...
            gsw_rho(sal_depth_int,CT,press_depth_int).* ...
            gsw_cp0.*CT)';
