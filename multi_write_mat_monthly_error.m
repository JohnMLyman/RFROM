...
load([path_tree,tree_file_name,'_2xweight_7day.mat'], 'lon_tpx' ,'lat_tpx','time_aviso')
...
%     file_nc_prefix=['RFROM_OHCA_error_',layer_name,'_']
    ...
    tree_file_name=[tree_model_file_name,'_error_',layer_name];
     ...
     load([path_tree,tree_file_name,'_2xweight_7day.mat'], 'ht_error')
%     for itime=1:nyears
%         jyear=tgrid(itime);
   ...
   for iyear=year_start_nc:year_end_nc
       for imonth=1:12
           ...
           if ~isempty(good)
               ...
               ht_error_mon=single(ht_error_mon);
               lon_tpx=single(lon_tpx);
               lat_tpx=single(lat_tpx);
               save([path_mat_nc,file_name_mat_nc],'ht_error_mon','time_1950','lon_tpx','lat_tpx')
           end
