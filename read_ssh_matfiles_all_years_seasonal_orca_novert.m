function read_ssh_matfiles_all_years_seasonal_orca_novert(TreeSetUp)
...
tree_model_file_name_all_year_season=TreeSetUp.tree_model_file_name_all_yea_season;
...
path_new_tree_all_year_season=TreeSetUp.path_new_tree_all_year_season;
...
path_new_tree=path_new_tree_all_year_season;
tree_model=tree_model_file_name_all_year_season;
    ...
    for ilayer=2:nlayer
        ...
        if ilayer<=ilayer_depth_use_sst
            ...
            ht_estimate=ht_estimate_m.*weight_d+ht_estimate;
             ...
             file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_split.mat'];
            [ht_estimate_m]=bagged_yearly_tree_temp_SSH(iyear_mod,...
