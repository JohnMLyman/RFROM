function make_bagged_tree_ohca_maps_7_day_seasonal_split_mask(TreeSetUp)
load_TreeSetUp
...
load([path_tree,tree_file_name_anom,'_split_7day_mask.mat'], 'lon_tpx' ,'lat_tpx','time_aviso')
...
for ilayer=2:nlayer
   ...
   save([path_tree,tree_file_name,'_seasonal_cycle_expand_split_mask.mat'],'ht_cycle',...
