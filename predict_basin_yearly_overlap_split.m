function [ht_estimate]=predict_basin_yearly_overlap_split(lon,lat,yr,ssh,sst,...
    layer_name,tree_model_file_name,start_year,end_year,path_new_tree)
     ...
     for ibasin=1:nbasin
            ...
            if ibasin<= n_mod_basin
                ...
                if ibasin==5
                    ...
                    good=pos_basin & pos_finite&good_yr;
