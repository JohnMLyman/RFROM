function []=multi_write_nc_monthly_sal_yearly_nossh(TreeSetUp)
...
path_mat_erddap=[path_ERDDAP,'matlab\yearly_nossh\'];
path_nc_erddap=[path_ERDDAP,'netcdf\yearly_nossh\'];
