...
function multi_write_mat_monthly_temp_all_t_orca(TreeSetUp)
...
load([path_tree_temp,tree_file_name_temp,'_split_7day.mat'], 'lon_tpx' ,'lat_tpx','time_aviso')
...
%     tree_file_name_temp=[tree_model_file_name_season_temp,'_',layer_name];
%     tree_file_name_temp=[tree_model_file_name_temp,'_',layer_name];
    tree_file_name_temp=[tree_model_file_name_combined_temp,'_',layer_name];

    tree_file_name_season_temp=[tree_model_file_name_season_temp,'_',layer_name];

%     load([path_tree,tree_file_name,'_7day.mat'], 'ht_estimate','time_aviso')
    [ht_estimate,lon_tpx,lat_tpx, time_aviso]=load_season_tree([path_tree_temp,tree_file_name_temp,'_split_7day.mat']);
...
[ht_cycle,ht_mean,~]=load_cycle([path_tree_temp,tree_file_name_season_temp,'_seasonal_cycle_split.mat']...
