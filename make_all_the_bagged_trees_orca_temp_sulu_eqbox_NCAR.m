...
[TreeSetUp]=TreeSetUp_2025_orca_temp_press_novert_paige_sulu_eqbox_NCAR;
tic
...
% % % toc./60/60
% % % 
% % % 'read_ssh_matfiles_all_years_season_orca_novert_paige_eqbox'
...
% % % baggedtree_hold_out_all_years_orca_novert_paige_eqbox(TreeSetUp)
% % % toc./60./60
% % % 
% % % 'read_ssh_matfiles_all_years_orca_novert'
% % % read_ssh_matfiles_all_years_orca_novert_paige_eqbox(TreeSetUp)
% % % toc./60./60

'read_ssh_matfiles_all_years_orca_novert_extra'
read_ssh_matfiles_all_years_orca_novert_extra_paige_eqbox(TreeSetUp)
toc./60./60
