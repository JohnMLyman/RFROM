...
var_type='s';
tree_prefix='tree_sal_3_nosst';
tree_prefix_temp='tree_temp';
path_mat_nc='D:\monthly_temp\';
path_ERDDAP='H:\erddap\sal_3_nosst\';
path_ERDDAP_sal=path_ERDDAP;
path_ERDDAP_temp='H:\erddap\temp\';
...
file_name_season_anom=[file_name_season,'_anom_mean_t'];
...
fname_nc_season=[file_path_hdata,var_type,'data_new_layers_noEN4_',file_WOD_suf,'_',file_name_season];
fname_nc=[file_path_hdata,var_type,'data_new_layers_noEN4_',file_WOD_suf,'_',file_name_season_anom];
...
start_yearly_maps=2009;
end_yearly_maps=2011;
...
% % % 'baggedtree_hold_out_yearly_overlap_seasonal_split_orca_sal_new'
% % % % baggedtree_hold_out_yearly_overlap_seasonal_split_orca_sal_mean(TreeSetUp)
% % % % baggedtree_yearly_overlap_seasonal_split_orca_sal_mean_nosstssh(TreeSetUp)
% % % baggedtree_yearly_overlap_seasonal_split_orca_sal_mean_nosst(TreeSetUp);
% % % % baggedtree_yearly_seasonal_split_orca_sal_mean_nosst_nossh(TreeSetUp)
% % % % % % 'multi_write_mat_monthly_temp_mean_t_orca'
% % % % % % % multi_write_mat_monthly_temp_mean_t_orca(TreeSetUp)
% % % % % % multi_write_mat_monthly_temp_all_t_orca(TreeSetUp)
% % % 'read_ssh_matfiles_yearly_overlap_seasonal_orca_sal'
% % % % read_ssh_matfiles_yearly_overlap_seasonal_orca_sal_mean(TreeSetUp)
% % % read_ssh_matfiles_yearly_overlap_seasonal_orca_sal_mean_nosst(TreeSetUp);
% % % % read_ssh_matfiles_yearly_seasonal_orca_sal_mean_nosst_nossh(TreeSetUp)
% % % % 
% % % 'make_seasonal_cycle_tree_split_orca'
% % % make_seasonal_cycle_tree_split_orca(TreeSetUp);
% % % 'make_model_stats_yearly_overlap_seasonal_split_orca_sal'
% % % % make_model_stats_yearly_overlap_seasonal_split_orca_sal(TreeSetUp)
% % % make_model_stats_yearly_overlap_seasonal_split_orca_sal_nosst(TreeSetUp);
% % % % make_model_stats_yearly_seasonal_split_orca_sal_nosst_nossh(TreeSetUp)
% % % 
% % % %% write the erdap salinity files
% % % 'multi_write_mat_monthly_sal'
% % % multi_write_mat_monthly_sal_mean_noEN4(TreeSetUp)
% % % 'multi_write_nc_monthly_sal'
% % % multi_write_nc_monthly_sal_mean_noEN4(TreeSetUp)

% % % % % % % % % %% Make the yearlly anomally tree
% % % % % % % % % % 
'baggedtree_hold_out_yearly_overlap_seasonal_anom_split_orca_sal_new'
% baggedtree_hold_out_yearly_overlap_anom_split_orca_sal_new(TreeSetUp)
% baggedtree_yearly_overlap_anom_split_orca_sal_new_nosst(TreeSetUp)

% baggedtree_yearly_overlap_anom_split_orca_sal_new_nosst_nossh(TreeSetUp)
% baggedtree_yearly_overlap_anom_split_orca_sal_new_meant_t(TreeSetUp);
% baggedtree_yearly_anom_split_orca_sal_new_meant_t_nossh(TreeSetUp)
baggedtree_yearly_anom_orca_sal_new_meant_t_nossh_floor(TreeSetUp)

% baggedtree_yearly_anom_split_orca_sal_new_meant_t_nossh_bigleaf(TreeSetUp)
% baggedtree_yearly_anom_orca_sal_new_meant_t_nossh_nolatlon(TreeSetUp)


% % % 'multi_write_mat_monthly_temp_anom_t_orca'
%  multi_write_mat_monthly_temp_anom_t_orca(TreeSetUp)
'read_ssh_matfiles_yearly_overlap_seasonal_anom_split_orca2_sal'
% read_ssh_matfiles_yearly_overlap_seasonal_anom_split_orca2_sal(TreeSetUp)
% read_ssh_matfiles_yearly_anom_split_orca2_sal_nosst(TreeSetUp)
% read_ssh_matfiles_yearly_anom_split_orca2_sal_nosst_nossh(TreeSetUp)
% read_ssh_matfiles_yearly_anom_split_orca2_sal_mean_t(TreeSetUp);
% read_ssh_matfiles_yearly_anom_split_orca2_sal_mean_t_nossh(TreeSetUp)
read_ssh_matfiles_yearly_anom_orca2_sal_mean_t_nossh_floor(TreeSetUp)

% read_ssh_matfiles_yearly_anom_orca2_sal_mean_t_nossh_nolatlon(TreeSetUp)

'make_model_stats_yearly_overlap_seasonal_anom_split'
% make_model_stats_yearly_overlap_seasonal_anom_split_orca_sal(TreeSetUp)
% make_model_stats_yearly_anom_split_orca_sal_nosst(TreeSetUp);
% make_model_stats_yearly_anom_split_orca_sal_nosst_nossh_noEN4(TreeSetUp)
make_model_stats_yearly_anom_orca_sal_nosst_nossh_noEN4_floor(TreeSetUp)

% make_model_stats_yearly_anom_orca_sal_nosst_nossh_nolatlon(TreeSetUp)

% 
'write nc files'
% multi_write_mat_monthly_sal_yearly_mean_t(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_mean_t(TreeSetUp)
% multi_write_mat_monthly_sal_yearly_mean_t_nossh(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_mean_t_nossh(TreeSetUp)
% multi_write_mat_monthly_sal_yearly_mean_t_nossh_noEN4(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_mean_t_nossh_noEN4(TreeSetUp)
multi_write_mat_monthly_sal_yearly_mean_t_nossh_noEN4_floor(TreeSetUp)
multi_write_nc_monthly_sal_yearly_mean_t_nossh_noEN4_floor(TreeSetUp)
% multi_write_mat_monthly_sal_yearly_mean_t_nossh_bigleaf(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_mean_t_nossh_bigleaf(TreeSetUp)

% multi_write_mat_monthly_sal_yearly_mean_t_nossh_nolatlon(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_mean_t_nossh_nolatlon(TreeSetUp)
% multi_write_mat_monthly_sal_yearly(TreeSetUp)
% multi_write_nc_monthly_sal_yearly(TreeSetUp)
% multi_write_mat_monthly_sal_yearly_nosst(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_nosst(TreeSetUp)

% multi_write_mat_monthly_sal_yearly_nossh(TreeSetUp)
% multi_write_nc_monthly_sal_yearly_nossh(TreeSetUp)
...
% % % 'baggedtree_hold_out_all_years_seasonal_anom_split_orca_sal'
% % % baggedtree_hold_out_all_years_seasonal_anom_split_orca_new_sal(TreeSetUp)
% % % 'read_ssh_matfiles_all_years_seasonal_anom_split_orca22_sal'
% % % read_ssh_matfiles_all_years_seasonal_anom_split_orca22_sal(TreeSetUp)
% % % 'make_model_stats_all_years_seasonal_anom_split_sal'
% % % make_model_stats_all_years_seasonal_anom_split_orca_sal(TreeSetUp)
% % % 
% % % 
