...
% plot the heat content for 2005
figure(3);wysiwyg
lon=lon2;
lat=lat2;


corrhc=interp2(lat,lon,ht_2005,lat_tpx,lon_tpx');
corrhc(isnan(corrhc))=0;
corrhc=corrhc+tpxest_2005;
corrhc(isnan(msk2(2:end-1,:)))=NaN;
...
t1=text(70,50,'2005','fontsize',16,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90])
...
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_heat_content_diff_2007_oct_john_2006'])
eval(['print -dpng -f3 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_heat_content_diff_2007_oct_john_2005'])
eval(['print -dpng -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_heat_change_diff_2007_oct_john_2006_2005'])
