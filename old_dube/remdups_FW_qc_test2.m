...
for i=1:length(d)
  ...
  if exist(['./WOD05/qc/toss/w',num2str(d(i)),'.mat']);
    load(['./WOD05/qc/toss/w',num2str(d(i)),'.mat']);
...
%  leave in duplicates at this stage of the saQC
% take out latter
...
%  %%%%%%%%%Remove the duplicates once
 ...
 %%%%%%%%not in all three data bases.
  ...
  % save to new file
  save(['./All_Data/qc/test2/d',num2str(d(i)),'.mat'],'temp','coords','dt','npts','time', ...
