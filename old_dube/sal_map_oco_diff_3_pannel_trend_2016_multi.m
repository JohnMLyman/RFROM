...
load 'surface_sal_jan_2016_2002_2015_6_deg.mat' lat lon time one sal;
...
hold on
m_grid('tickdir','out','xtick',[60:60:360],'ytick',[-90:30:90],'linestyle','none','fontname','arial',...
...
set(h1,'linecolor','none')
hold on
m_grid('xtick',[60:60:360],'ytick',[-90:30:90],'box','on','tickdir','out','linestyle','none','fontname','arial',...
...
hold on
m_coast('patch',.999*[1 1 1]);
t1=m_text(30,100,['(b) ' num2str(fyear) '-' num2str(syear)],'fontsize',12,'fontname','arial');
...
%%%%%%%%%%%%%%%%%%
wysiwyg;orient tall
eval(['print -dpdf -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_jan_2016_3pannel'])

eval(['print -dtiff -r600 -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_jan_2016_3pannel'])