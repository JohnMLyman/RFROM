...
'cat'
gind=find(day>=datenum(1967,1,1)&day<datenum(2002,1,1)& ...
	~isnan(heatanom));
...
save /Users/johnlyman/data/Globalhc/HC/clim_2_1967_2002_700 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
