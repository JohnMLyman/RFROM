...
pj=plot(josh_time,josh_hc,'-*','color',mycor(6,:));

pjt=plot(josh_time,josh_hc_tpx,'-*','color',mycor(8,:));

phc=plot(time,hc,'-*','color',mycor(9,:));
...
eval(['print -dpng -f3 /Users/johnlyman/figs/oco/Oceans/hc_one_greg_oco_2010_josh'])
%%
