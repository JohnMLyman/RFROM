function [near,min_lon,max_lon,min_lat,max_lat]=find_wmo_square_floats_surface(wmo,del_deg)
...
near=NaN;
   ...
   if exist(['den_den_no_f',num2str(wmo),'.mat'])
    eval(['load den_den_no_f',num2str(wmo),'.mat;']);
