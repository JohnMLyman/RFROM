function [model_mean,mean_error]=j_fit_weighted_mean(t,y,w_in,dof)
...
% slope_error expressed as a standard error
...
y_model_err_95=student(dof)*(model_err(1));

model_mean=model(1);
mean_error=model_err(1);
