...
load('/Users/lyman/Documents/MATLAB/BASS_2016/bass_matlab_2016.mat')

s=length(bass_month);

sss_WOD2009_bass=repmat(sss_WOD2009,1,1,1,7);
...
sss_bass_quart(:,:,1)=squeeze(nanmean(sss_bass(:,:,:,72:74),4));
e_bass_quart(:,:,1)=max(squeeze(ebass(:,:,:,72:74)),[],3);

sss_bass_quart(:,:,2)=squeeze(nanmean(sss_bass(:,:,:,75:77),4));
e_bass_quart(:,:,2)=max(squeeze(ebass(:,:,:,75:77)),[],3);

sss_bass_quart(:,:,3)=squeeze(nanmean(sss_bass(:,:,:,78:80),4));
e_bass_quart(:,:,3)=max(squeeze(ebass(:,:,:,78:80)),[],3);


sss_bass_quart(:,:,4)=squeeze(nanmean(sss_bass(:,:,:,81:83),4));
e_bass_quart(:,:,4)=max(squeeze(ebass(:,:,:,81:83)),[],3);
...
% 
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_bass_one_2013v2'])
eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_bass_one_2013v2'])

eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_bass_one_2013v2'])
