function []=heat_map_oco_2012_diff_2_pannel_gen(year_start,year_end)
...
for i=1:length(tgrid)   
  ...
  for j=1:length(ii)
    load(['../../Mtpers/realtime_2012/',s(ii(j)).name],'sshanom')
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2012_realtime_2010_2p_',num2str(start_year-.5)])
