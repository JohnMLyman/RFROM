function [y_model,y_model_err,slope_error,slope,dof]=j_fit_tim(t,yin)
...
%       OUTPUTS
% y_model the line
% y_model_err  one standard devation on y_model 
...
y_model_err=(sqrt(model_err(2)+((t- mean(t))*model_err(1)).^2)).*scale_fit;
