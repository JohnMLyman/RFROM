function [y_model,y_model_err_95,slope_error,slope]=j_fit_mean(t,yin,scale)
...
y_model=(model(1)).*scale_fit;
y_model_err_95=student(dof)*sqrt(model_err(1)).*scale_fit;
