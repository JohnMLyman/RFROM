function [hc,time,hc_one,one_curve,Area]=heat_curv_gen_mat_topo_new_layers_karina_lat(file_name_in,depth_min,depth_max,lats,latn)


% latn defines that northern boundery of the integrated area
% lats defines that southern boundery of the integrated area
