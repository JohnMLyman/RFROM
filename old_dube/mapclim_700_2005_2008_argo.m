...
'cat'
gind=find(day>=datenum(2005,1,1)&day<datenum(2008,1,1)& ...
	~isnan(heatanom));
...
save /Users/johnlyman/data/Globalhc/HC/clim_2_2005_2008_argo_700 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
