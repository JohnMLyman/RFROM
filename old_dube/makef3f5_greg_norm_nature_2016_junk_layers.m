...
% % 
%load '/Volumes/Data/OHCA_curves/total_uncertainty_paper_2015_0_700_1800_oco'  time_se total_se_0_700 samp_un_sd_700_1800 total_se_0_1800

load '/Volumes/ThunderBay/Data/OHCA_curves/total_uncertainty_paper_2016_0_1800_oco_2'  time_se  total_se_0_1800 total_se_0_700

time_se=time_se' ;
hc_se=total_se_0_700;
% % % hc_se_deep=samp_un_sd_700_1800 ;

hc_se_total=total_se_0_1800;
...
cd ../HC/
 ...
 [hc_100,time,hc_one_100,Area_100]=heat_curv_gen_mat_2012_new_un_topo('hdata_new_layers__ishii_EN3_2014_argo_2016_9_16_QC1950_2015_0_100_real_new_layers',0,100);
[hc_100_300,time,hc_one_100_300,Area_100_300]=heat_curv_gen_mat_2012_new_un_topo('hdata_new_layers__ishii_EN3_2014_argo_2016_9_16_QC1950_2015_100_300_real_new_layers',100,300);
 [hc_300_700,time,hc_one_300_700,Area_300_700]=heat_curv_gen_mat_2012_new_un_topo('hdata_new_layers__ishii_EN3_2014_argo_2016_9_16_QC1950_2015_300_700_real_new_layers',300,700);
 [hc_700_900,time,hc_one_700_900,Area_700_900]=heat_curv_gen_mat_2012_new_un_topo('hdata_new_layers__ishii_EN3_2014_argo_2016_9_16_QC1950_2015_700_900_real_new_layers',700,900);
 [hc_900_1800,time,hc_one_900_1800,Area_900_1800]=heat_curv_gen_mat_2012_new_un_topo('hdata_new_layers__ishii_EN3_2014_argo_2016_9_16_QC1950_2015_900_1800_real_new_layers',900,1800);

 
 good_junk=find(time>= 1992);
 hc_100=hc_100(good_junk);
 hc_one_100=hc_one_100(good_junk);
 Area_100=Area_100(good_junk);
 
 hc_100_300=hc_100_300(good_junk);
 hc_one_100_300=hc_one_100_300(good_junk);
 Area_100_300=Area_100_300(good_junk);
 
 hc_300_700=hc_300_700(good_junk);
 hc_one_300_700=hc_one_300_700(good_junk);
 Area_300_700=Area_300_700(good_junk);
 
 hc_700_900=hc_700_900(good_junk);
 hc_one_700_900=hc_one_700_900(good_junk);
 Area_700_900=Area_700_900(good_junk);
 
 hc_900_1800=hc_900_1800(good_junk);
 hc_one_900_1800=hc_one_900_1800(good_junk);
 Area_900_1800=Area_900_1800(good_junk);
 time=time(good_junk);
 
 
  save '/Volumes/ThunderBay/Data/Globalhc/SAL/Floats/ohca_1992_2015_curve_100_300_700_900_1800_jan_2016_area_new_layers' time hc_one_100 hc_one_100_300 ...
      hc_one_300_700 hc_one_700_900 hc_one_900_1800 hc_100 hc_100_300 hc_300_700 hc_700_900 hc_900_1800 ...
      Area_100 Area_100_300 Area_300_700 Area_700_900 Area_900_1800
% % load '/Volumes/Data/Globalhc/SAL/Floats/ohca_1992_2015_curve_100_300_700_900_1800_jan_2016_area' time hc_one_100 hc_one_100_300 ...
% %       hc_one_300_700 hc_one_700_900 hc_one_900_1800 hc_100 hc_100_300 hc_300_700 hc_700_900 hc_900_1800 ...
% %       Area_100 Area_100_300 Area_300_700 Area_700_900 Area_900_1800
% % load '/Volumes/Data/Globalhc/SAL/Floats/ohca_1992_2015_curve_100_300_700_900_1800_jan_2016' time hc_one_100 hc_one_100_300 ...
% %       hc_one_300_700 hc_one_700_900 hc_one_900_1800 hc_100 hc_100_300 hc_300_700 hc_700_900 hc_900_1800
% % % % % load '/Volumes/Data/Globalhc/SAL/Floats/ohca_1950_2015_curve_100_300_700_900_1800_jan_2016' time hc_one_100 hc_one_100_300 hc_one_300_700 hc_one_700_900 hc_one_900_1800
time_one=time;
hc_one=hc_one_100+hc_one_100_300+hc_one_300_700;
 

 hc_one_deep=(hc_one_700_900+hc_one_900_1800)./1e21;
 hc_one_total=(hc_one_100+hc_one_100_300+hc_one_300_700+hc_one_700_900+hc_one_900_1800)./1e21
 time_deep=time;
good_se_deep=find(time_se>= min(time_deep));
% % % hc_se_deep=hc_se_deep(good_se_deep);
hc_se_total=hc_se_total(good_se_deep);
...
%%
load /Volumes/ThunderBay//Data/Globalhc/SAL/Floats/simon_hc_2015
...
load /Volumes/ThunderBay//Data/Globalhc/SAL/Floats/tim_hc_2015
good_tim=find(tim_time> min_year);
tim_time=tim_time(good_tim);
tim_se=tim_se(good_tim);
tim_hc=tim_hc(good_tim);

load /Volumes/ThunderBay//Data/Globalhc/SAL/Floats/ishii_hc_2015
...
load /Volumes/ThunderBay//Data/Globalhc/SAL/Floats/catia_hc_2015
...
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/tim_hc_2016_deep.mat tim_hc_deep tim_time_deep tim_se_deep
...
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/ishii_hc_2015_deep.mat ishii_hc_deep ishii_time_deep ishii_se_deep
% tim_hc_deep=hc_one_deep';
% tim_time_deep=time_deep;
% tim_se_deep=hc_se_deep;


%load /Volumes/Data/Globalhc/SAL/Floats/ishii_hc_2016_deep.mat ishii_hc_deep ishii_time_deep ishii_se_deep
...
hc_one_total=hc_one_total(pos_deep);
time_deep=time_deep(pos_deep);
% % % hc_se_deep=hc_se_deep(pos_deep);
hc_se_total=hc_se_total(pos_deep);
...
set(gca,'tickdir','out','Fontsize',16,'Fontname','Arial','box','on','pos',[.15 .26-.01 .75 plot_height],'xtick',[1970:5:max_year],'XAxisLocation','bottom',...
    'ytick',[min_ohca:20:max_ohca])
axis([min_year max_year min_ohca max_ohca])
...
text(1994.5,55,'(b)','Fontsize',16,'Fontname','Arial','Fontweight','Bold')
...
text(year_text,text_off+text_del*3,'700m > z > 1800m','color',mycor(1,:),'FontName','Arial','FontSize',text_size)
plot([year_text-2 year_text-1],[text_off+text_del*3 text_off+text_del*3],'color',mycor(1,:),'linewidth',3)
...
% 
% 
%  eval(['print -dpng -f3 /Users/lyman/figs/oco/Oceans/curve_oco_2016_topo_2_panel_NCEI'])
...
se_rate_1800_oco=sqrt(hc_se_total(1:end-1).^2+hc_se_total(2:end).^2).*1e21*fac;

rate_1800_oco=diff(hc_one_total).*fac .*1e21;
time_1800_oco=.5.*(time_deep(1:end-1)+time_deep(2:end));
rate_1800=rate_1800_oco;
se_rate_1800=se_rate_1800_oco;
time_rate=time_1800_oco;
OHCA_1800=hc_se_total;
se_OHCA_1800=hc_se_total;
OHCA_1800=hc_one_total;
time_OHCA=time_deep;
...
save greg_rate_OHCA_1800_new_new_layers rate_1800 se_rate_1800 time_rate OHCA_1800 ...
    se_OHCA_1800 time_OHCA per_100 per_100_300 per_300_700 per_700_900 ...
    per_900_1800 per_0_1800 time_per
figure(100)
...
load greg_rate_OHCA_1800_old2_layers rate_1800 se_rate_1800 time_rate OHCA_1800 ...
    se_OHCA_1800 time_OHCA per_100 per_100_300 per_300_700 per_700_900 ...
