...
function mapdiff_gen_allheat_realtime_temp(file_name,fname_nc,clim_file)
...
% remove annual cycle
load ../Levitus/levcyc_700_temp levheatcyc lon lat mo
...
save hregress_reatime_temp alat alon alpha c xvar
end % of skip
