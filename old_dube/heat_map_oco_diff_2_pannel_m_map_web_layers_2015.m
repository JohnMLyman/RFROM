...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,'a) 2014','fontsize',11,'fontweight','bold');
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,'b) 2014-2013','fontsize',11,'fontweight','bold');
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2015_webn2'])
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2015_webn2'])

eval(['print -dtiff -r300 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2015_webn2'])
