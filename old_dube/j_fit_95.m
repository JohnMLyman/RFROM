function [y_model,y_model_err_95,slope_error,slope]=j_fit_95(t,yin)
...
% slope_error at the 95% interval on the standard error
...
slope_error=student(dof).*slope_error*scale_fit;
