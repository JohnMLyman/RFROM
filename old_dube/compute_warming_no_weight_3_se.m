function [txt]=compute_warming_no_weight_3_se(mean_ohca,total_error_ohca,tgrid_ohca)
...
w_hc=1./(std_error.^2);
 [y_model,y_model_se,slope_error_hc,sl_hc]=j_fit_se(tgrid,hc_2,1);
 
 
 slope_error_hc=slope_error_hc*scale_fit_hc./area_of_earth;
sl_hc=sl_hc*scale_fit_hc./area_of_earth;

w3=num2str(sl_hc/86400/365.25,'%5.3f');
