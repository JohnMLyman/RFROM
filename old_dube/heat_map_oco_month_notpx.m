...
caxis([min_val max_val])
xlabel('2004-2007 Monthly Upper Ocean Heat Content Anomaly [J m^{-2} x 10^9] no tpx')
...
corrhc=(corrhc).*1e9./((60*60*24*365.5./12.));
corrhc(isnan(msk2(2:end-1,:)))=NaN;
...
set(j,'tickdir','out','xaxisl','top','xtick',[min_val:del_val:max_val],'ytick',[])
caxis([min_val max_val])
xlabel('2004-2007 1-month Heat Content Change [W m^{-2}] no tpx')
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/oco_monthly_notpx_heat_', num2str(month_plot)])
eval(['print -dpng -f2 /Users/johnlyman/figs/oco/oco_monthly_notpx_heat_diff_',num2str(month_plot)])
