...
c                     12345678901234567890123456789012345678901234567890123
	dfname(1:24)='hdata_twin_1997_1993.txt'
	nfname(1:26)='hdata_twin_1997_1993.notes'
	mfname(1:22)='map_twin_1997_1993.txt'
c get name of file with input data and read in data
	open(66,file='input4',form='formatted',status='old')
	read(66,'(a24)'),dfname(1:24)
	close(66)
	nfname(1:20)=dfname(1:20)
	mfname(10:18) = dfname(12:20)
...
c load grid info
	open(66,file='map_twin.grd',form='formatted',status='old')
