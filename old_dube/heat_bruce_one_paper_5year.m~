...
pos1=find(tgrid>= 1993.5 & tgrid<=2002.5);
pos2=find(tgrid>= 1994.5 & tgrid<=2003.5);
pos3=find(tgrid>= 1995.5 & tgrid<=2004.5);
pos4=find(tgrid>= 1996.5 & tgrid<=2005.5);
pos5=find(tgrid>= 1996.5 & tgrid<=2005.5);
