...
ncload('htanom_q1_no_te_1950_2006_2000_2004.nc','lat','lon','time','one','htdiff');
htdiff=permute(htdiff,[3 2 1])./1e9;
one=permute(one,[3 2 1]);
...
set(j,'tickdir','out','xaxisl','top','xtick',[min_val:del_val:max_val],'ytick',[])
caxis([min_val max_val])
xlabel('2-year Heat Content Change [W m^{-2}]')
...
eval(['print -dpng -f1 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_heat_content3_2006'])
eval(['print -dpng -f2 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_heat_change3_2006_2004'])
