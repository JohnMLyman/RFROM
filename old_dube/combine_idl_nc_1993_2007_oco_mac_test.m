...
ncload('htanom_mac_test_1993_2001.nc','lon','lat','ht','htdiff','time','one','tpx','error')
...
ncload('htanom_mac_test_2002_2007.nc','lon','ht','time','htdiff','one','tpx','error')
ht_t=[ht_t;ht];
...
save 'htanom_1993_2007_mac_test' time lon lat one ht tpx error htdiff
