...
m_coast('patch',.999*[1 1 1]);
t1=m_text(55,54,['b) ' num2str(fyear) '-' num2str(syear)],'fontname','arial','fontsize',12,'linew',0.1);
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2015_',num2str(fyear)])
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2015_',num2str(fyear)])
% 
