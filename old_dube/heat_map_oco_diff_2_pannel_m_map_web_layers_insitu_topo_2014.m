...
load /Users/johnlyman/data/Globalhc/topo/topo_tpx
...
eval(['load ../../HC/',name_pre_file,'_100_real']);
end

if depth_max==300
        
eval(['load ../../HC/',name_pre_file,'_100_300_real']);
end
if depth_max==700
        
eval(['load ../../HC/',name_pre_file,'_300_700_real']);

end
if depth_max==900
        
eval(['load ../../HC/',name_pre_file,'_900_real']);
end

if depth_max==1800
      
eval(['load ../../HC/',name_pre_file,'_1800_real']);  
...
ht_all=(htdiff_300_700(:,:,ind_all))./1e9;
...
ht_2008=ht_2008_300_700;
ht_2007=ht_2007_300_700;
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,['a) 2013 ', num2str(depth_max),'m'],'fontsize',11,'fontweight','bold');
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,'b) 2013-2012','fontsize',11,'fontweight','bold');
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2013_web_2013_2012_insitu_new_june_no_ind_topo_',num2str(depth_max)])
%eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2013_web_2013_2012_insitu_new_topo'])
