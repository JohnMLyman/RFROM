...
good_time=find(time>=slope_min_year);
time=time(good_time);
...
% eval(['save slope_salt_',file_surface_name,'_', year_of_oco_pub,' slope error time lat lon'])
save(['slope_salt_',file_surface_name,'_', num2str(year_of_oco_pub),'.mat'],'slope','error','time','lon','lat')
