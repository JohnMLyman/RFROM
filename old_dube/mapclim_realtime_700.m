...
alat=lat;alon=ln;
save hregress_realtime_clim alat alon alpha crl xvar
%return
cds=cd;
...
save clim_realtime_2012_700 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
