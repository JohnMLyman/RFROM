...
ncload('htanom_no_te2_2006_2006.nc','lat','lon','time','one','ht','htdiff');
htdiff=permute(htdiff,[3 2 1])./1e9;
one=permute(one,[3 2 1]);
ind_2006=find(time == 2006.5);
...
ncload('htanom_no_te2_2005_2005.nc','lat','lon','time','one','ht','htdiff');
htdiff=permute(htdiff,[3 2 1])./1e9;
one=permute(one,[3 2 1]);
...
eval(['print -dpng -f1 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_insitu_heat_diff_est_content_john_2006'])
eval(['print -dpng -f2 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_insitu_heat_diff_est_change_john_2006_2004'])
