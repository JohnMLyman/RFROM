...
% % % load '/Volumes/Data/OHCA_curves/total_uncertainty_paper_2015_0_700_1800_oco'  time_se total_se_0_700 samp_un_sd_700_1800
% % % del_time=max_year-2010-1;
% % % time_se=[time_se' [2010.5:1:2010.5+del_time]];
% % % hc_se=[total_se_0_700 repmat(total_se_0_700(end),1,del_time)];
% % % samp_700_1800=[samp_un_sd_700_1800 repmat(samp_un_sd_700_1800(end),1,del_time)];
...
%  [hc,time,hc_one_300_700]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131992_2012_300_700_real');
 ...
 [hc,time,hc_one_100]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_oct_2015_QC1950_2015_100_real',0,100);
[hc,time,hc_one_100_300]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_oct_2015_QC1950_2015_100_300_real',100,300);
 [hc,time,hc_one_300_700]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_oct_2015_QC1950_2015_300_700_real',300,700);
 [hc,time,hc_one_700_900]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_oct_2015_QC1950_2015_900_real',700,900);
 [hc,time,hc_one_900_1800]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_oct_2015_QC1950_2015_1800_real',900,1800);
 hc_one=hc_one_100+hc_one_100_300+hc_one_300_700;
% save '/Volumes/Data/Globalhc/SAL/Floats/nature_2015_nov_ohca_curve_oco_greg2_2014_topo' time hc_one hc_se
% load '/Volumes/Data/Globalhc/SAL/Floats/nature_2015_nov_ohca_curve_oco_greg2_2014_topo' time hc_one hc_se
...
save '/Volumes/Data/Globalhc/SAL/Floats/ohca_1950_2015_curve_100_300_700_900_1800' time hc_one_100 hc_one_100_300 hc_one_300_700 hc_one_700_900 hc_one_900_1800
...
eval(['print -dpng -f3 /Users/lyman/figs/oco/Oceans/curve_oco_2016_topo'])
