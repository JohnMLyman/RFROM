function []=tpx_heat_map_oco_2010_diff_2_pannel_gen(year_start,year_end)
...
caxis([min_val max_val])
xlabel('Upper Ocean Heat Content Anomaly Proxy [J m ^{-2} x 10^9]')
...
corrhc=(tpxest_change).*1e9./((60*60*24*365.5));
corrhc(isnan(msk2(2:end-1,:)))=NaN;
...
caxis([min_val max_val])
xlabel('1-year Heat Content Change Proxy [W m ^{-2}]')
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2010_realtime_2010_2p_proxy_uh_',num2str(start_year-.5)])
