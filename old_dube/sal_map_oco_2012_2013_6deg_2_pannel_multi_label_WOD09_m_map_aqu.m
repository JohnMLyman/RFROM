...
function [syear]=sal_map_oco_2012_2013_6deg_2_pannel_multi_label_WOD09_m_map_aqu(fyear)
...
load 'surface_sal_jan_2014_2002_2013_6_deg.mat' lat lon time one sal;

load '/Volumes/Data/Aquaris/Aq_2014/aquarius_sss_2012.mat' lat lon sss;
lat=lat';
lon=lon';
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2014'])
eval(['print -depsc2 -r300 -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2014'])
