function [std_error,time,f2]=twin_error_realtime_2012_100_junk(jdepth)
...
time=[1950.5:1:2003.5];
for i=1:length(time)
   
    iyear=time(i);    
   
   [tsub,hc2,time_twin]=heat_curv_gen_twin_realtime_2012( ['allheat_twin_',depth,'_',num2str(iyear),'.mat_tpx_map.mat'],depth);
