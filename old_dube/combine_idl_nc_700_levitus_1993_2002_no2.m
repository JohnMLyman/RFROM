...
ncload('htanom_700_1993_2002_no2_1993_1995.nc','lon','lat','ht','htdiff','time','one','tpx','error')
...
%one(isnan(one))=0;
%tps(isnan(tpx))=0;
save 'htanom_1993_2002_no2_1993_1995_700_levitus' time lon lat one ht tpx error htdiff
