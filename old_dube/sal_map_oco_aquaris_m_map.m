...
function [sname]=sal_map_oco_aquaris_m_map(smonth,fmonth)
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(smonth),'_',num2str(fmonth),'_aquaris'])
%eval(['print -depsc2 -r600 -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2010_2009_2_pannel_label2mauto'])
