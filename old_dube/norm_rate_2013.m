...
time_error=[time, time(end)+1,time(end)+2,time(end)+3,time(end)+4];
...
[hc,time,hc_one_100_300]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131991_2012_100_300_real');
 ...
 [hc,timen,hc_one_700_900]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131950_2012_900_real');
  good_900=find(ismember(timen,time));
 
 [hc,timen,hc_one_900_1800]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131950_2012_1800_real');
 good_1800=find(ismember(timen,time));
 
 hc_one_700=hc_one_100+hc_one_100_300+hc_one_300_700;
 hc_one_1800=hc_one_700+hc_one_700_900(good_900)+hc_one_900_1800(good_1800);
