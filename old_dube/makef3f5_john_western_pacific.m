...
load hcseries_western_pacific

max_ind=length(tgrid);
min_ind=find(tgrid == 1993.5);
max_ind=find(tgrid == 2004.5);
...
hc=hc_south(min_ind:max_ind);

tp=hc_north(min_ind:max_ind);
df=hc_all(min_ind:max_ind);
...
error=sqrt((student(36)*.6e7)^2+samp_error.^2)+1.1e7;
...
% print plot
print -deps2 -f1 /home/shoko/C/'IDL ps/'heat/f3_john_west.eps
print -dpng -f1 /home/shoko/C/'IDL ps/'heat/f3_john_west.png
...
% % 
% % set(a,'YAxisLocation','right','color','none','ygrid','off', ...
% % hc_all'xgrid','off','box','off','xtick',[])
...
axis([min_year max_year .0e8 .25e8])
set(gca,'fontsize',16)
...
set(a,'YAxisLocation','right','color','none','ygrid','off', ...
'xgrid','off','box','off','xtick',[])
 axis(a,[min_year max_year 0e8 .25e8])
set(a,'fontsize',16)
title('sampling error')
% print plot
print -deps2 -f3 /home/shoko/C/'IDL ps/'heat/ferror_john_west.eps
print -dpng -f3 /home/shoko/C/'IDL ps/'heat/ferror_john_west.png
