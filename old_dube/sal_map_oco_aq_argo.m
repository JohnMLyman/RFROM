...
function [syear]=sal_map_oco_aq_argo(fyear)
'cat'


load /Volumes/Data/WOA09/salinity_annual_1deg.mat sal lat lon depth
...
load('/Volumes/Data/Aquaris/Aq_2015/aquarius_v3_sss_201109-201412.mat')

sss_2014=nanmean(sss(:,:,40-11:40),3)'-sss_lev;
sss_2013=nanmean(sss(:,:,40-12-11:40-12),3)'-sss_lev;
...
load 'surface_sal_jan_2015_2002_2014_6_deg.mat' lat lon time one sal;
...
corrhc2=interp2(lat,lon,surface_sal_2007,lat_aq,lon_aq');

corrhc=sss_2014-corrhc2;
...
caxis([min_val max_val-del_cont])
xlabel('Aquarius-Argo Surface Salinity Anomaly [PSS-78] ')
...
lat=lat2;
 ...
 corrhc2=interp2(lat,lon,surface_sal_2007-surface_sal_2006,lat_aq,lon_aq');
% corrhc(isnan(msk2(2:end-1,:)))=NaN;
% land_mask=msk2(2:end-1,:);

corrhc=sss_2014-sss_2013-corrhc2;
lon=lon_aq;
lat=lat_aq;
...
caxis([min_val max_val-del_cont])
xlabel('Aquarius-Argo Surface Salinity Change [PSS-78 yr ^{-1}]')
...
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_jan_2015_2_aq_ar'])
