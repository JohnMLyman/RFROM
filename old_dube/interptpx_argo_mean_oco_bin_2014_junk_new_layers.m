...
eval(['load ',file_path_out,file_name,'_heat_oa_amon_oco_bin_no_season_new_layers '...
    'heat_0_40_anom heat_40_90_anom heat_90_190_anom heat_190_290_anom '...
    'heat_290_450_anom heat_450_700_anom heat_700_950_anom ',...
    'heat_950_1450_anom heat_1450_1950_anom heat_1950_2000_anom ',...
    'heat_0_40 heat_40_90 heat_90_190 heat_190_290 heat_290_450 ',...
    'heat_450_700 heat_700_950 heat_950_1450 heat_1450_1950 heat_1950_2000 ',...
...
for ilayer=2:length(layer_bounds)
         ...
         num2str(layer_bounds(ilayer)),'_anom;'])
end
...
% took out topex from save John Lyman 11/12/2015
 eval(['save ',file_path_out,'allheat_new_layers',allheat_extra,...
