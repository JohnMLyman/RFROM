...
time_error=time;
time_all_error=[time_all 2007.5 2008];
error_all=[error_all error_all(end) error_all(end)];

cd ../SAL/Floats

[hc,time,hc_one]=heat_curv_gen_mat('htanom_oco_realtime_1993_2008.mat');
[hc,time,hc_diff]=heat_curv_gen_mat_diff('htanom_oco_realtime_1993_2008.mat');
...
error_all=interp1(time_all_error,error_all,time);
time_all_error=time;
close all
...
eval(['print -dtiff -f2 /Users/johnlyman/figs/oco/poster/hc_oco_2008_cosc'])
