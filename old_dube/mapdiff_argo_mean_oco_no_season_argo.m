...
eval(['load ',file_path_out,'allheat_100_300_700_900_1800_argo_WOD_new ht_100 ht_300 ht_700 ht_900 ht_1800 ht_100_300 ht_300_700 cds dt  mdep  topex'])
...
good_time=find(dt(:,1) >=min_year & dt(:,1)<= max_year);
    ...
    eval(['save ',file_path_out,'hregress_1800_2 alpha_1800 c_1800 xvar_1800 alat alon']);
...
fname_nc=[file_path_hdata,'hdata_new_argo_',file_name];
