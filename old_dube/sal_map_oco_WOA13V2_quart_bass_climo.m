...
load('/Users/lyman/Documents/MATLAB/BASS_2018/bass_matlab_2018.mat')
...
NODC_sss_bass=[NODC_sss_bass(jj,:,:,:);;;NODC_sss_bass(ii,:,:,:)];
sss_WOD2009_bass=[sss_WOD2009_bass(jj,:,:,:);;;sss_WOD2009_bass(ii,:,:,:)];
plot_year=2018;

nm=12*(2016-plot_year);
...
ndoc(:,:,1)=squeeze(nanmean(NODC_sss_bass(:,:,:,72:74),4));
ndoc(:,:,2)=squeeze(nanmean(NODC_sss_bass(:,:,:,75:77),4));
ndoc(:,:,3)=squeeze(nanmean(NODC_sss_bass(:,:,:,78:80),4));
ndoc(:,:,4)=squeeze(nanmean(NODC_sss_bass(:,:,:,81:83),4));
wod(:,:,4)=squeeze(nanmean(sss_WOD2009_bass(:,:,:,81:83),4));
wod(:,:,3)=squeeze(nanmean(sss_WOD2009_bass(:,:,:,78:80),4));
wod(:,:,2)=squeeze(nanmean(sss_WOD2009_bass(:,:,:,75:77),4));
wod(:,:,1)=squeeze(nanmean(sss_WOD2009_bass(:,:,:,72:74),4));

sss_bass_quart=wod-ndoc;
for iyear=1:4
...
% 
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Sal/oco_quart2_surface_sal_bass_one_2013v2_climo_new'])
% % eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_2013v2_',num2str(plot_year),'_new'])
% % 
% % eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_2013v2_',num2str(plot_year),'_new'])
