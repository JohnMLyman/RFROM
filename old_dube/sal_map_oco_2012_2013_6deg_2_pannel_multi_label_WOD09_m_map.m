...
function [syear]=sal_map_oco_2012_2013_6deg_2_pannel_multi_label_WOD09_m_map(fyear)
'cat'
syear=fyear-1;
...
caxis([min_val max_val-del_cont])
xlabel('Surface Salinity Change [PSS-78 yr ^{-1}]')
...
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2014_2'])
