function []=nc_idl_surface_sal_nov_2007(filename)
...
nc = netcdf('surface_sal_nov_2007.nc', 'clobber');              % Create NetCDF file.
...
load /Volumes/Data/Globalhc/SAL/Floats/argo/all_surface
