...
ind_all=find(time>1993 & time <2019);
ht_all=(htdiff(:,:,ind_all))./1e9;
ht_all2=(ht(:,:,ind_all))./1e9;
...
% % 'cat'
% % save 'OHCA_2016_tpx.mat' lon lat corrhc
hold on
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_ins_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_ins_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])

eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_ins_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
