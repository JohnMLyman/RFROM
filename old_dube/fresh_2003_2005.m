...
[lon,lat,time,fresh]=load_idl_data_fresh('fresh_new_2003_2005.nc')
error=fresh;
error=1-(error-2.2);
 lon2=lon;
...
corrhc=interp2(lat,lon,fresh(:,:,i),lat_tpx,lon_tpx')./1e9;
corrhc(isnan(msk2(2:end-1,:)))=NaN;

corrhc_one=interp2(lat,lon,fresh(:,:,i),lat_tpx,lon_tpx');
