...
load allheat_oco_realtime_700_temp
load ../Levitus/hlevhr_700_temp
...
% pick only data from 1993 through 2008
tpx=topex(:,1);
day=datenum(dt);

'cat'
gind=find(day>=datenum(2004,1,1)&day<datenum(2012,1,1)& ...
	~isnan(tpx+heatanom));
...
alat=lat;alon=ln;
save hregress_realtime_clim_temp alat alon alpha crl xvar
%return
cds=cd;
...
save clim_realtime_2012_700_temp gheatclim gheatclim2 ln lon lat map tpxmap levheat 
