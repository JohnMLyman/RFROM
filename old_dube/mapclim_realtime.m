...
'cat'
gind=find(day>=datenum(2004,1,1)&day<datenum(2011,1,1)& ...
	~isnan(tpx+heatanom));
...
save clim_realtime_2011 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
