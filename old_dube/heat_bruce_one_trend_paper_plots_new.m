...
axis([1955 2007 0 1])
ylabel('Slope of linear trend [watts m^{-2}] ','fontsize',16);
set(p1,'linewidth',4)
...
eval(['print -dtiff -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/aviso_estimate_new'])
eval(['print -dtiff -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/aviso_estimate_slope_new'])
