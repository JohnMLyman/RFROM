...
max_year=(iyear)+(time_scale*2);
min_year=(iyear)-(time_scale*2);
...
eval(['save ./twin/monthly/allheat_twin_',num2str(idepth),'_',num2str(iyear),'.mat yr_proxy cds_proxy topex'])
end
end
