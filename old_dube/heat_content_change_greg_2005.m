...
corrhc_change=corrhc/86400/365.25;
lon_change=lon;
...
caxis([min_val max_val])
xlabel('Heat Content Anomaly [J m^{-2} x 10^9]')


subplot(2,1,2)
% put into the proper coordinates
lon=lon_change;
corrhc=corrhc_change;
min_val=-80
max_val=80
del_val=10
...
eval(['print -dtiff -f1 heat_content_change_JIMAR_',num2str(start_year)])
