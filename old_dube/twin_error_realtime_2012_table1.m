function [std_error,time,f2]=twin_error_realtime_2012_table1(jdepth)
...
depth_name{1}='100';
 ...
 [hctpx,tpave]=heat_curv_gen_twin_real_realtime_2012(tgrid,depth);
...
time=[1950.5:1:1970.5];
for i=1:length(time)
   
    iyear=time(i);    
   
   [tsub,hc2,time_twin]=heat_curv_gen_twin_realtime_2012( ['allheat_twin_table1_',depth,'_',num2str(iyear),'.mat_tpx_map.mat'],depth);
