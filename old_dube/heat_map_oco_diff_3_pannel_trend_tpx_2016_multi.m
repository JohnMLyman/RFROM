...
ind_all=find(time>1993 & time <2016);
...
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_',num2str(year_of_oco_pub),'_web_3_pannel_insitu_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
close(1)