function [hc1,time,hc_one]=heat_curv_gen_mat_takeout_map_mean(file_name)
...
% take out a local mean
 sht=size(ht);
 good=find(time > 2005 & time < 2011);
 
 
 ht=ht-repmat(nanmean(ht(:,:,good),3),[1,1,sht(3)]);
