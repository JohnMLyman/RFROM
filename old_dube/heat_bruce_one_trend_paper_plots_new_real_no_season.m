...
cd ../SAL/Floats
[hc_tpx,hc_tpx_one,time,hc_tpx_no,hc_tpx_no_one]=heat_curv_gen_mat_reva('htanom_1993_2006_reva_no_trend');
hold on

cd ../../HC
subplot(2,1,1)
plot_bruce_aviso_real_no_season(hc_tpx_one,hc_tpx,hc_tpx_no_one,hc_tpx_no,time)




eval(['print -dpng -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/aviso_estimate_new_real_no'])
