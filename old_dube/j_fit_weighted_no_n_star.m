function [y_model,y_model_err_95,slope_error,slope]=j_fit_weighted_no_n_star(t,y,w_in)
...
y_model_err_95=student_dist(dof,90)*sqrt(model_err(2)+((t- mean(t))*model_err(1)).^2);

slope=model(1);
slope_error=student_dist(dof,90)*model_err(1);
