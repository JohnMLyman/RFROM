...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,'a) 2011','fontsize',11,'fontweight','bold');
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,'b) 2011-2010','fontsize',11,'fontweight','bold');
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2012_realtime_2011t_2p_700_uhm'])
eval(['print -depsc2 -r600 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2012_realtime_2011t_2p_700_uhm'])
