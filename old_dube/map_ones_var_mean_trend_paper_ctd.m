function map_ones_var_mean_trend_paper_ctd(start_time,end_time)
%start_time=1993
%end_time=2006
%close(1)
%close(2)
...
times_string=[num2str(time(start_ind)-.5),'_',num2str(time(end_ind)-.5)];
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/mean_one_trend2_revb_',times_string])
eval(['print -dpng -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/std_one_trend2_revb_',times_string])
