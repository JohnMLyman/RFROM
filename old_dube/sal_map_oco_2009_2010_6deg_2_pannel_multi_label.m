...
function [syear]=sal_map_oco_2009_2010_6deg_2_pannel_multi_label(fyear)
...
t1=text(60,54,['a) ',num2str(fyear)],'fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
a=gca;
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2010_2009_2_pannel_label'])
eval(['print -depsc2 -r600 -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2010_2009_2_pannel_label'])
