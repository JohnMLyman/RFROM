...
t1=text(60,54,'a) 2011','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
a=gca;
...
t1=text(55,54,'b) 2011-2010','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
b=gca;
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2012_realtime_2011t_2p_700_uh'])
eval(['print -depsc2 -r600 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2012_realtime_2011t_2p_700_uh'])
