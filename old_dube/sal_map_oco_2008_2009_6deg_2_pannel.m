...
ind_2006=find(time == 2008.5);
ind_2007=find(time == 2009.5);
...
t1=text(60,54,'a) 2009','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
a=gca;
...
t1=text(55,54,'b) 2009-2008','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
...
eval(['print -dtiff -r600 -f1 /Users/johnlyman/figs/oco/Sal/oco_2009_nov_surface_sal_6deg_change_2009_2008_2_pannel'])
%eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_2009_nov_surface_sal_6deg_change_2009_2008_2_pannel'])
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Sal/oco_2009_nov_surface_sal_6deg_change_2009_2008_2_pannel'])
