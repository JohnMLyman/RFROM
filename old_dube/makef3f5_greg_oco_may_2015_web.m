...
ylabel('0-700 m Heat Content Anomaly [Zetta joules]','fontsize',16);
%set(p2,'linewidth',3)
% set(ps,'linewidth',3)
%set(pt,'linewidth',3)
...
eval(['print -dpng -f3 /Users/johnlyman/figs/oco/Oceans/OHCA_curve_2015'])
eval(['print -dpdf /Users/johnlyman/figs/oco/Oceans/OHCA_curve_2015'])
%%
d=[time';hc_one;hc_se]';
fid = fopen('OHCA_700_2015.txt', 'w');
