...
'cat'
gind=find(day>=datenum(1955,1,1)&day<datenum(2009,1,1)& ...
	~isnan(tpx+heatanom));
...
save /Users/johnlyman/data/Globalhc/HC/clim_2_1955_2008_700 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
