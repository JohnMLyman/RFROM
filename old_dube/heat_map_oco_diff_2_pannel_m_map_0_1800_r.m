...
load(['/Volumes/Data_old/Globalhc/Floats/Argo/CORIOLIS/depth_grid/hregress_',file_name,'_2.mat'])
%%%figure(i);wysiwyg
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/greg/r_900_1800'])
eval(['print -dpdf -f1 /Users/johnlyman/figs/greg/r_900_1800'])
