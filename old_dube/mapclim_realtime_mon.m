...
'cat'
gind=find(day>=datenum(2005,1,1)&day<datenum(2009,1,1)& ...
	~isnan(tpx+heatanom));
...
alat=lat;alon=ln;
save hregress_realtime_clim_mon alat alon alpha crl xvar
%return
cds=cd;
...
save clim_realtime_2005_2008_mon gheatclim gheatclim2 ln lon lat map tpxmap levheat 
