...
mean_end=2003;
 [mean_map,std_map,std_error_map,mean_rep,std_rep,std_error_rep]=...
     scale_type(begin_year,end_year,mean_start,mean_end,'slope',scales);
...
ylabel('slope difference  (W m^{-2})');
xlabel('scale (years)');
title(['mean difference in OHCA slope: ',num2str(mean_start),' to ',num2str(mean_end),' sampling'],'fontsize',12)
...
eval(['print -dpng -f4 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/scale_plot_slope_test'])
