...
% 3/17/3
%computes alpha!
path2='/Users/johnlyman/data/xbt/Levitus/'

 eval(['cd ',path2,'Globalhc/HC'])
...
'cat'
gind=find(day>=datenum(1993,1,1)&day<datenum(2002,1,1)& ...
	~isnan(heatanom));
...
save /Users/johnlyman/data/Globalhc/HC/clim_2_1993_2002_700_test gheatclim gheatclim2 ln lon lat map tpxmap levheat 
