...
error_xbt=sqrt(error_xbt_samp.^2);
...
fac=3e8*3.6e14; axis(a,[min_year max_year -fac fac])
...
axis([min_year max_year .0e8 .8e8])
set(gca,'fontsize',16)
...
set(a,'YAxisLocation','right','color','none','ygrid','off', ...
'xgrid','off','box','off','xtick',[])
 axis(a,[min_year max_year 0e8 .8e8])
set(a,'fontsize',16)
