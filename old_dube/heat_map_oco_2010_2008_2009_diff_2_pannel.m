...
ind_2007=find(time == small_year+.5);
...
for i=1:length(tgrid) 
  ...
  if tgrid(i) == small_year+.5 
      tpxest_2007=sshave.*alpha./1e9;
  end % if 2007
  
  if tgrid(i) == big_year+.5
...
t1=text(60,54,['a) ',num2str(big_year)],'fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
a=gca;
...
t1=text(55,54,['a) ',num2str(big_year),'-',num2str(small_year)],'fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
b=gca;
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2010_realtime_',num2str(big_year),'_2p_early'])
%eval(['print -dtiff -r600 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2010_realtime_',num2str(big_year),'_2p_early'])
