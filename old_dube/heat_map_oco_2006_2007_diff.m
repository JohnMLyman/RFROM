...
path_old='/Volumes/Buffalo/Extra data/Mtpers/ssh files/'
path_old='/Volumes/Data/Globalhc/Mtpers/realtime/'
s=sdir([path_old, 'ssh*.mat']);
...
load /Volumes/Buffalo/W'indows backup'/desktop/meanssh.mat lat lon sshcyc gmo
...
load htanom_2006_2007_oco_realtime
...
for i=1:length(tgrid) 
  ...
  for j=1:length(ii)
    load([path_old,s(ii(j)).name],'sshanom')
...
t1=text(60,50,'2007-2006','fontsize',16,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90])
...
% eval(['print -djpeg90 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2007_oct_realtime_2007_new2'])
% eval(['print -djpeg90 -f2 /Users/johnlyman/figs/oco/Oceans/oco_heat_change_diff_2007_oct_realtime_2007_2006_new2'])

eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2007_oct_realtime_2007_new3'])
eval(['print -dpdf -f2 /Users/johnlyman/figs/oco/Oceans/oco_heat_change_diff_2007_oct_realtime_2007_2006_new3'])
