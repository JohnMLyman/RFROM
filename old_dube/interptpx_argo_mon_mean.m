...
eval(['load ',file_path_out,file_name,'_heat_mon_amon heat_1800 heat_975 heat_750 heat_1800_mon_anom heat_975_mon_anom heat_750_mon_anom coords date mdep npts time fptot fpkeep bdt bbas ind id qual ',...
...
eval(['save ',file_path_out,'aviso_2004_2007 -v7.3 aviso aviso_no_cycle lon lat sshcyc date_aviso day_aviso']);
...
ht_750=heat_750_mon_anom;
ht_975=heat_975_mon_anom;
ht_1800=heat_1800_mon_anom;
cds=coords;
dt=date;
tm=time(:,1);

eval(['save ',file_path_out,'allheat_750_975_1800 ht_750 ht_975 ht_1800 topex cds dt tm mdep npts time fptot fpkeep bdt bbas ind id qual ',...
