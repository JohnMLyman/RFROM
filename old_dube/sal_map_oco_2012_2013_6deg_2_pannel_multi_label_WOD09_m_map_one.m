...
function [syear]=sal_map_oco_2012_2013_6deg_2_pannel_multi_label_WOD09_m_map_one(fyear)
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_2014_one'])
eval(['print -depsc2 -r300 -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_2014_one'])
