...
ncload('htanom_greg_test_2006_2007.nc','lat','lon','time','one','htdiff');
htdiff=permute(htdiff,[3 2 1])./1e9;
one=permute(one,[3 2 1]);
ind_2007=find(time == 2007.5);

ht_2007=htdiff(:,:,ind_2006);
one_2007=one(:,:,ind_2006);
...
%eval(['print -dpng -f1 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_heat_content_diff_john_2006'])
%eval(['print -dpng -f2 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_heat_change_diff_john_2006_2005'])
