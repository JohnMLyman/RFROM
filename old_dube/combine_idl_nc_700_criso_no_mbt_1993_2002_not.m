...
ncload('htanom_700_1993_2002_no_mbt_1993_2002.nc','lon','lat','ht','htdiff','time','one','tpx','error')
...
%one(isnan(one))=0;
%tps(isnan(tpx))=0;
save 'htanom_1993_2002_no_mbt_1993_2002_700_criso' time lon lat one ht tpx error htdiff
