...
ncload('surface_sal_anom_3_error_2004_2005.nc','lat','lon','sal','time');
...
corrhc=interp2(lat,lon,surface_sal(:,:,i),lat_tpx,lon_tpx');
...
caxis([min_val max_val])
xlabel('Surface Salintiy Anomaly (from Levitus mean and season cycle) [psu]')
