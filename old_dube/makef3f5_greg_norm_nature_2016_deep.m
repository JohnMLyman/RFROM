...
% % %  
% % %  [hc_100,time,hc_one_100,Area_100]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC1992_2015_100_real',0,100);
% % % [hc_100_300,time,hc_one_100_300,Area_100_300]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC1992_2015_100_300_real',100,300);
% % %  [hc_300_700,time,hc_one_300_700,Area_300_700]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC1992_2015_300_700_real',300,700);
% % %  [hc_700_900,time,hc_one_700_900,Area_700_900]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC1992_2015_900_real',700,900);
% % %  [hc_900_1950,time_1950,hc_one_900_1950,Area_900_1950]=heat_curv_gen_mat_2012_new_un_topo('hdata_1950__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC1950_2015_1950_real',900,1950);
% % % 
% % %  good_1950=find(ismember(time_1950,time));
% % %  hc_900_1950=hc_900_1950(good_1950);
% % %  hc_one_900_1950=hc_one_900_1950(good_1950);
% % %  Area_900_1950=Area_900_1950(good_1950);
% % %   save '/Volumes/Data/Globalhc/SAL/Floats/ohca_1992_2015_curve_100_300_700_900_1950_jan_2016_area_deep' time hc_one_100 hc_one_100_300 ...
% % %       hc_one_300_700 hc_one_700_900 hc_one_900_1950 hc_100 hc_100_300 hc_300_700 hc_700_900 hc_900_1950 ...
% % %       Area_100 Area_100_300 Area_300_700 Area_700_900 Area_900_1950
load '/Volumes/Data/Globalhc/SAL/Floats/ohca_1992_2015_curve_100_300_700_900_1950_jan_2016_area_deep' time hc_one_100 hc_one_100_300 ...
      hc_one_300_700 hc_one_700_900 hc_one_900_1950 hc_100 hc_100_300 hc_300_700 hc_700_900 hc_900_1950 ...
      Area_100 Area_100_300 Area_300_700 Area_700_900 Area_900_1950
time_one=time;
hc_one=hc_one_100+hc_one_100_300+hc_one_300_700;
 ...
 hc_one_deep=(hc_one_700_900+hc_one_900_1950)./1e21;
 hc_one_total=(hc_one_100+hc_one_100_300+hc_one_300_700+hc_one_700_900+hc_one_900_1950)./1e21
 time_deep=time;
...
%%
load /Volumes/Data/Globalhc/SAL/Floats/simon_hc_2015
...
load /Volumes/Data/Globalhc/SAL/Floats/catia_hc_2015
...
load /Volumes/Data/Globalhc/SAL/Floats/tim_hc_2016_deep.mat tim_hc_deep tim_time_deep tim_se_deep
load /Volumes/Data/Globalhc/SAL/Floats/tim_hc_2016_deep_pen.mat tim_hc_deep_pen tim_time_deep_pen tim_se_deep_pen


load /Volumes/Data/Globalhc/SAL/Floats/ishii_hc_2015_deep.mat ishii_hc_deep ishii_time_deep ishii_se_deep
...
text(year_text,text_off+text_del*3,'700m > z > 1950m','color',mycor(1,:),'FontName','Arial','FontSize',text_size)
plot([year_text-2 year_text-1],[text_off+text_del*3 text_off+text_del*3],'color',mycor(1,:),'linewidth',3)
...
se_rate_1950_oco=sqrt(hc_se_total(1:end-1).^2+hc_se_total(2:end).^2).*1e21*fac;

rate_1950_oco=diff(hc_one_total).*fac .*1e21;
time_1950_oco=.5.*(time_deep(1:end-1)+time_deep(2:end));
rate_1950=rate_1950_oco;
se_rate_1950=se_rate_1950_oco;
time_rate=time_1950_oco;
OHCA_1950=hc_se_total;
se_OHCA_1950=hc_se_total;
OHCA_1950=hc_one_total;
time_OHCA=time_deep;
...
per_900_1950=100*hc_900_1950./hc_one_900_1950;
...
per_900_1950=per_900_1950(good_per);
...
vol_900_1950=Area_900_1950(good_per)*(1950-900);

time_per=time_one(good_per);

per_0_1950=(per_100.*vol_100+per_100_300.*vol_100_300+per_300_700.*vol_300_700+...
    per_700_900.*vol_700_900+per_900_1950.*vol_900_1950)./ ...
    (vol_100+vol_100_300+vol_300_700+vol_700_900+vol_900_1950);

save greg_rate_OHCA_1950_new rate_1950 se_rate_1950 time_rate OHCA_1950 ...
    se_OHCA_1950 time_OHCA per_100 per_100_300 per_300_700 per_700_900 ...
    per_900_1950 per_0_1950 time_per
figure(100)
...
plot(time_per,per_900_1950)

axis([2000 2016 0 100])

figure
errorbar(time_rate,rate_1950,se_rate_1950,'k')
...
hold on 
errorbar(time_rate,rate_1800,se_rate_1800,'r')
