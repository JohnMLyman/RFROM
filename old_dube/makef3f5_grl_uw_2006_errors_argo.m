...
heat_content_no_argo_var2
tgrid_err_no_argo=tgrid_err;
std_error_no_argo=std_error;
...
j_plot_no_argo_zeta(tgrid_err_no_argo,std_error_no_argo,hc2,tgrid,error_insitu)
hold on
...
axis([min_year max_year -70 70])
set(gca,'fontsize',16)


hc22=hc2.*1e-21;error_22=error_insitu.*1e-21;
e2=errorbar(tgrid,hc22,error_22,'k');set(e2,'linewidth',2)
...
txt={['warming rate (',num2str(warm_min-.5),' to ',num2str(warm_max-.5),'): '];[w5,'\pm',w5_err,' W/m^2']; ...
    ['cooling rate (',num2str(cool_min-.5),' to ',num2str(cool_max-.5),'): '];[w4,'\pm',w4_err,' W/m^2']};


 txth=text(1999.15,-39,txt,'fontsize',16);

 %load in no argo 
load /home/shoko2/wills/globalhc_dirs/Globalhc/HC/hcseries_no_season.mat
...
% 
% pp=plot([year_set+2.5 year_set+3.5],[j_set j_set]+off_set,'k-*')
% pp1=plot([year_set+2.5 year_set+3.5],[j_set j_set]-space+off_set,'b-*')
% pp2=plot([year_set+2.5 year_set+3.5],[j_set j_set]-2.*space+off_set,'r-*')
% set(pp1,'linewidth',3)
% set(pp2,'linewidth',3)
% set(pp,'linewidth',3)
% 
...
%eval(['print -depsc -f2 ../heat_1993_2005_grl_plus2_3_Aug_2'])

%eval(['print -dpng -f2 /home/shoko/C/','''IDL ps''','/heat/talk/heat_1993_2005_error_argo'])
