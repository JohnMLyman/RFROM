...
% 
% eval(['load ',file_path_out,file_name,'_height_oa_amon_oco_100 height_1800 height_900 height_700 height_300 height_100 ',...
% 	'height_1800_anom height_900_anom  height_700_anom height_300_anom height_100_anom coords date mdep npts time fptot fpkeep bdt bbas ind id qual ',...
% 	'press_mis_flag dac_centre wmo_inst cycle'])% this is the radius that is looked at

eval(['load ',file_path_out,file_name,'_height_oa_amon_oco_bin_new_no_season height_1800_anom height_900_anom ',...
    'height_700_anom height_300_anom height_100_anom height_300_700_anom height_100_300_anom coords ',...
...
ht_100=height_100_anom;
ht_300=height_300_anom;
ht_100_300=height_100_300_anom;
ht_300_700=height_300_700_anom;

ht_700=height_700_anom;
ht_900=height_900_anom;
ht_1800=height_1800_anom;
cds=coords;
dt=date;
tm=time(:,1);

eval(['save ',file_path_out,'allheight_100_300_700_900_1800_new ht_100 ht_300 ht_100_300 ht_300_700 ',...
