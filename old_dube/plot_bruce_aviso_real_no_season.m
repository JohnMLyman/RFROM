function plot_bruce_aviso_real_no_season(tsub_one,tsub_map,tsub_one_no,tsub_map_no,tgrid)
scale=1;
...
;hold on
p=plot(tgrid,tsub_one_no*scale./1e21,'k-*');
...
p4=plot(tgrid,tsub_map_no*scale./1e21,'-*k')
set(p4,'linewidth',2)
