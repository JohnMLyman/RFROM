...
load ../../HC/hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC2015_100_real_quart

htdiff_100=ht;
ind_2008=find(time == time(itime));
...
if itime~=1
    ind_2007=find(time == time(itime-1));
else
    ind_2007=find(time == time(itime));
end
...
%bad=find(one_2007 <= .8);
%ht_2007(bad)=NaN;
load ../../HC/hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC2015_100_300_real_quart
htdiff_100_300=ht;
...
load ../../HC/hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2016_QC2015_300_700_real_quart
htdiff_300_700=ht;
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,['a) ', num2str(itime)],'fontsize',11,'fontweight','bold');
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,['b) ' num2str(itime) '-' num2str(itime+1)],'fontsize',11,'fontweight','bold');
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/lyman/figs/oco/Oceans/oco_heat_jan_2016_web_2014_2013_insitu_quart',num2str(itime)])
