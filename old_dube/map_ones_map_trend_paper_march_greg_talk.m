...
load 'htanom_1993_2007_oco_greg_josh.mat'
%error=1-(error-2.2);
 lon2=lon;
...
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/map_one_trend2_march_',times_string])
