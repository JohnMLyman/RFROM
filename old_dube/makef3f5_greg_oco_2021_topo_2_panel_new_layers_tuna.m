...
depth_bot_plot=2000;
 ...
 [hc_deep,hc_one_deep,hctpx_deep,time_grid_deep]=...
    oco_new_load_ohca_curves(file_name,min_year_maps,max_year_maps,...
    min_year_maps_out,max_year_maps_out,depth_top_plot,depth_bot_plot,layer_bounds);
...
%%
save([path_curves,'pmel_hc_2021.mat'],'time', 'hc_one', 'hc_se')
%%
...
text(1994.5,165,'(a)','Fontsize',16,'Fontname','Arial','Fontweight','Bold')
...
axes
save_ascii_oco_hc_2021_tuna
% compute the deep OHCA curves


%compute offsett

load([path_curves,'tim_hc_2021_deep.mat'], 'tim_hc_deep', 'tim_time_deep', 'tim_se_deep')
...
load([path_curves,'ishii_hc_2021_deep.mat'],'ishii_hc_deep', 'ishii_time_deep', 'ishii_se_deep')
% tim_hc_deep=hc_one_deep';
% tim_time_deep=time_deep;
% tim_se_deep=hc_se_deep;
load([path_curves,'cheng_hc_2021_deep.mat'], 'cheng_hc_deep', 'cheng_time_deep','cheng_se_deep')

load([path_curves,'simon_hc_2021_deep.mat'], 'simon_hc_deep', 'simon_time_deep', 'simon_se_deep')
...
%
save([path_curves,'pmel_hc_2021_deep.mat'], 'hc_one_deep', 'time_deep', 'hc_se_deep')
...
% 
  eval(['print -dpng -r600 -f3 ',path_figs,'curve_oco_new_',num2str(year_of_oco_pub)])
%     eval(['print -depsc2 -f3 ',path_figs,'curve_oco_2022'])
% 
%       eval(['print  -dtiff -r300 -f3 ',path_figs,'curve_oco_2022'])
