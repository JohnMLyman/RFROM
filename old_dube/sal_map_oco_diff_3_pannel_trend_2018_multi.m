...
slope_min_year=2005;
file_surface_name='Jan_2018_2002_2017';%    MUST CHANGE TO MATCH SAL MAPPING
...
eval(['load surface_sal_',file_surface_name,'_6_deg.mat lat lon time one sal']);
...
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_',num2str(year_of_oco_pub),'_3pannel'])
eval(['print  -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_',num2str(year_of_oco_pub),'_3pannel'])
eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_',num2str(year_of_oco_pub),'_3pannel'])
