function [hc_tpx,hc_tpx_one,time,hc_tpx_no,hc_tpx_no_one]=heat_curv_gen_mat_reva(file_name)
...
hc_tpx=hc_tpx.*scale;
hc_tpx_no=hc_tpx_no.*scale;
hc_tpx_no_one=hc_tpx_no./hc_one;
hc_tpx_one=hc_tpx./hc_one;
