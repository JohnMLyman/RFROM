...
ncload('htanom_q1_no_te_1950_2006_2006_2006.nc','lat','lon','time','one','ht');
...
t1=text(60,50,'2006-2004','fontsize',16,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90])
...
set(j,'tickdir','out','xaxisl','top','xtick',[min_val:del_val:max_val],'ytick',[])
caxis([min_val max_val])
xlabel('2-year Heat Content Change (in situ)  [W m^{-2}]')
...
eval(['print -dpng -f1 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_insitu_heat_content3_2006'])
eval(['print -dpng -f2 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_insitu_heat_change3_2006_2004'])
