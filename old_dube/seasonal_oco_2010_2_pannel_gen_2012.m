function [junk]=seasonal_oco_2010_2_pannel_gen_2012(lon,lat,ht,idepth,imonth,range,del)
lon_ht=lon;
lat_ht=lat;
junk=1;
...
caxis([min_val max_val])
xlabel(['Upper Ocean Heat Content Anomaly ',idepth',' m, month ',num2str(imonth),'  [J m ^{-2} x 10^9]'])
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/seasonal_cycle/seasonal_2012_',idepth','m_month_',num2str(imonth)])
