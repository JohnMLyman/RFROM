...
function mapdiff_gen_allheat_no_trend(file_name,fname_nc,clim_file)
...
% did not remove the levitus guess at the season cycle
htanom=ht-htclim;
...
save hregress_delayed_no_trend alat alon alpha c xvar
end % of skip
