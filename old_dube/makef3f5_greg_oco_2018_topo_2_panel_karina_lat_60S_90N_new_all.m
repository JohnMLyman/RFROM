...
[~,time,~,~,~]=...
         ...
         layer_bounds(1),layer_bounds(2),-60,90);
      hc_one_0_300=zeros(1,length(time));
      hc_one_0_700=hc_one_0_300;
      hc_one_0_2000=hc_one_0_300;
      hc_one_700_2000=hc_one_0_300;
      vol_0_300=hc_one_0_300;
      vol_0_700=hc_one_0_300;
      vol_0_2000=hc_one_0_300;
      vol_700_2000=hc_one_0_300;

      pos_1960_2017=find(time >1960 & time<2018); %note that time is on the half year so this only goes 2017 not 2018 for the mean
...
for ilayer=2:length(layer_bounds)
    ...
    area_junk=[];
     [hc,time,hc_one_junk,~,area_junk]=...
         heat_curv_gen_mat_topo_new_layers_karina_lat(['hdata_new_layers__ishii_EN3_2014_',file_name_argo,...
         min_year_mapped,'_',max_year_mapped,'_'],...
         layer_bounds(ilayer-1),layer_bounds(ilayer),-60,90);
...
%          num2str(layer_bounds(ilayer)),'_1960_2018_60_60=hc_one_junk-nanmean(hc_one_junk(pos_1960_2017));'])
%       eval(['hc_one_',num2str(layer_bounds(ilayer-1)),'_',...
%          num2str(layer_bounds(ilayer)),'_1993_2018_60_60=hc_one_junk-nanmean(hc_one_junk(pos_1993_2017));'])
%       eval(['hc_one_',num2str(layer_bounds(ilayer-1)),'_',...
%          num2str(layer_bounds(ilayer)),'_2005_2018_60_60=hc_one_junk-nanmean(hc_one_junk(pos_2005_2017));'])
     
      layer_bounds(ilayer)
     if layer_bounds(ilayer)<= 300
         hc_one_0_300=hc_one_junk+hc_one_0_300;
         vol_0_300=vol_0_300+area_junk*(layer_bounds(ilayer)-layer_bounds(ilayer-1));
         ['0-300 :',num2str(layer_bounds(ilayer-1)),'-',num2str(layer_bounds(ilayer))]
...
pos_1960_2018=find(time >1960 & time<2019); %now time will go to 2018
pos_1993_2018=find(time >1993 & time<2019);
pos_2005_2018=find(time >2005 & time<2019);


time_1960_2018=time(pos_1960_2018);
time_1993_2018=time(pos_1993_2018);
time_2005_2018=time(pos_2005_2018);

area_0_300=vol_0_300(pos_1960_2018)./300;
area_0_700=vol_0_700(pos_1960_2018)./700;
area_0_2000=vol_0_2000(pos_1960_2018)./2000;
area_700_2000=vol_700_2000(pos_1960_2018)./(2000-700);

hc_one_0_300_1960_2018_60_90=hc_one_0_300(pos_1960_2018)-nanmean(hc_one_0_300(pos_1960_2017));
hc_one_0_700_1960_2018_60_90=hc_one_0_700(pos_1960_2018)-nanmean(hc_one_0_700(pos_1960_2017));

hc_one_0_300_1993_2018_60_90=hc_one_0_300(pos_1993_2018)-nanmean(hc_one_0_300(pos_1993_2018));
hc_one_0_700_1993_2018_60_90=hc_one_0_700(pos_1993_2018)-nanmean(hc_one_0_700(pos_1993_2017));

hc_one_0_300_2005_2018_60_90=hc_one_0_300(pos_2005_2018)-nanmean(hc_one_0_300(pos_2005_2017));
hc_one_0_700_2005_2018_60_90=hc_one_0_700(pos_2005_2018)-nanmean(hc_one_0_700(pos_2005_2017));
hc_one_0_2000_2005_2018_60_90=hc_one_0_2000(pos_2005_2018)-nanmean(hc_one_0_2000(pos_2005_2017));
hc_one_700_2000_2005_2018_60_90=hc_one_700_2000(pos_2005_2018)-nanmean(hc_one_700_2000(pos_2005_2017));

save karina_ohca_60S_90N_new_all.mat hc_one_0_300_1960_2018_60_90 hc_one_0_700_1960_2018_60_90 ...
    hc_one_0_300_1993_2018_60_90 hc_one_0_700_1993_2018_60_90 ...
    hc_one_0_300_2005_2018_60_90 hc_one_0_700_2005_2018_60_90 ...
    hc_one_700_2000_2005_2018_60_90 hc_one_0_2000_2005_2018_60_90...
    time_1960_2018 time_1993_2018 time_2005_2018...
