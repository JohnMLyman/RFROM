...
ncload('htanom_q1_1950_2006_take2_1993_2004.nc','lat','lon','ht','time','one','htdiff','error')
...
ncload('htanom_q1_1950_2006_take2_2006_2006.nc','lat','lon','ht','time','one','htdiff','error')
   ht_t=[ht_t;ht];
one_t=[one_t;one];
htdiff_t=[htdiff_t;htdiff];
error_t=[error_t;error];
...
save 'htanom_q1_take2_1993_2006' time lon lat one ht htdiff error 
