...
load /home/shoko2/wills/globalhc_dirs/Globalhc/SAL/Floats/total_den_grid_april_28.mat
 ...
 distance=sqrt((coords_tot(:,1)-lon_square).^2+(coords_tot(:,2)-lat_square).^2);
...
% % % hold on
% % % plot(sal_0,temp_0,'.')
% % % plot(sal_0(this_cast,:),temp_0(this_cast,:),'.r')
% % % plot(sal_0(jj,:),temp_0(jj,:),'.k')
% % % 
% % %   
% % % 
% % % 
...
% % % 
% % % hold on 
% % % plot(sal_0,-1.*press_0,'.')
% % % plot(sal_0(this_cast,:),-1.*press_0(this_cast,:),'.r')
% % % plot(sal_0(jj,:),-.1*press_0(jj,:),'k.')
% % % 
% % % hold off
% % % 
% % % subplot(2,4,3)
% % % 
% % % hold on  
% % % plot(temp_0,-1.*press_0,'.')
% % % plot(temp_0(this_cast,:),-1.*press_0(this_cast,:),'.r')
% % % plot(temp_0(jj,:),-.1*press_0(jj,:),'k.')
% % % 
% % % hold off
...
if length(find(ii == this_cast)) > 0
    bad=[bad',isquare]';
    per_done=100.*isquare/s(1)
    per_bad=100.*length(bad)/isquare
end


end

save bad_ind_3degree bad per_bad
% % if length (temp) >=1 
