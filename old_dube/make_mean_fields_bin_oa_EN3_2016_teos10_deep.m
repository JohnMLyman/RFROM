...
% % % 
% % %  [data_grid,lon,lat]=load_and_grid_matlab_season_test3_bin_deep(file_path_out,file_path,file_name_mean);
% % % % [data_grid,lon,lat]=load_and_grid_matlab_season_test3_bin_height(file_path_out,file_path,file_name_mean);
% % % 
% % % % % % 
% % % %% UNCOMMENT TO RERUN!!!
% % %  
% % % [data_grid_oa,lon,lat]=load_and_grid_matlab_season_test3_oa_deep(file_path_out,file_path,file_name_mean);
...
% % % % same 
% % % 
% % % remove_argo_mean_oa_oco_bin_2013_deep
...
% % % %% UNCOMMENT TO RERUN!!!
% % % 
% % % [iyear]=load_and_grid_matlab_season_test2_bin_deep(file_path_out,file_path,file_name_mean);
...
% % % %% UNCOMMENT TO RERUN!!!
% % % 
% % % [iyear]=load_and_grid_matlab_season_test2_bin_oa_deep(file_path_out,file_path,file_name_mean);
...
% % % % same
% % % 
% % % remove_argo_mean_oa_oco_bin_season_2013_deep
...
% % % %UNCOMMENT TO RERUN!!!
% % % % % % 
% % % interptpx_argo_mean_oco_bin_2014_deep
% % % 
% % % 
% % % 
...
% % % remove_argo_mean_oa_seasonal_cycle_WOD_bin_EN3_2013_deep
% % % 
% % % 
% % % %%remove_argo_mean_oa_seasonal_cycle_WOD_bin_height_EN3d
% % % 
% % % 'interpx WOD'
...
% % % 
% % % interptpx_argo_mean_oco_WOD_2015_deep
% % % clearvars -except file_WOD_suf file_path file_path_out file_name file_name_mean file_path_hdata max_year min_year path_EN3
% % % %%interptpx_argo_mean_oco_WOD_height
% % % clearvars -except file_WOD_suf file_path file_path_out file_name file_name_mean file_path_hdata max_year min_year path_EN3
% % % 'mapdiff WOD'
% % % 
% % % mapdiff_argo_mean_oco_no_season_WOD_EN3_2013_deep
clearvars -except file_WOD_suf file_path file_path_out file_name file_name_mean file_path_hdata max_year min_year path_EN3
...
map_ht_1950_900_700_300_100_EN3_junk_2015_deep
