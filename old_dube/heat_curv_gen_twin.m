function [hc_tpx,hc_hctpx,time_hc]=heat_curv_gen_twin(file_name)

current_dir=cd('/Users/johnlyman/data/Globalhc/SAL/Floats/twin/correction');
...
ncload(file_name,'lat','lon','tpx','time','hctpx','one')
...
hc_hctpx(i)=nansum(arw(:).*corrhc_one(:));
