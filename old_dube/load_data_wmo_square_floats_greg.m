function [coords_tot, density_surface, dg_hi_tot, dg_lo_tot, dt_tot, fpress_tot,  id_tot, ...
    mdep_tot, npts_tot, per_bad_grad_tot, press_0_tot, press_bot_0_tot,  ...
    press_top_0_tot,  qual_tot, ratio_bad_tot, sal_tot, sal_0_tot,  temp_tot,...
    temp_0_tot,  time_tot,wmo_tot]= ...
        load_data_wmo_square_floats(wmo,del_deg)
...
[wmo_squares,min_lon,max_lon,min_lat,max_lat]=find_wmo_square_floats(wmo,del_deg);
min_lon;
max_lon;
min_lat;
max_lat;
...
for i=1:length(wmo_squares)
      ...
      if exist(['grad_den_0_grid_aden_den_no_f',num2str(wmo_squares(i)),'.mat'])
    eval(['load grad_den_0_grid_aden_den_no_f',num2str(wmo_squares(i)),'.mat']);
    wmo_squares(i)
    lon_junk=coords(:,1);
    lat_junk=coords(:,2);
    b=0;
...
clear coords dg_hi dg_lo  dt ...
    fpress  id  mdep  npts  per_bad_grad  press_0  press_bot_0 ...
    press_top_0   qual  ratio_bad ...
    sal  sal_0  temp  temp_0  time
% % 
