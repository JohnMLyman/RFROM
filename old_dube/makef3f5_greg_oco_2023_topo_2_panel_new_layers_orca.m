...
[TreeSetUp]=TreeSetUp_2023_orca_heat_vert_test_nosshsst_combine;
...
donata_hc=donata_hc(good_donata);
...
pos_donata_argo=find(donata_time> 2004);
donata_hc=donata_hc-nanmean(donata_hc(pos_donata_argo));
...
pos_donata_deep=find(donata_time_deep> min_year_deep );
...
donata_hc_deep=donata_hc_deep(pos_donata_deep);
donata_time_deep=donata_time_deep(pos_donata_deep);
donata_se_deep=donata_se_deep(pos_donata_deep);
...
pos_donata_deep_off=find(donata_time_deep> 2004  & donata_time_deep <=max_year_deep);
donata_hc_deep=donata_hc_deep-nanmean(donata_hc_deep(pos_donata_deep_off));
...
hc_all=[hc_one_deep(1)';tim_hc_deep(1);ishii_hc_deep(1);cheng_hc_deep(1);simon_hc_deep(1);donata_hc_deep(1)];
...
donata_hc_deep=donata_hc_deep-offset;
...
pdon=plot(donata_time_deep,donata_hc_deep,'-*','color',mycor(2,:));
edon=errorbar(donata_time_deep,donata_hc_deep,donata_se_deep,'color',mycor(2,:));set(edon,'linewidth',3);
...
text(year_text,text_off+text_del*7,'700m > z > 2000m','color',mycor(2,:),'FontName','Arial','FontSize',text_size)
...
%   eval(['print -dpng -r600 -f3 ',path_figs,'curve_oco_new5_',num2str(year_of_oco_pub)])
    eval(['print -depsc2 -f3 ',path_figs,'ccurve_oco_final_',num2str(year_of_oco_pub)])
% 
