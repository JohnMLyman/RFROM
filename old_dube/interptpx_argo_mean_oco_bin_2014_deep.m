...
% 
% eval(['load ',file_path_out,file_name,'_heat_oa_amon_oco_100 heat_1950 heat_900 heat_700 heat_300 heat_100 ',...
% 	'heat_1950_anom heat_900_anom  heat_700_anom heat_300_anom heat_100_anom coords date mdep npts time fptot fpkeep bdt bbas ind id qual ',...
% 	'press_mis_flag dac_centre wmo_inst cycle'])% this is the radius that is looked at

eval(['load ',file_path_out,file_name,'_heat_oa_amon_oco_bin_1950_no_season heat_1950_anom heat_900_anom ',...
...
% 
% aviso_path='/Users/lyman/data/Globalhc/Mtpers/realtime_2015/';
...
ht_1950=heat_1950_anom;
cds=coords;
dt=date;
tm=time(:,1);

% % % eval(['save ',file_path_out,'allheat_100_300_700_900_1950_new',allheat_extra,' ht_100 ht_300 ht_100_300 ht_300_700 ',...
% % %     'ht_700 ht_900 ht_1950 topex cds dt tm mdep npts time fptot fpkeep bdt bbas ind id qual ',...
% % % 	'press_mis_flag dac_centre wmo_inst cycle'])%
% % % 
% % % 
...
% took out topex from save John Lyman 11/12/2015
 eval(['save ',file_path_out,'allheat_100_300_700_900_1950_new',allheat_extra,' ht_100 ht_300 ht_100_300 ht_300_700 ',...
    'ht_700 ht_900 ht_1950 cds dt tm mdep npts time fptot fpkeep bdt bbas ind id qual ',...
	'press_mis_flag dac_centre wmo_inst cycle'])%
