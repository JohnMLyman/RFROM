function map_ones_map_trend_paper_agu_2008(year_map)
%start_time=1993
%end_time=2006
%close(1)
%close(2)
...
% plot with out the map 

figure(2);wysiwyg

% load in position of data

load '../../HC/allheat_no_te.mat' cds dt
hold on
pos_good=find(dt(:,1) == year_map);
plot(cds(pos_good,1),cds(pos_good,2),'.k','MarkerSize',.5)
plot(cds(pos_good,1)+360,cds(pos_good,2),'.k','MarkerSize',.5)
hold off
hold on
...
axis([30 390 -90 90])
plot_coasts_black
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90],'box','on')
...
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/map_one_trend2_agu_2008_',times_string])
eval(['print -dpng -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/map_trend2_agu_2008_',times_string])
