...
load /home/shoko2/wills/globalhc_dirs/Globalhc/Mtpers/meanssh lat lon
lon_tpx=[lon(542:end)-360;lon(1:541)];
lat_tpx=lat;

clear lon lat

load /home/shoko2/wills/globalhc_dirs/Globalhc/HC/landmask msk2
...
%ncload('surface_sal_anom_3_error_6_deg_2005_2007.nc','lat','lon','time','one','sal','error');
ncload('surface_sal_anom_3_error_6_deg_jan_2005_2007.nc','lat','lon','time','one','sal','error');
...
[sss_atl,sss_pac,sss_ind]=find_basin(lat2,lon2,surface_sal_2007);
corrhc=interp2(lat,lon,sss_atl,lat_tpx,lon_tpx');
corrhc(isnan(msk2(2:end-1,:)))=NaN;

arw=areavec(lon_tpx,lat_tpx);
arw(isnan(corrhc))=NaN;
wcorr=arw.*corrhc;
sss_curve=nansum(wcorr)./nansum(arw);
...
axis([30 390 -90 90])
set(gca,'pos',[.13 .25 .6 .55])

%axis([30 390 -90 90])
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90])
hold on

jj=axes('pos',[.75 .25 .2 .55]);
plot(sss_curve,lat_tpx)
axis([-.5 .5 -90 90])
set(gca,'tickdir','out','yaxisl','right','ytick',[-90:30:90])
hold on 
j=axes('pos',[.13 .85 .6 .02]);
%colormap jet(256)
colormap(fresh_to_salty_colormap)
...
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_surface_sal_atlatic'])
%eval(['print -dtiff -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_oct_surface_sal_6deg_jan_2006'])
%eval(['print -dtiff -f3 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_oct_surface_sal_6deg_change_jan_2007_2006'])
