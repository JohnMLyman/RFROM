...
function mapdiff_gen_allheat_basin_700_xbt_new_climo_test_jan26(start_year,end_year,fname_nc)
...
lat_ht2=lat;
lon_ht2=lon;
mean_ht2=[mean_ht(end-40:end-1,:);mean_ht;mean_ht(2:41,:)];
lon_ht2=[lon_ht(end-40:end-1)-360;lon_ht;lon_ht(2:41)+360];
...
%% remove climatology
gheatclim=gheatclim+map_clim+mapclim2;
