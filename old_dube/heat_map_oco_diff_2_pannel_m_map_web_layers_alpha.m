...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,'a) 0-100 m','fontsize',11,'fontweight','bold');
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,'b) 100-300 m','fontsize',11,'fontweight','bold');
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_0_100_300_alpha'])
