...
e_bass_quart(:,:,1)=max(squeeze(ebass(:,:,:,60:62)),[],3);

sss_bass_quart(:,:,2)=squeeze(nanmean(sss_bass(:,:,:,63:65),4));
e_bass_quart(:,:,2)=max(squeeze(ebass(:,:,:,63:65)),[],3);

sss_bass_quart(:,:,3)=squeeze(nanmean(sss_bass(:,:,:,66:68),4));
e_bass_quart(:,:,3)=max(squeeze(ebass(:,:,:,66:68)),[],3);


sss_bass_quart(:,:,4)=squeeze(nanmean(sss_bass(:,:,:,69:71),4));
e_bass_quart(:,:,4)=max(squeeze(ebass(:,:,:,69:71)),[],3);
...
% 
eval(['print -dpng -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_6deg_change_dec_2015_new_bass_one'])

eval(['print -dtiff -r600 -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_6deg_change_dec_2015_new_bass_one'])
