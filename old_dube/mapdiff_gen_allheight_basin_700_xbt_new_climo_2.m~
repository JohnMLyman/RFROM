...
function mapdiff_gen_allheight_basin_700_xbt_new_climo_2(start_year,end_year,fname_nc)
...
clim_file='/Users/johnlyman/data/Globalhc/HC/clim_2_2004_2008_700_height'
file_name='allheight_700'
data_file='/Volumes/Data/xbt/Levitus_2/Globalhc/SAL/Floats/htanom_1993_2002_not_height_1993_2008_700_levitus_2'
...
eval(['load ' clim_file ' gheightclim lon lat ln'])
gheatclim=gheightclim;
...
%% remove climatology
gheatclim=gheatclim+map_clim;
htclim=interp2(lat,ln,gheatclim,cds(:,2),cds(:,1));
clear gheatclim ii mean_ht map_clim

% remove annual cycle
load /Users/johnlyman/data/Globalhc/Levitus/levcyc_700 levheightcyc lon lat mo
levheatcyc=levheightcyc;
...
save hregress_700 alat alon alpha c xvar
end % of skip
