...
function [syear]=sal_map_oco_2013_2014_6deg_2_pannel_multi_label_WOD09_m_map_aq(fyear)
'cat'
...
caxis([min_val max_val-del_cont])
xlabel('Aquarius Surface Salinity Anomaly [PSS-78] ')
...
caxis([min_val max_val-del_cont])
xlabel('Aquarius Surface Salinity Change [PSS-78 yr ^{-1}]')
...
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_jan_2015_2_aq'])
