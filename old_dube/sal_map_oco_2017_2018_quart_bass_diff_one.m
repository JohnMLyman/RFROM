...
% 
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_',num2str(plot_year),'_new'])
% % % eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_',num2str(plot_year),'_new'])
% % % 
% % % eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_',num2str(plot_year),'_new'])
