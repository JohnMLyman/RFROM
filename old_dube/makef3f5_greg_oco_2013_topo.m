...
name_pre_file='hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_20142010_2013';


 [hc,time,hc_one_100]=heat_curv_gen_mat_2012_new_un_topo([name_pre_file,'_100_real'],0,100);
[hc,time,hc_one_100_300]=heat_curv_gen_mat_2012_new_un_topo([name_pre_file,'_100_300_real'],100,300);
 [hc,time,hc_one_300_700]=heat_curv_gen_mat_2012_new_un_topo([name_pre_file,'_300_700_real'],300,700);
 % [hc,time,hc_one_700_900]=heat_curv_gen_mat_2012_new_un_topo([name_pre_file,'_900_real'],700,900);
  % [hc,time,hc_one_900_1800]=heat_curv_gen_mat_2012_new_un_topo([name_pre_file,'_1800_real'],900,1800);
%  [hc,time,hc_one_700_900]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131950_2012_900_real');

 hc_one=hc_one_100+hc_one_100_300+hc_one_300_700;
save '/Volumes/Data/Globalhc/SAL/Floats/nature_2013_ohca_curve_oco_greg2_topo24' time hc_one hc_se
load '/Volumes/Data/Globalhc/SAL/Floats/nature_2013_ohca_curve_oco_greg2_topo24' time hc_one hc_se
...
% % eval(['print -dpng -f3 /Users/johnlyman/figs/oco/Oceans/hc_one_greg_oco_t2012_new_new2_topo'])
% % eval(['print -depsc2 -r600 -f3 /Users/johnlyman/figs/oco/Oceans/hc_one_greg_oco_t2012_new_new2_topo'])
eval(['print -dpdf -f3 /Users/johnlyman/figs/oco/Oceans/hc_one_greg_oco_t2012_new_new2_topo'])
%%
