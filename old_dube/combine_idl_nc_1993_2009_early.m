...
ncload('htanom_oco_realtime_2009_1993_2009.nc','lon','lat','ht','htdiff','time','one','tpx','error')
...
%one(isnan(one))=0;
%tps(isnan(tpx))=0;
save 'htanom_oco_realtime_1993_2009_early' time lon lat one ht tpx error htdiff
