...
function [sname]=sal_map_oco_aquaris_m_map_mat(smonth,fmonth)
%  NOTE: only works if smonth and fmonth are in the same year  Other wise
%  you need to change year_name and what you divide the change by
Name_suff='.L3m_MO_SCISM_V1.3_SSS_1deg';
smonth=4;
fmonth=10;
%Name_suff='.L3m_MO_SCI_V1.3_SSS_1deg';
switch smonth
        
    case 1
        FILE_NAME='Q20120012012031';
    case 2
        FILE_NAME='Q20120322012060.';
    case 3
        FILE_NAME='Q20120612012091';
    case 4
        FILE_NAME='Q20120922012121';
        sname2='Apr'
        year_name='2012'
    case 5
        FILE_NAME='Q20120922012121';
    case 6
        FILE_NAME='Q20121222012152';    
    case 7
        FILE_NAME='Q20121532012182';
    case 8
        FILE_NAME='Q20121832012213';
    case 9
        FILE_NAME='Q20122142012244';
    case 10 
        FILE_NAME='Q20122452012274';
    case 11
        FILE_NAME='Q20122752012305';
    case 12 
        FILE_NAME='';
        
end

sname=[FILE_NAME,Name_suff];
...
load('/Volumes/Data/Aquaris/aqmap_201204.mat')
ssal=s';
lon=lono;
lat=lato;

load('/Volumes/Data/Aquaris/aqmap_201210.mat')
fsal=s';
load('/Volumes/Data/Aquaris/aqmap_2012mean.mat')
meansal=s';
% [lon,lat,ssal]=read_sss(sname);
% [lon,lat,fsal]=read_sss(fname);

lon=[lon(end-3:end)-360,lon,lon(1:4)+360];
ssal=[ssal(end-3:end,:);ssal;ssal(1:4,:)];
fsal=[fsal(end-3:end,:);fsal;fsal(1:4,:)];
meansal=[meansal(end-3:end,:);meansal;meansal(1:4,:)];
surface_sal_2006=ssal;

surface_sal_2007=fsal;
...
corrhc=interp2(lat,lon,meansal,lat_tpx,lon_tpx');
corrhc(isnan(msk2(2:end-1,:)))=NaN;
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,['a) ',year_name],'fontsize',11,'fontweight','bold');
...
caxis([min_val max_val-del_cont])
xlabel('Sea Surface Salinity [PSS-78]')
...
corrhc=interp2(lat,lon,(surface_sal_2007-surface_sal_2006)/((fmonth-smonth)./12),lat_tpx,lon_tpx');
corrhc(isnan(msk2(2:end-1,:)))=NaN;
land_mask=msk2(2:end-1,:);
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,['b) ',fname2,'-',sname2],'fontsize',11,'fontweight','bold');
caxis([min_val max_val-del_cont])
b=gca;
apos=get(a,'pos')
...
caxis([min_val max_val-del_cont])
xlabel([fname2,'-',sname2,' ',year_name,' Sea Surface Salinity Trend [PSS-78 yr ^{-1}]'])
...
%eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_04_10_aquaris_mat_woce'])
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_04_10_aquaris_mat_argo'])
eval(['print -dtiff -r300 -f1 /Users/johnlyman/figs/oco/Sal/oco_04_10_aquaris_mat_argo'])
