function [hctpx,sshtpx]=heat_curv_gen_twin_real_realtime_2012_2016(tgrid,depth)

current_dir=cd('/Users/lyman/data/Globalhc/HC');
...
alpha2=interp2(alat,alon,alpha2,lat,lon');clear alon alat
