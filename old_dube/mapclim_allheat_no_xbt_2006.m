...
% pick only data from 1993 through 2002
tpx=topex(:,1);
day=datenum(dt);
gind=find(day>=datenum(1993,1,1)& ...
	~isnan(tpx+heatanom));
gind=find(day>=datenum(1993,1,1)&day<datenum(2008,1,1)& ...
	~isnan(tpx+heatanom));
...
save clim_2007_mac_no_xbt_2006 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
