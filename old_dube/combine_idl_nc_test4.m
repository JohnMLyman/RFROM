...
ncload('htanom_oco_realtime_2009_annual_2008_2008.nc','lon','lat','ht','htdiff','time','one','tpx','error')
...
%one(isnan(one))=0;
%tps(isnan(tpx))=0;
save 'htanom_oco_annual_2008' time lon lat one ht tpx error htdiff
