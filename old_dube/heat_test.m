...
%load 'htanom_1993_2006_3_error_jan_2007.mat'
%ncload ('htanom_3_error_1990_2006.nc')
ncload('htanom_diff_realtime_jan_2007_3_error_2005_2006.nc')                                                                       
ht=permute(ht,[3 2 1])./1e9;
one=permute(one,[3 2 1])./1e9;
                                                                                
error=permute(error,[3 2 1])./1e9;
...
tgrid=time_hc;
%save ../../HC/hcseries_1993_2006_jan_2007 hc tgrid hc_one
