...
ones_colormap=[[165, 0, 38]'/255,[215, 48, 39]'/255,[244, 109, 67]'/255,[253, 174, 97]'./255,[254, 224, 144]'/255,...
    [224, 243, 248]'/255,[171, 217, 233]'/255,[116, 173, 209]'/255,[69, 117, 180]'/255,[49, 54, 149]'/255]';
%ones_colormap=interp1([0:1/2:1],cold_to_hot_colormap,[0:1/255:1]);
...
load ../../HC/hdata_new__ishii_EN3_pfloat_sal_greg_jan_20121949_2012_100_real

htdiff_100=ht;
ind_2008=find(time ==1950.5);
...
%bad=find(one_2007 <= .8);
%ht_2007(bad)=NaN;
load ../../HC/hdata_new__ishii_EN3_pfloat_sal_greg_jan_20121949_2012_100_300_real
htdiff_100_300=ht;
...
load ../../HC/hdata_new__ishii_EN3_pfloat_sal_greg_jan_20121949_2012_300_700_real
htdiff_300_700=ht;
...
one_2007= 100*(1*one_2007_100+2*one_2007_100_300+4*one_2007_300_700)/7; 
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(60,54,'a) 1950','fontsize',11,'fontweight','bold');
...
corrhc=interp2(lat,lon,one_2007,lat_tpx,lon_tpx');
corrhc(isnan(corrhc))=0;
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,'b) 1950-1951','fontsize',11,'fontweight','bold');
...
caxis([min_val max_val-del_cont])
xlabel('percentage area coverage')
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_1950_web_1950_1951_insitu_new_one2'])
%eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2013_web_2013_2012_insitu_new'])
