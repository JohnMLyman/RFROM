...
c                     12345678901234567890123456789012345678901234567890123
	dfname(1:23)='hdata_no_argo_1997c.txt'
	nfname(1:25)='hdata_no_argo_1997c.notes'
	mfname(1:21)='map_no_argo_1997c.txt'
c get name of file with input data and read in data
	open(66,file='input4',form='formatted',status='old')
	read(66,'(a23)'),dfname(1:23)
	close(66)
	nfname(1:19)=dfname(1:19)
	mfname(13:17) = dfname(15:19)
...
c load grid info
	open(66,file='map_no_argo.grd',form='formatted',status='old')
