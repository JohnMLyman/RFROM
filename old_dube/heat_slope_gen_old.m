...
mean_error_map=mean(error_map_t);
mean_error_rep=mean(error_rep_t);
mean_error_ave=mean(error_ave_t);

std_diff_map=sqrt(mean((map_diff-mean_diff_map).^2));
std_diff_rep=sqrt(mean((rep_diff-mean_diff_rep).^2));

std_error_rep=sqrt(mean((error_rep_t-mean_error_rep).^2));
std_error_map=sqrt(mean((error_map_t-mean_error_map).^2));
