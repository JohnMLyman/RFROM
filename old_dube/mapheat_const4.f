...
c                     12345678901234567890123456789012345678901234567890123
	...
	dfname(1:20)='hdata_const_1993.txt'
	nfname(1:22)='hdata_const_1993.notes'
	mfname(1:18)='map_const_1993.txt'
c get name of file with input data and read in data
	open(66,file='input4',form='formatted',status='old')
	read(66,'(a20)'),dfname(1:20)
	close(66)
	write(*,*),dfname,nfname,mfname
	nfname(1:16)=dfname(1:16)
	mfname(11:14) = dfname(13:16)
	write(*,*),dfname,nfname,mfname
...
c load grid info
	open(66,file='map_const.grd',form='formatted',status='old')
