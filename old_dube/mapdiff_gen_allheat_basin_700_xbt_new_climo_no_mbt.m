...
function mapdiff_gen_allheat_basin_700_xbt_new_climo_no_mbt(start_year,end_year,fname_nc)
...
%  find the argo floats
good_argo=find(~(t(:,1)=='M' & t(:,2)=='B'));
