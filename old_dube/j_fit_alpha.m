function [y_model,y_model_err_95,slope_error,slope,res]=j_fit_alpha(t,y)
...
scale=1.;scalet=std(t);scaley=std(y);
%scalet=1
%scaley=1e8
t=t/scalet;
y=y/scaley;
...
% this wieghts the least square fit by the 1/var of the fit (see numerical
% recipies)

model_err=model_err*sqrt(chisqr);

y_model_err_95=sqrt(((t- mean(t))*model_err(1)).^2);
...
model_err=model_err*(scaley/scalet);

t=t*scalet;
y=y*scaley;
model=model*(scaley/scalet);
