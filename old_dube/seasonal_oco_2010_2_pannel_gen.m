function [junk]=seasonal_oco_2010_2_pannel_gen(lon,lat,ht,idepth,imonth,range,del)
lon_ht=lon;
lat_ht=lat;
junk=1;
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/seasonal_cycle/seasonal_',num2str(idepth),'m_month_',num2str(imonth)])
