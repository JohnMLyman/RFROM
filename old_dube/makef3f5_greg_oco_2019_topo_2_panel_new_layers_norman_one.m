...
% put the error onto a half year grid spacing

time_se_new=[min(time_se):.5:max(time_se)];
hc_se_new=interp1(time_se,hc_se,time_se_new);
hc_se_deep_new=interp1(time_se,hc_se_deep,time_se_new);
hc_se_total_new=interp1(time_se,hc_se_total,time_se_new);

hc_se_total=hc_se_total_new(1:end-1);
hc_se_deep=hc_se_deep_new(1:end-1);
hc_se=hc_se_new(1:end-1);
time_se=time_se_new(1:end-1);
...
layer_bounds=[0,40,90,190,290,450,700,950,1450,1950,2000];
file_name_argo='argo_2019_11_26_QC';
min_year_mapped='1990'; % the minimum year that was used to produce the OHCA fields.
max_year_mapped='2019';% the maximumyear that was used to produece the OHCA fields.


layer_bounds=[0,40,90,190,290,450,700,950,1450,1950,2000];
file_name_argo='argo_2020_8_14_QC';
min_year_mapped='1998'; % the minimum year that was used to produce the OHCA fields.
max_year_mapped='2019.5';% the maximumyear that was used to produece the OHCA fields.


[~,time,~]=...
         heat_curv_gen_mat_2012_new_un_topo_new_layers_half(['hdata_new_layers__ishii_EN3_2014_',file_name_argo,...
...
for ilayer=2:length(layer_bounds)
    ...
    hc_one_junk=[];
     ...
     one_0_2000=one_junk*(layer_bounds(ilayer-1)-layer_bounds(ilayer))+one_0_2000;
...
one_0_2000=one_0_2000./(-2000.);
 save 'norm_one.mat' time one_0_2000
hc_one_total=hc_one_deep+hc_one./1e21;
...
%%
save /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/pmel_hc_2019_norm time hc_one hc_se
%%
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/simon_hc_2019
...
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/tim_hc_2019
good_tim=find(tim_time> min_year);
tim_time=tim_time(good_tim);
tim_se=tim_se(good_tim);
tim_hc=tim_hc(good_tim);

load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/ishii_hc_2019
...
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/catia_hc_2019
...
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/cheng_hc_2019
...
axes
% % % save_ascii_oco_hc_2019
% compute the deep OHCA curves


%compute offsett

load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/tim_hc_2020_deep.mat tim_hc_deep tim_time_deep tim_se_deep
...
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/ishii_hc_2020_deep.mat ishii_hc_deep ishii_time_deep ishii_se_deep
% tim_hc_deep=hc_one_deep';
% tim_time_deep=time_deep;
% tim_se_deep=hc_se_deep;
load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/cheng_hc_2020_deep.mat cheng_hc_deep cheng_time_deep cheng_se_deep

load /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/simon_hc_2020_deep.mat simon_hc_deep simon_time_deep simon_se_deep
...
%
save /Volumes/ThunderBay/Data/Globalhc/SAL/Floats/pmel_hc_2020_deep_norm.mat hc_one_deep time_deep hc_se_deep
...
% 
  eval(['print -dpng -f3 /Users/lyman/Documents/figs/oco/Oceans/curve_oco_2020_topo_2_panel_NCEI_new2'])
    eval(['print -depsc2 -f3 /Users/lyman/Documents/figs/oco/Oceans/curve_oco_2020_topo_2_panel_NCEI_new2'])

      eval(['print  -dtiff -r300 -f3 /Users/lyman/Documents/figs/oco/Oceans/curve_oco_2020_topo_2_panel_NCEI_new2'])
...
save greg_OHCA_2000.mat time_deep hc_se_total hc_one_total
...
% % 
save greg_rate_OHCA_2000 rate_2000 se_rate_2000 time_rate_2000 OHCA_2000 ...
    time_OHCA
% % figure(100)
