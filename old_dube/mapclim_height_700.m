...
load allheight_700
load /Users/johnlyman/data/Globalhc/Levitus/hlevheight_700
...
alat=lat;alon=ln;
save /Users/johnlyman/data/Globalhc/HC/hregress_700_height alat alon alpha crl xvar
%return
cds=cd;
...
gheightclim=map+levheat(ii,:);
gheightclim2=map+levheat(ii,:)-tpxmap;
levheight=levheat;
save /Users/johnlyman/data/Globalhc/HC/clim_2_2004_2008_700_height gheightclim gheightclim2 ln lon lat map tpxmap levheight 
