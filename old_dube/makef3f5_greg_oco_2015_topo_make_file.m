...
% % 
% % hc_se=[ohca_se ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end)]*10;
% % 
% % time_error=time;

% Make the standard error based on Tim's XBT paper and My sampiling paper.
% % total_uncertianty_2015


load '/Volumes/Data/OHCA_curves/total_uncertainty_paper_2015_0_700'  time_se total_se


good_se=(find(time_se>min_year & time_se< max_year));
ohca_se=total_se(good_se);
hc_se=[ohca_se ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ];
time_error=time_se(good_se)';
...
% % %  [hc,time,hc_one_100]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_100_real',0,100);
% % % [hc,time,hc_one_100_300]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_100_300_real',100,300);
% % %  [hc,time,hc_one_300_700]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_300_700_real',300,700);
% % %  [hc,time,hc_one_700_900]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_900_real',700,900);
% % %  [hc,time,hc_one_900_1800]=heat_curv_gen_mat_2012_new_un_topo('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_1800_real',900,1800);
% % %  hc_one=hc_one_100+hc_one_100_300+hc_one_300_700;
% % % save '/Volumes/Data/Globalhc/SAL/Floats/nature_2014_jan_ohca_curve_oco_greg2_2014_topo' time hc_one hc_se
load '/Volumes/Data/Globalhc/SAL/Floats/nature_2014_jan_ohca_curve_oco_greg2_2014_topo' time hc_one
...
good_simon=find(simon_time> 1990);
...
good_ishii=find(ishii_time> 1990);
% ishii_time=ishii_time(good_ishii);
% ishii_se=ishii_se(good_ishii);
% ishii_hc=ishii_hc(good_ishii);

load /Volumes/Data/Globalhc/SAL/Floats/catia_hc_2014
good_catia=find(catia_time> 1990);
...
axis([min_year max_year -100 110])
set(gca,'fontsize',16)
...
%I have not run the last line of code yet.
save_ascii_oco_hc_1990_2014
