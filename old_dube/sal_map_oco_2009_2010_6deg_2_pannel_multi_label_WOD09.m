...
function [syear]=sal_map_oco_2009_2010_6deg_2_pannel_multi_label_WOD09(fyear)
...
[cs1,h1]=m_contourf(lon,lat,coorhc',[min_val:del_cont:max_val]);
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2010_2009_2_pannel_label2'])
eval(['print -depsc2 -r600 -f1 /Users/johnlyman/figs/oco/Sal/oco_',num2str(fyear),'_jan_surface_sal_6deg_change_2010_2009_2_pannel_label2'])
