...
eval(['load ',file_path_out,file_name,'_heat_amon_oco_monthly_removed heat_1800 heat_900 heat_700 heat_300 heat_1800_anom heat_900_anom heat_700_anom heat_300_anom coords date mdep npts time fptot fpkeep bdt bbas ind id qual ',...
...
aviso_path='/Users/johnlyman/data/Globalhc/Mtpers/realtime_2010/';
...
aviso_mean=ones(nlon_aviso,nlat_aviso,n_aviso_files).*NaN;
...
aviso_mean=squeeze(nanmean(aviso_mean,3));
...
aviso=aviso-repmat(aviso_mean,[1,1,n_aviso_files]);



eval(['save ',file_path_out,'aviso_2004_2009_oco -v7.3 aviso aviso_no_cycle aviso_mean lon lat sshcyc date_aviso day_aviso']);
...
eval(['save ',file_path_out,'allheat_300_700_900_1800_monthly_removed ht_300 ht_700 ht_900 ht_1800 topex cds dt tm mdep npts time fptot fpkeep bdt bbas ind id qual ',...
