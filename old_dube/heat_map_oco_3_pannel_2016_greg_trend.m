...
path_ssh='../../Mtpers/realtime_2016/';
s=sdir([path_ssh,'ssh*.mat']);
nfiles=floor(length(s)./7);
pos_good_s=[1:nfiles]*7;
s=s(pos_good_s);
...
ind_all=find(time>1993 & time <2015);
...
alpha_100=interp2(alat,alon,alpha_100,lat_tpx,lon_tpx)*-1;
alpha_100_300=interp2(alat,alon,alpha_100_300,lat_tpx,lon_tpx)*-1;
alpha_300_700=interp2(alat,alon,alpha_300_700,lat_tpx,lon_tpx)*-1;clear alon alat
...
hold on
set(h1,'linecolor','none','linew',0.1)
hold on
...
t1=m_text(30,100,['(a) ', num2str(fyear)],'fontsize',12,'fontname','arial','linew',0.1);
...
set(ja,'tickdir','out','xaxisl','top','xtick',[min_val:del_val:max_val],'yticklabel',[],'tickdir','out','ytick',[],'fontname','arial','fontsize',11)
caxis([min_val max_val-del_cont])
xlabel('   Upper Ocean Heat Content Anomaly (J m ^{-2} x 10^9)','fontsize',12,'fontname','arial')
...
hold on
%m_grid('tickdir','out','xtick',[60:60:390],'xticklabel',[],'ytick',[-90:30:90],'linestyle','none','fontname','arial','fontsize',12,'box','on');
m_grid('xtick',[60:60:360],'ytick',[-90:30:90],'box','on','tickdir','out','linestyle','none','fontname','arial','fontsize',12,'linew',1);


m_coast('patch',.999*[1 1 1]);
t1=m_text(30,100,['(b) ' num2str(fyear) '-' num2str(syear)],'fontname','arial','fontsize',12,'linew',0.1);
...
set(jb,'tickdir','out','xtick',[min_val:del_val:max_val],'ytick',[],'fontname','arial','fontsize',12,'yticklabel',[],...
    'xticklabel',{'-95' '' '-75' '' '-55' '' '-35' '' '-15' '-5' '5' '15' '' '35' '' '55' '' '75' '' '95'  })
caxis([min_val max_val-del_cont])
xlabel('Year to Year Heat Content Change (W m ^{-2})','fontname','arial','fontsize',12)
drawnow
...
%%% print plot
% % % 
% % % eval(['print -dpng -f1 /Users/lyman/figs/oco/Oceans/oco_heat_2016_',num2str(fyear)])
% % % eval(['print -dpdf -f1 /Users/lyman/figs/oco/Oceans/oco_heat_2016_',num2str(fyear)])
% % % % 
% % % %eval(['print -dtiff -r300 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2015_webn3'])
% % % close all
