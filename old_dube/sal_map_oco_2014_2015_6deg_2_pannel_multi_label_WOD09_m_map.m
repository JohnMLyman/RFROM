...
function [syear]=sal_map_oco_2014_2015_6deg_2_pannel_multi_label_WOD09_m_map(fyear)
'cat'
syear=fyear-1;
...
load 'surface_sal_nov_2015_2002_2015_6_deg.mat' lat lon time one sal;
...
eval(['print -dpdf -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_nov_2015_new'])
%eval(['print -dtiff -r300 -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(fyear),'_surface_sal_6deg_change_nov_2015_new'])
