...
load /Users/johnlyman/Desktop/OCO/ml_OHCA_2008minus2007.mat
lat=y;
lon=x;
heat_change=Q_diff';
...
% gets rid of double 30 in the middle
jj=jj(1:end-1);

lon=[lon(jj)-360;lon(ii)];
heat_change=[heat_change(jj,:);heat_change(ii,:)];
% shift lon so that it goes from -180 to 180
...
% % % 
% % % 
% % % t1=text(60,54,'a) 2008','fontsize',11,'fontweight','bold');
% % % axis([30 390 -90 90])
% % % axis equal
% % % axis([30 390 -90 90])
% % % a=gca;
...
corrhc=interp2(lat,lon',heat_change,lat_tpx,lon_tpx');
corrhc(isnan(corrhc))=0;
...
t1=text(55,54,'   2008-2007','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
b=gca;
...
set(b,'pos',bpos+[0 -.05 0 0])
%set(jb,'XAxisLocation','bottom')

%%% print plot

% % eval(['print -djpeg90 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2008_jan_realtime_2008'])
% % eval(['print -djpeg90 -f2 /Users/johnlyman/figs/oco/Oceans/oco_heat_change_diff_2008_jan_realtime_2008_2007'])
% % 
% % eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2008_jan_realtime_2008'])
% % eval(['print -dpdf -f2 /Users/johnlyman/figs/oco/Oceans/oco_heat_change_diff_2008_jan_realtime_2008_2007'])

eval(['print -dtiff -r600 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2008_mixed_layer_test'])
