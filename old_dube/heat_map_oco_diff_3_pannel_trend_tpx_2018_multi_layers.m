...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_tpx_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_tpx_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])

eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_tpx_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
