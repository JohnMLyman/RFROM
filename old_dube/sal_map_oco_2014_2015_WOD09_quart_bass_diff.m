...
sss_bass_quart(:,:,4)=squeeze(nanmean(sss_bass(:,:,:,69:70),4));
e_bass_quart(:,:,4)=max(squeeze(ebass(:,:,:,69:70)),[],3);
...
eval(['print -dpdf -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_6deg_change_nov_2015_new_bassd'])
eval(['print -dtiff -r300 -f1 /Users/lyman/figs/oco/Sal/oco_',num2str(iyear),'_quart_surface_sal_6deg_change_nov_2015_new_bassd'])
close all
end