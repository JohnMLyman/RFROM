...
t1=text(60,54,'a) 2010 no tpx','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
a=gca;
...
t1=text(55,54,'b) 2010-2009 no tpx','fontsize',11,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
b=gca;
...
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_content_diff_2010_realtime_2010_2p_700_no_tpx_uh'])
