...
load /home/shoko2/wills/globalhc_dirs/Globalhc/SAL/Floats/data/ht_diff_1993_2006_xbt_delayed.mat
lon2=lon;
lat2=lat;
start_year=2005
...
lon=lon2;
lat=lat2;
iyear_1=find(tgrid == iyear+.5);
corrhc=(hc_diff(:,:,iyear_1)-hc_diff(:,:,iyear_1-1)).*1e9;
...
t1=text(70,50,[num2str(iyear),'-',num2str(iyear-1)],'fontsize',16,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
...
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/heat_content_change',num2str(start_year)])
