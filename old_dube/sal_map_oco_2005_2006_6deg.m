...
ncload('surface_sal_anom_3_error_6_deg_2006_2006.nc','lat','lon','time','one','sal','error');
one_2006=permute(one,[3 2 1]);
error_2006=permute(error,[3 2 1]);
...
ncload('surface_sal_anom_3_error_6_deg_2004_2005.nc','lat','lon','time','one','sal','error');
...
one_2005=one_2004_2005(:,:,ind_2005);

% Mask loaction with less than a 80% coverage

bad=find(one_2005 <= .8);
surface_sal_2005(bad)=NaN;
...
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_surface_sal_6deg_2006'])
eval(['print -dpng -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_surface_sal_6deg_2005'])
eval(['print -dpng -f3 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_surface_sal_6deg_change_2006_2005'])
