...
file_name_argo='pfloat_sal_greg_jan_2021_QC'
...
file_path_hdata='/Volumes/ThunderBay/Data/Globalhc/HC/'
file_WOD_suf='_ishii_EN3_2014'
file_EN3_type='_ishii_EN3_2014'
path_EN3='/Volumes/ThunderBay/Data/EN3/ishiiXBTMBT_2014/'
allheat_extra='_new'




% % % year_of_oco_pub=2018; %  NEED TO CHANGE year_of_oco_pub OR TREND WONT CHANGE AND PLOTS WILL BE WRITEN OVER
...
% % % file_name='argo_2017_1_3_QC' % NEED TO CHANGE TO MATCH OCO_MAPS_2017_2 
% % % OHCA_map_name=['hdata_new_layers__ishii_EN3_2014_',file_name,'1990_2017_'] %NEED TO CHANGE TO MATCH OUTPUT OF OCO_MAPS_2017_2
% % % YEARS_plot_maps=[ 2017] %  NEED TO CHANGE TO REFLECT CURRENT YEARS 
% % % 
% % % depth_top_plot=0;
% % % depth_bot_plot=700;
% % % slope_min_year=1993; %MUST BE GREATER THAN MIN MAP YEAR IN OHCA_map_name (ie the second to last year in the name) !!!
year_of_oco_pub=202113; %  NEED TO CHANGE year_of_oco_pub OR TREND WONT CHANGE AND PLOTS WILL BE WRITEN OVER
%      NEED TO MAKE SURE THAT: 
%      heat_slope_file=['slope_heat_',num2str(year_of_oco_pub),'_insitu_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)];
%      has been errased if you want the slope to be recomputed
...
YEARS_plot_maps=[2020] %  NEED TO CHANGE TO REFLECT CURRENT YEARS 
...
ind_all=find(time>min_year_maps & time <min_year_maps+1);
...
% save 'test_2021.m' lat lon corrhc tpxest_2008
...
greg_map_hc_20_year_insitu_scatter_plot_oco
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_insitu_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_insitu_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])

eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Oceans/oco_heat_m_',num2str(year_of_oco_pub),'_web_3_pannel_insitu_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
