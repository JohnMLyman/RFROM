...
ncload('surface_sal_anom_3_error_6_deg_jan_2006_2008.nc','lat','lon','time','one','sal','error');
one=permute(one,[3 2 1]);
error=permute(error,[3 2 1]);
surface_sal=permute(sal,[3 2 1]);

ind_2006=find(time == 2007.5);
...
eval(['print -dtiff -f3 /Users/johnlyman/figs/oco/Sal/oco_2008_oct_surface_sal_6deg_change_jan_2008_2007'])
