...
for i=length(time)-1:length(time)-1
%i=3
figure(i);wysiwyg
...
caxis([min_val max_val])
xlabel('Ocean Heat Content Anomoly [J m^{-2} x 10^9]')
...
eval(['print -dpng -f',num2str(i),' /home/shoko/C/','''IDL ps''','/heat/talk/heat_',num2str(floor(time(i)))])
