...
%     [alat,alon,alpha_1800,c_1800,xvar_1800]=compute_alpha(ht_1800(good_time),topex(good_time,2),dt(good_time,:),cds(good_time,:),wnum(good_time)');
    ...
    eval(['load ',file_path_out,'hregress_100_2 alpha_100 c_100 xvar_100 alat alon']);
    eval(['load ',file_path_out,'hregress_300_2 alpha_300 c_300 xvar_300 alat alon']);
    
    eval(['load ',file_path_out,'hregress_100_300_2 alpha_100_300 c_100_300 xvar_100_300 alat alon']);
    eval(['load ',file_path_out,'hregress_300_700_2 alpha_300_700 c_300_700 xvar_300_700 alat alon']);
    
    eval(['load ',file_path_out,'hregress_700_2 alpha_700 c_700 xvar_700 alat alon']);
    eval(['load ',file_path_out,'hregress_900_2 alpha_900 c_900 xvar_900 alat alon']);
    eval(['load ',file_path_out,'hregress_1800_2 alpha_1800 c_1800 xvar_1800 alat alon']);
...
fname_nc=[file_path_hdata,'hdata_new_',file_WOD_suf,'_',file_name];
    
    
coords = cds;

eval(['save ',fname_nc,' htdiff_100 htdiff_300 htdiff_100_300 htdiff_300_700 htdiff_700 htdiff_900 htdiff_1800 tpx yr coords ht_100 ht_300 ht_100_300 ht_300_700 ht_700 ht_900 ht_1800'])
