...
eval(['load ',file_path_out,'allheat_300_700_900_1800_monthly ht_300 ht_700 ht_900 ht_1800 topex cds dt tm mdep npts time fptot fpkeep bdt bbas ind id qual ',...
...
fname_nc=[file_path_hdata,'hdata_monthly_',file_name];
