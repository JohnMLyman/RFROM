...
subplot(2,1,2)
year=dt(:,1);
time_2005=find(year == 2005);
n=hist(year,[1950:2006]);h=bar(1950:2006,n/1e3,'k');
%axis([1992.4 2003.6 0 200])
axis([1954 2006 0 200])
set(gca,'fontsize',16)
...
% print plot
 print -dpng -f1 /home/shoko/C/'IDL ps/'heat/agu/hist_agu
