...
for iyear=2021:2022
    ...
    eval(['print -dpng  -r600 -f1 ',path_figs,'oco_heat_m2_',num2str(year_of_oco_pub),'_fixed_tpx_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
    eval(['print -dtiff -r600 -f1 ',path_figs,'oco_heat_m2_',num2str(year_of_oco_pub),'_fixed_tpx_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
    
    eval(['print -depsc2 -f1 ',path_figs,'oco_heat_m2_',num2str(year_of_oco_pub),'_fixed_tpx_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
   close(1)
end
