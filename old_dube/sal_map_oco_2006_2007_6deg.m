...
t1=text(60,50,'2006','fontsize',16,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% plot 1-year surface_sal  cange 2007 %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%eval(['print -dtiff -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/oco/oco_2007_oct_surface_sal_6deg_jan_2007'])
