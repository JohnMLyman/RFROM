...
corrhc=interp2(lat,lon,one_2003_john-one_2003,lat_tpx,lon_tpx');
...
corrhc=interp2(lat,lon,one_2003_john,lat_tpx,lon_tpx');
corrhc(isnan(corrhc))=0;
...
t1=text(60,50,'2003','fontsize',16,'fontweight','bold');
axis([30 390 -90 90])
axis equal
axis([30 390 -90 90])
set(gca,'xtick',[30:30:390],'tickdir','out','xticklabel', [30:30:180,-150:30:30],'ytick',[-90:30:90])
...
eval(['print -dpng -f1 /home/shoko/C/','''IDL ps''','/heat/oco/2006/oco_john_josh_2003_diff_one'])
