...
load ../../HC/hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131992_2012_100_real

htdiff_100=ht;
ind_2008=find(time == 2011.5);
...
%bad=find(one_2007 <= .8);
%ht_2007(bad)=NaN;
load ../../HC/hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131992_2012_100_300_real
htdiff_100_300=ht;
...
load ../../HC/hdata_new__ishii_EN3_2013_pfloat_sal_greg_jan_20131992_2012_300_700_real
htdiff_300_700=ht;
...
ind_all=find(time>1993 & time <2011);
...
hold on
m_coast('patch',[1 1 1]);
t1=m_text(55,54,'b) 2012-2011','fontsize',11,'fontweight','bold');
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2013_web_2011_2010_insitu_new'])
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2013_web_2011_2010_insitu_new'])
