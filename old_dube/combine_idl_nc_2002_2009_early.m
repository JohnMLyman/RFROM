...
ncload('htanom_oco_realtime_2009_2002_2009.nc','lon','lat','ht','htdiff','time','one','tpx','error')
...
%one(isnan(one))=0;
%tps(isnan(tpx))=0;
save 'htanom_oco_realtime_2002_2009' time lon lat one ht tpx error htdiff
