...
'cat'
gind=find(day>=datenum(1993,1,1)&day<datenum(2009,1,1)& ...
	~isnan(tpx+heatanom));
...
save /Users/johnlyman/data/Globalhc/HC/clim_2_1993_2008_700 gheatclim gheatclim2 ln lon lat map tpxmap levheat 
