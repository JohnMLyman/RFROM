...
%computes alpha!
 ...
 path='/Users/johnlyman/data/xbt/Levitus/'

 eval(['cd ',path,'Globalhc/HC'])



clim_path='/Users/johnlyman/data/Globalhc/HC/'
load allheat_700
...
'cat'
gind=find(day>=datenum(2001,1,1)&day<datenum(2002,1,1)& ...
	~isnan(heatanom));
...
save /Users/johnlyman/data/Globalhc/HC/clim_2_1993_2002_700_realtest gheatclim gheatclim2 ln lon lat map tpxmap levheat 
