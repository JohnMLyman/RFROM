...
load ../SAL/Floats/hc_factor_trend_no_te
junk_years=[1998 1970 2005 2006];
for iyear=start_year:2006
    
    one_pos=find(time == iyear+.5);
    one_scale=hc_one(one_pos);

%    file_name=['hdata_twin_allheat_no_te_',num2str(iyear),'_1993_2006.nc']
    
%     [tsub,tsub_hc,tgrid]=heat_curv_gen_twin_trend(file_name);
% 
%     tsub=tsub./area_of_ocean;
%   eval(['save ./hc_curve/hc_curve_1993_2006_trend_no_te_',num2str(iyear),' tsub tgrid tsub_hc']); 
 eval(['load ./hc_curve/hc_curve_1993_2006_trend_no_te_',num2str(iyear)]);
...
eval(['print -dpng -f2 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/aviso_estimate_no_te_new'])
eval(['print -dpng -f1 /home/shoko2/wills/globalhc_dirs/Globalhc/figs/trend_paper/aviso_estimate_slope_no_te_new'])
