...
alpha_100=interp2(alat,alon,alpha_100,lat_tpx,lon_tpx)*-100;
alpha_100_300=interp2(alat,alon,alpha_100_300,lat_tpx,lon_tpx)*-100;
alpha_300_700=interp2(alat,alon,alpha_300_700,lat_tpx,lon_tpx)*-100;clear alon alat
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2014_webn2junk'])
eval(['print -dpdf -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2014_webn2junk'])

eval(['print -dtiff -r300 -f1 /Users/johnlyman/figs/oco/Oceans/oco_heat_2014_webn2junk'])
