...
% load('/Users/lyman/Documents/MATLAB/BASS_2019/bass_matlab_2019.mat')
load('/Users/lyman/Documents/MATLAB/BASS_2019/bass_matlab_2019_li.mat')
s=length(bass_month);
...
%BE CARFULL MAKE SURE THAT THE START TIME IS JAN, 2010
%  MIGHT WANT TO DOUBLE CHECK THAT THE TIME IDCIES CORRESPOND WITH THE
%  RIGHT QUARTERS

plot_year=2019;

nm=12*(plot_year-2016);
...
% 
eval(['print -dpng -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_',num2str(plot_year),'_new2'])
 eval(['print -depsc2 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_',num2str(plot_year),'_new2'])
% % % 
 eval(['print -dtiff -r600 -f1 /Users/lyman/Documents/figs/oco/Sal/oco_',num2str(iyear),'_quart2_surface_sal_bass_one_',num2str(plot_year),'_new2'])
