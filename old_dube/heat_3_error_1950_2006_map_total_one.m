...
set(j,'tickdir','out','xaxisl','top','xtick',[min_val:del_val:max_val],'ytick',[])
caxis([min_val max_val])
xlabel('mean of fraction of area')
...
set(j,'tickdir','out','xaxisl','top','xtick',[min_val:del_val:max_val],'ytick',[])
caxis([min_val max_val])
xlabel('standard devation of fraction of area')
...
times_string=[num2str(time(start_ind)-.5),'-',num2str(time(end_ind)-.5)];
eval(['print -dpng -f1 ../figs/trend_paper/mean_one_',time_string])
eval(['print -dpng -f2 ../figs/heat/trend_paper/std_one_',times_string])
