function [p_bar,p_map]=map_paper_2013_r(file_name,title_name,panel_letter,fig_number)
...
hold on
m_grid('tickdir','out','xtick',[30:90:390],'ytick',[-90:30:90],'linestyle','none');

t1=m_text(60,54,panel_letter,'fontsize',10,'fontweight','bold');
title(title_name)
...
p_bar=gca;
pos_bar=get(p_bar,'pos');
set(p_bar,'pos',pos_bar-[0 .7 0 0]);
end
