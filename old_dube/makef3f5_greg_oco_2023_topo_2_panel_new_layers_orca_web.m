...
% % 
TreeSetUp=TreeSetUp_2023_orca_heat_novert_test;
...
hc_one=ht_curve_annual_0_2000./1e21;
...
hc_all=[hc_one(1)]+30
% ;tim_hc(1);simon_hc(1);ishii_hc(1);cheng_hc(1)];
...
%%     
figure(3); clf;orient landscape; wysiwyg_tuna
...
set(gca,'tickdir','out','Fontsize',16,'Fontname','Arial','box','on','xtick',[1970:5:max_year],...
...
ylabel('0-2000 m OHC (ZJ)','Fontsize',16,'Fontname','Arial')

xlabel('Time (years)','Fontsize',16,'Fontname','Arial')
...
% hc_all=[hc_one_deep(1)'];
% % ;tim_hc_deep(1);ishii_hc_deep(1);cheng_hc_deep(1);simon_hc_deep(1)];
% 
% offset=nanmean(hc_all);
% 
...
% 
  eval(['print -dpng -r600 -f3 ',path_figs,'curve_web_',num2str(year_of_oco_pub)])
  save_ascii_oco_hc_web_2023
