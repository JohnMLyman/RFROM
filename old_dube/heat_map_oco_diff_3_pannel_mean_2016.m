...
corrhc=(mean_heat_oa_100(:,:,2:13)+mean_heat_oa_100_300(:,:,2:13)+mean_heat_oa_300_700(:,:,2:13))./1e8;
corrhc=nanmean(corrhc,3);
lon=lon_tpx;
lat=lat_tpx;
...
%%% print plot
wysiwyg;orient tall
eval(['print -dpng -f1 /Users/lyman/figs/oco/Oceans/oco_heat_2016_2015_2014_3_pannel_season_insitu_mean',num2str(imon)])
end