...
hc_se=[ohca_se ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end) ohca_se(end)]*10;
...
% % 
% % % %  [hc,time,hc_one_100]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_100_real');
% % % % [hc,time,hc_one_100_300]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_100_300_real');
% % % %  [hc,time,hc_one_300_700]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_300_700_real');
% % % %  [hc,time,hc_one_700_900]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_900_real');
% % % %  [hc,time,hc_one_900_1800]=heat_curv_gen_mat_2012_new_un('hdata_new__ishii_EN3_2014_pfloat_sal_greg_jan_2015_QC1950_2014_1800_real');
% % % %  hc_one=hc_one_100+hc_one_100_300+hc_one_300_700;
% % % % save '/Volumes/Data/Globalhc/SAL/Floats/nature_2014_jan_ohca_curve_oco_greg2_2014' time hc_one hc_se
load '/Volumes/Data/Globalhc/SAL/Floats/nature_2014_jan_ohca_curve_oco_greg2_2014' time hc_one hc_se

hc_se=[repmat(hc_se(1),[1 43]) hc_se];
...
hc_se=hc_se(good_pos);
%%


load /Volumes/Data/Globalhc/SAL/Floats/simon_hc_2013
...
load /Volumes/Data/Globalhc/SAL/Floats/catia_hc_2013_2
...
pt=plot(tim_time,tim_hc,'-*','color',mycor(1,:));
et=errorbar(tim_time,tim_hc,tim_se,'color',mycor(1,:));set(et,'linewidth',3);
hold on
pc=plot(catia_time,catia_hc,'-*','color',mycor(2,:));
ec=errorbar(catia_time,catia_hc,catia_se,'color',mycor(2,:));set(ec,'linewidth',3);
hold on
p2=plot(time,hc_one,'-*','color',mycor(3,:));
e=errorbar(time,hc_one,hc_se,'color',mycor(3,:));set(e,'linewidth',3);
...
set(ps,'linewidth',3)
%set(pt,'linewidth',3)
set(gca,'XTick',[1960:5:max_year],'tickdir','out', 'XMinorTick','off')


xlabel('Time [years]','fontsize',16);

%title('0-700m Heat Content Anomaly','fontsize',18);
axis([min_year max_year -150 120])
set(gca,'fontsize',16)
...
text(year_text,text_off+text_del*1,'Met Office ','color',mycor(4,:),'FontName','Arial','FontSize',text_size)
...
text(year_text,text_off+text_del*2,'NODC ','color',mycor(1,:),'FontName','Arial','FontSize',text_size)
plot([year_text-2 year_text-1],[text_off+text_del*2 text_off+text_del*2],'color',mycor(1,:),'linewidth',3)
...
text(year_text,text_off+text_del*3,'PMEL/JPL/JIMAR ','color',mycor(3,:),'FontName','Arial','FontSize',text_size)
plot([year_text-2 year_text-1],[text_off+text_del*3 text_off+text_del*3],'color',mycor(3,:),'linewidth',3)

text(year_text,text_off+text_del*4,'CSIRO/ACE CRC ','color',mycor(2,:),'FontName','Arial','FontSize',text_size)
...
eval(['print -dpng -f3 /Users/johnlyman/figs/oco/Oceans/curve_oco_1967_2015'])
eval(['print -depsc2 -r300 -f3 /Users/johnlyman/figs/oco/Oceans/curve_oco_1967_2015'])
eval(['print -dtiff -r300 -f3 /Users/johnlyman/figs/oco/Oceans/curve_oco_1967_2015'])
%%
