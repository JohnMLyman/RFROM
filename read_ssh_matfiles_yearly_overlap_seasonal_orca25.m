function read_ssh_matfiles_yearly_overlap_seasonal_orca(TreeSetUp)
...
mid_mean_maps=start_year_mean+delta_year_mean_maps./10;
...
%         clearvars sst_total ssh_total LON LATfor isplit=1:2
     ...
     yr_av=time_aviso;
    parfor tlayer=1:(nlayer-1)*4
        ilayer=ceil(tlayer./(nlayer-1))+1
...
%             clear model_all
            ...
            if isplit==1
                ...
                parsave_tree ([path_tree_junk,tree_file_name_season,num2str(tlayer),'_split_7day_junk.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)
            else
