function [ht_estimate]=bagged_yearly_tree_temp_SSH_SST_vert(iyear_mod,...
 ...
 if ibasin<= n_mod_basin
     ...
     if ~isempty(M)
        ...
        jw=repmat(weight_cross(pos_2d),nfiles,1);
            ...
            good=isfinite(jyr) & isfinite(jsst)&isfinite(jssh)&good_yr&isfinite(jhtvert);
            pos_use=find(pos_3d);
            pos_3d_use=pos_3d;
