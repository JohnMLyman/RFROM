function read_ssh_matfiles_all_years_orca_vert_sal_newcycle_extra_anomt(TreeSetUp)
...
tree_model_file_name_combined_withoutcycle_temp=TreeSetUp.tree_model_file_name_combined_withoutcycle_temp;
...
path_new_tree_combined_withoutcycle_temp=TreeSetUp.path_new_tree_combined_withoutcycle_temp;
...
%         file_name_temp=[path_new_tree_withcycle_temp,tree_file_name_out_withcycle_temp,'_split_7day.mat'] ;
        ...
        ht_estimate_m=nan(nlon_tpx,nlat_tpx,nfiles);        
            ...
            if ilayer==2
                ...
                [ht_estimate_m]=bagged_yearly_tree_temp_SSH_sal(iyear_mod,...
            ...
            elseif ilayer<=ilayer_depth_use_ssh
                file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_split.mat'];
                [ht_estimate_m]=bagged_yearly_tree_temp_SSH_vert_sal(iyear_mod,...
                    time_aviso,ssh_total,temp_use,...
                ...
                file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_split.mat'];
                [ht_estimate_m]=bagged_yearly_tree_temp_vert_sal(iyear_mod,...
                    time_aviso,temp_use,...
                    nfiles,ht_estimate_m,ht_estimate_old,TreePredictInfo,file_big_model,'a','all') ;
                 ht_estimate=ht_estimate_m.*weight_a;
                 ht_estimate_m=nan(nlon_tpx,nlat_tpx,nfiles);
...
%         ht_estimate=ht_estimate_a.*weight_a+ht_estimate_b.*weight_b+ht_estimate_c.*weight_c+ht_estimate_d.*weight_d;
        ...
        parsave_tree_year([path_new_tree,tree_file_name_out,'_extra_split_7day.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)
