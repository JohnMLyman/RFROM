function baggedtree_yearly_overlap_seasonal_anom_orca_sal_anomt_leaf(TreeSetUp)


nbasins_use=TreeSetUp.nbasins_use;
file_name=TreeSetUp.file_name;
var_type=TreeSetUp.var_type;
leaf_base=TreeSetUp.leaf_base;
...
% for ilayer=2:nlayer
    for iyear_mod=start_year:.5:end_year
       ...
       layer_offset=layer_off_all_junk{ilayer-1};
        ...
        if ilayer==2
            [model_all]=make_trees_mean_nosst_sal_leaf(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a',leaf_base);
            ...
            [model_all]=make_trees_mean_nosst_sal_leaf(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_sal_leaf(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_sal_leaf(use,ht_use,tpx,temp_use,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d',leaf_base);
...
%             ht_predict=ht_all_junk{ilayer-2}; 
            ...
            [model_all]=make_trees_mean_vert_nosst_sal_leaf(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
             [model_all]=make_trees_mean_vert_nosst_sal_leaf(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
             [model_all]=make_trees_mean_vert_nosst_sal_leaf(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
             [model_all]=make_trees_mean_vert_nosst_sal_leaf(use,ht_use,tpx,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        else
%             ht_predict=ht_all_junk{ilayer-2}; 
            ...
            [model_all]=make_trees_mean_vert_nosst_nossh_sal_leaf(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'a',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
             [model_all]=make_trees_mean_vert_nosst_nossh_sal_leaf(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'b',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
             [model_all]=make_trees_mean_vert_nosst_nossh_sal_leaf(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'c',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
        
             [model_all]=make_trees_mean_vert_nosst_nossh_sal_leaf(use,ht_use,temp_use,ht_predict,layer_offset,coords,yr,nbasins_use,good_yr,good_prof,'d',leaf_base);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
            parsave_model_all(file_big_model,model_all)
