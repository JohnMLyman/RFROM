opfunction [global_basins]=find_basin_paige_plot(lon,lat)
...
not_in_basin=~(in_ind|in_pac|in_arc|in_med|in_atl|in_bs|in_cs|in_bb|in_rs);
...
% global_basins(10).name='not identied in a basin';
% global_basins(10).pos=not_in_basin;