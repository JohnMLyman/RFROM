function []=baggedtree_hold_out_all_years_seasonal_orca_novert_paige(TreeSetUp)
...
parfor ilayer=2:nlayer
        ...
        if ilayer<=ilayer_depth_use_sst
            ...
            [model_all]=make_trees_mean_paige(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'a');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_paige(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'b');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_paige(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'c');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_paige(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'d');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name];
            parsave_model_all(file_big_model,model_all)

        else
            good_prof=isfinite(ht_use)&isfinite(tpx);
            [model_all]=make_trees_mean_nosst_paige(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'a');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_paige(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'b');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_paige(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'c');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_paige(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'d');
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name];
            parsave_model_all(file_big_model,model_all)
