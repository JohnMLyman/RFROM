...
for ilayer=2:nlayer
   layer_name=[num2str(layer_bounds(ilayer-1)),'_',num2str(layer_bounds(ilayer))]
    ...
    test_tree_year_compact
     file_big_model=[path_new_tree,tree_model_file_name,'_model_',layer_name,'.mat'];
        file_compact_model=[path_new_tree,tree_model_file_name,'_compact_model_',layer_name,'.mat'];
