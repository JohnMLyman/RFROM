function []=write_netcfd_cf_heat_depth_mon(ht_estimate,time_1950,lon_tpx,...
...
%     good=floor(time_aviso)==iyear;
    ...
    ohca_att(2).Value='mapped ocean heat content anomaly (TEOS-10) integrated from upper to lower bounds of mean depth';
