function []=loess_sal_errdap(TreeSetUp)
...
%            file_name_nc= [path_nc_erddap,'RFROM_OHCA_',num2str(iyear),'_',num2str(imonth),'.nc'];
               ...
               if imonth>=10
                      ...
                      file_name_nc_sal_loess= [path_nc_erddap_sal_loess,'RFROM_SAL_LOESS_',num2str(iyear),'_',num2str(imonth),'.nc'];
                      ...
                      file_name_nc_sal_loess= [path_nc_erddap_sal_loess,'RFROM_SAL_LOESS_',num2str(iyear),'_0',num2str(imonth),'.nc'];
