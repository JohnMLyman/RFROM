...
path_figs='C:\data\OHCA\figs\tree_paper\'
 eval(['print -dpng -r600 -f1 ',path_figs,'toa_tree_gilson_ceres2_rloess'])
%% yearly
...
path_figs='C:\data\OHCA\figs\tree_paper\'
 eval(['print -dpng -r600 -f2 ',path_figs,'toa_tree_gilson_ceres_cycle_new_rloess'])
% 
...
d = Document([path_figs,'Tree_corr_table_rloess'],'docx');
append(d,mltableObj);
close(d);
% rptview(d);
...
import mlreportgen.dom.*
mltableObj = MATLABTable(mltable);
d = Document([path_figs,'RG_corr_table_rloess'],'docx');
append(d,mltableObj);
close(d);
% rptview(d);
