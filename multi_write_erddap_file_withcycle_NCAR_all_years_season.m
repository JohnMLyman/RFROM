function []=multi_write_erddap_file_withcycle_NCAR_all_years_season(TreeSetUp)
...
parfor year_load=time_ssh_load
    ...
    aviso_day=1+(time_aviso-year_aviso).*365;
    sday=round(aviso_day+year_aviso*365);
    days_since_1950=sday-datenum(1950,1,1);
    [~,month_data]=datevec(aviso_day);
