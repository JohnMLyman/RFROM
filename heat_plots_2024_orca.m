function []=heat_plots_2023_orca(TreeSetUp)
...
[httpx_maps,lon_tpx,lat_tpx,time_grid]=load_annual_ohca_maps(TreeSetUp,depth_top_plot,depth_bot_plot);
lon_tpx=lon_tpx';
lat_tpx=lat_tpx';
arw=areavec(lon_tpx,lat_tpx);
httpx_maps=httpx_maps./arw;
...
for iyear=slope_max_year-2:slope_max_year
    ...
    greg_map_hc_20_year_tpx_scatter_plot_oco_orca
...
%     eval(['print -dpng -f1 ',path_figs,'oco_heat_m_',OUTOUT_type,'_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
    eval(['print -dtiff -r600 -f1 ',path_figs,'oco_heat_m_',OUTOUT_type,'_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
        eval(['print -dpng -f1 ',path_figs,'oco_heat_m_',OUTOUT_type,'_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])

%     eval(['print -depsc2 -f1 ',path_figs,'oco_heat_m_',OUTOUT_type,'_',num2str(fyear),'_',num2str(depth_top_plot),'_',num2str(depth_bot_plot)])
   close(1)
end
