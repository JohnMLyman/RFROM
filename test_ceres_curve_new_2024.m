path_data='H:\Figs\OHC\data\';
file_old=[path_data,'curve_tree_heat_novert_test_0_2000_ohca_nomean_OCO_2023_novert.nc'];
file_new=[path_data,'curve_tree_heat_novert_test_0_2000_ohca_nomean_OCO_2024_novert.mat'];
file_new_2023=[path_data,'curve_tree_heat_novert_test_0_2000_ohca_nomean_OCO_2023_novert.mat'];

file_txt=[path_data,'RFROMv21_OHU.txt'];

ohca=ncread(file_old,'ocean_heat_content_anomaly');
time=ncread(file_old,'time');
...
load(file_new)
[rate_vert,tgrid_rate_vert]=find_rate_tree_new(ht_curve,tgrid,2024);
...
tgrid_12mon=[(1993.5-1/24):1./12.:2024-1/24];
