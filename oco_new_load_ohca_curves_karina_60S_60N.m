...
[~,LATtest,~]=ndgrid(lon_tpx,lat_tpx,tgrid);

hiLAT=abs(LATtest) >60;
...
for ilayer=pos_top+1:pos_bot
    ...
    shallow=topo_tpx_new < depth_min | topo_tpx_new <300; % Karian doesn't want to use measurements in waters lesss than 300m
...
%     arwj_2d=arwj;
    ...
    % block out Latitudes higher than 60
    arwj(hiLAT)=nan;
