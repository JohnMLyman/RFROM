function []=read_ssh_matfiles_yearly_anom_orca2_sal_mean_t_nolatlon(TreeSetUp)
...
%                             jsst=double(sst_total(pos_3d));
                            ...
                            jw=repmat(weight_cross(pos_2d),nfiles,1);
                                ...
                                input_mat=nans(length(jyr_yearly),3);
...
%                                end
                                ...
                                input_mat(:,2)=jssh(good);
%                                 input_mat(:,5)=jsst(good);
                                input_mat(:,3)=jtemp_use(good);
                                jw_use=jw(good);
