...
%      [ht_estimate,~]=parload_tree_error([path_tree,tree_file_name_yearly_error,'_split_7day.mat'] );
     [ht_error,scale_total,scale_total_median]=...
         parload_tree_error([path_tree,tree_file_name_yearly_error,'_2xweight_7day_split.mat']);
...
%      'scale_total','scale_total_median')
    [ht_error,scale_total,scale_total_median]=...
        parload_tree_error([path_tree,tree_file_name_all_years_error,'_2xweight_7day_split.mat']);
...
%     '-v7.3')
    parsave_tree_error([path_tree,tree_file_name_combined_error,'_2xweight_7day_split.mat'],...
