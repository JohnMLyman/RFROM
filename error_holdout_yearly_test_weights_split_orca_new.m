...
function []=error_holdout_yearly_test_weights_split_orca_new(TreeSetUp)
...
path_new_error=path_new_error_yearly;
...
%   load([path_tree,tree_file_name_yearly,'_split_7day.mat'], 'ht_estimate', 'lon_tpx', 'lat_tpx', 'time_aviso')
  ...
  scale_total_median=scale_total;
   filename_holdout=[path_new_error,tree_model_file_name,'_hold_out_estiamte_split_',layer_name,'.mat'];
...
%     '-v7.3')
parsave_error_estimate([path_error,tree_file_name_yearly_error,'_2xweight_7day_split.mat'],ht_error,scale_total,...
