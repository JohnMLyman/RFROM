...
eval(['load ',file_path_out,file_name,'_','aviso_cycle lon lat ssh cyc']);
...
load([file_path_hdata,file_name_out,'_',layer_name,'_tree_half.mat'],...
'lon', 'lat' ,'time')
...
% load in the OA heatcontent estimates and difference estimates.
    ...
    load([file_path_hdata,file_name_out,'_',layer_name,'_tree_half.mat'], 'ht',...
        'htdiff','htdiff_tree','one', 'lon', 'lat' ,'time')
...
write_ascii_norm_half(httpx_curve_north,tgrid,'combined_0_2000_northern.txt');
write_ascii_norm(httpx_curve,tgrid,'combined_0_2000_whole.txt');
write_ascii_norm_half(httpx_curve_south,tgrid,'combined_0_2000_southern.txt');