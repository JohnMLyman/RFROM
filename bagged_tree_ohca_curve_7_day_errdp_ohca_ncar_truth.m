function bagged_tree_ohca_curve_7_day_errdp_ohca_ncar_truth(TreeSetUp,min_depth,max_depth)
...
[lone,late,yre,ohca_oute,layer_bounds_NCAR_oute]=load_heat_netcdf_NCAR_SMALL_fast([start_year:end_year],TreeSetUp);
