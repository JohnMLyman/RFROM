function   tree_movie_split_temp_al_newl_SO(TreeSetUp)
%%
...
nlayer=length(layer_bounds);
 ...
 file_sum_name=[path_tree,tree_model_file_name,'_SO_all.mat'];
...
%%
 ...
 % put into the proper coordinates
    ...
    min_val=-2;
    max_val=8.;
v=VideoWriter([path_figs,'tree_SO_all.avi']);
v.FrameRate = 10;
open(v)
...
%     corrhc=ht_estimate(:,:,iframe)./1e9;
   ...
   corrhc=ht_estimate_mean(:,:,iframe);
    ...
    a=gca;
    set(a,'xtick',[],'ytick',[])
        set(a,'tickdir','out','xtick',[0:10:360],'ytick',[-2000:100:0],...
            'XAxisLocation','bottom');
    yticklabels(([2000:-100:0]))
    axis(a,[0 360 -2000 0])
    apos=get(a,'pos');
   title(['55 S on ',num2str(time_aviso(iframe))])
