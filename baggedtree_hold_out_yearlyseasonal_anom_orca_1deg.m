...
%     for ilayer=2:nlayer
    ...
    for iyear_mod=start_year:.5:end_year
        ...
        if ilayer<=ilayer_depth_use_sst
            ...
            [model_all]=make_trees_mean_1deg(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'a',scale_box_deg);
            ...
            [model_all]=make_trees_mean_1deg(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'b',scale_box_deg);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_1deg(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'c',scale_box_deg);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_1deg(use,ht_use,tpx,sst,coords,yr,nbasins_use,good_yr,good_prof,'d',scale_box_deg);
            ...
            [model_all]=make_trees_mean_nosst_1deg(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'a',scale_box_deg);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_a_',layer_name,'_',year_file_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_1deg(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'b',scale_box_deg);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_b_',layer_name,'_',year_file_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_1deg(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'c',scale_box_deg);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_c_',layer_name,'_',year_file_name];
            parsave_model_all(file_big_model,model_all)
        
            [model_all]=make_trees_mean_nosst_1deg(use,ht_use,tpx,coords,yr,nbasins_use,good_yr,good_prof,'d',scale_box_deg);
            file_big_model=[path_new_tree,tree_model_file_name,'_model_d_',layer_name,'_',year_file_name];
            parsave_model_all(file_big_model,model_all)
