...
file_sum_name=[path_tree,tree_model_file_name,'_',num2str(min_layer),'_',num2str(max_layer),'_split_7day_mask.mat'];

% if ~exist(file_sum_name,'file')
    bagged_tree_ohca_maps_7_day_split_mask
% else
...
v=VideoWriter([path_figs,'ohca_gaps_0_2000_combine_mask.avi']);
open(v)
