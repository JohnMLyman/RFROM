...
path_ERDDAP='H:\erddap\sal_vert';
path_ERDDAP_sal=path_ERDDAP;
path_ERDDAP_temp='H:\erddap\temp_vert';
...
path_new_tree_combined_withcycle_temp=[path_tree_temp,'combined_withcycle\'];
...
% % % 
% % % 
% % % 'baggedtree_yearly_overlap_seasonal_anom_orca_sal'
% % % baggedtree_yearly_overlap_seasonal_anom_orca_sal(TreeSetUp)
% % % toc./60./60
% % % 
% % % 'read_ssh_matfiles_yearly_seasonal_anom_orca_vert_sal'
% % % read_ssh_matfiles_yearly_seasonal_anom_orca_vert_sal(TreeSetUp)
% % % toc./60./60
% % % 
