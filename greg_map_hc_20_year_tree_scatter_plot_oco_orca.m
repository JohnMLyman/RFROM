...
path_heat_slope='D:\data\OHCA\OHCA_grided\';

heat_slope_file=[path_heat_slope,'slope_heat_',num2str(year_of_oco_pub),'_tree_orca_',num2str(min_layer),'_',num2str(max_layer)];
