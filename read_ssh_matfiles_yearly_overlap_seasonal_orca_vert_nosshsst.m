function read_ssh_matfiles_yearly_overlap_seasonal_orca_vert_nosshsst(TreeSetUp)
...
% for year_load=time_ssh_load
    ...
    for ilayer=2:nlayer
        ...
        for iyear_mod=start_year_mod:.5:end_year_mod
            ...
            if ilayer==2
               file_big_model=[path_tree_junk,tree_model,'_model_',layer_name,'_',year_file_name,'_split.mat'];
                     [ht_estimate]=bagged_yearly_tree_temp_SSH_SST(iyear_mod,...
                        time_aviso,ssh_total,sst_total,...
                        nfiles,ht_estimate,TreePredictInfo,file_big_model) ;
                elseif ilayer<=ilayer_depth_use_sst
                 file_big_model=[path_tree_junk,tree_model,'_model_',layer_name,'_',year_file_name,'_split.mat'];
                   [ht_estimate]=bagged_yearly_tree_temp_SSH_SST_vert(iyear_mod,...
                time_aviso,ssh_total,sst_total,...
                nfiles,ht_estimate,ht_estimate_old,TreePredictInfo,file_big_model) ;
            ...
            elseif ilayer<=ilayer_depth_use_ssh
                ...
                file_big_model=[path_tree_junk,tree_model,'_model_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate]=bagged_yearly_tree_temp_vert(iyear_mod,...
                time_aviso,...
                nfiles,ht_estimate,ht_estimate_old,TreePredictInfo,file_big_model) ;
