function []=make_model_stats_yearly_anom_orca_sal_nosst_nossh_noEN4_floor(TreeSetUp)
    ...
    for iyear_mod=start_yearly_maps:.5:end_yearly_maps
        ...
        for ibasin=1:nbasin
            ...
            if ~isempty(Mdl)
                ...
                %             xlabel('Predictors');
                %             h = gca;
                PredictorNames={'Year' 'Lon' 'Lat' 'Temp'};
...
file_stats=[path_new_tree,tree_model_file_name,'_all_stats_split_noEN4_floor.mat'];
