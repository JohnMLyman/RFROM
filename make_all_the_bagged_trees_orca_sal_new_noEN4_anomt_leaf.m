...
tree_prefix='tree_sal_vert_nosshsst_newcycle';
tree_prefix_temp='tree_temp_vert_nosshsst_newcycle';
path_mat_nc='D:\monthly_temp\';
path_ERDDAP='H:\erddap_filt_anomt_leaf\sal_vert';
path_ERDDAP_sal=path_ERDDAP;
path_ERDDAP_temp='H:\erddap_filt\temp_vert';
...
file_name_season_anom=[file_name_season,'_anom_anomt_leaf'];
...
file_name_basin_coverage=[path_tree,var_type,'data_new_layers_noEN4_',file_WOD_suf,'_',file_name_season,'_basin_coverage.mat'];
...
'baggedtree_yearly_overlap_seasonal_anom_orca_sal_anomt_leaf'
baggedtree_yearly_overlap_seasonal_anom_orca_sal_anomt_leaf(TreeSetUp)
toc./60./60
...
% % % baggedtree_all_year_orca_sal_newcycle(TreeSetUp)
% % % toc./60./60
% % % 
% % % 'read_ssh_matfiles_all_years_orca_vert_sal_newcycle'
% % % read_ssh_matfiles_all_years_orca_vert_sal_newcycle(TreeSetUp)
% % % 
% % % toc./60./60
% % % 
% % % 'read_ssh_matfiles_all_years_orca_vert_sal_newcycle_extra'
% % % read_ssh_matfiles_all_years_orca_vert_sal_newcycle_extra(TreeSetUp)
% % % toc./60./60
% % % 
...
'loess_sal_errdap'
loess_sal_errdap(TreeSetUp)
toc./60./60
%%
'stablize_t_and_sl_errdap'
