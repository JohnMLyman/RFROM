function []=read_ssh_matfiles_all_years_seasonal_anom_split_orca22_sal(TreeSetUp)
load_TreeSetUp
%%
...
min_split_year=floor(start_all_year):2:floor(end_all_year);
nsplit=length(min_split_year);

% mid_all_year=start_all_year+5;
...
%         if isplit ==1
%             min_tpx_year=floor(start_all_year);
%             max_tpx_year=min_tpx_year+1;
%         else
            min_tpx_year=min_split_year(isplit);
            if min_tpx_year ~=end_all_year
                max_tpx_year=min_tpx_year+1;
            else
                max_tpx_year=min_year_fit;
            end
%         end
...
%          
%              if isplit==1
%                 good_split_1=time_aviso<=floor(mid_all_year)+.5;
%                 ht_estimate=ht_estimate(:,:,good_split_1);
%                 time_aviso=time_aviso(good_split_1);
                 parsave_tree ([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat'] ,ht_estimate,lon_tpx, lat_tpx,time_aviso)      
% 
%                 save ([path_tree_junk,tree_file_name,'_split_7day_junk.mat'] ,'ht_estimate','lon_tpx', 'lat_tpx','time_aviso','-v7.3')
%             else
% 
%                 good_split_2=time_aviso>floor(mid_all_year)+.5;
%                 
...
%                  [ht_estimate,time_aviso]=parload_tree([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat'] );
...
%                 parsave_tree([path_new_tree_season,tree_file_name,'_split_7day.mat'],ht_estimate,lon_tpx, lat_tpx,time_aviso)
%                 
...
'all done saving '
  ...
  parfor ilayer=2:nlayer %can only do 10  at a time
...
%                  load([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat'] ,'ht_estimate','lon_tpx', 'lat_tpx','time_aviso')   
                 [ht_estimate,time_aviso,lat_tpx,lon_tpx]=parload_tree_all([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat']);
                 pardelete_tree([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat'])
%                 save ([path_tree_junk,tree_file_name,'_split_7day_junk.mat'] ,'ht_estimate','lon_tpx', 'lat_tpx','time_aviso','-v7.3')
            else
...
%                 ht_estimate_end=ht_estimate;
%                 time_aviso_end=time_aviso;
%                 load([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat'] ,'ht_estimate','time_aviso')     
                 [ht_estimate_end,time_aviso_end,lat_tpx,lon_tpx]=parload_tree_all([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat']);
                 pardelete_tree([path_tree_junk,tree_file_name,num2str(isplit),'_split_7day_junk.mat'])
                ht_estimate=cat(3,ht_estimate,ht_estimate_end);
                time_aviso=cat(2,time_aviso,time_aviso_end);
...
function [ht_estimate,time_aviso,lat_tpx,lon_tpx]=parload_tree_all(filename)
