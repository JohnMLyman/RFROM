...
%%
save([path_figs,'tree_gilson_ceres_rate.mat'],'toa_qu_all',"toa_yearly",'cycle_toa',...
...
% corr(toa_gilson(plot_pos_gilson_year),gilson_rate_year_no_cycle(plot_pos_gilson_year))
 ...
 eval(['print -dpng -r600 -f1 ',path_figs,'toa_tree_gilson_ceres2_loess'])
%% yearly
...
import mlreportgen.dom.*
mltableObj = MATLABTable(mltable);
d = Document([path_figs,'RG_corr_table_loess_fixed'],'docx');
append(d,mltableObj);
close(d);
% rptview(d);
