function [model_all]=baggedtree_hold_out_all_years_orca_vert_nosshsst_sal(use,ht_use,temp_use,ht_perdict,coords,yr,nbasins_use,good_yr,good_prof,large_scale)
