function read_ssh_matfiles_all_years_orca_novert_extra_fast(TreeSetUp)
...
parfor year_load=time_ssh_load
    ...
    for ilayer=2:nlayer
        ...
        if ilayer<=ilayer_depth_use_sst
            ...
            [ht_estimate_m]=bagged_yearly_tree_temp_SSH_SST_fast(iyear_mod,...
            ...
            ht_estimate=ht_estimate_m.*weight_d+ht_estimate;
             ...
             file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name];
            [ht_estimate_m]=bagged_yearly_tree_temp_SSH_fast(iyear_mod,...
