function [TreeSetUp]=TreeSetUp_2023_orca_heat_novert_test_paige
nbasins_use=[1:10];
nbasins_use_extra_all_years=[4,6:10];
% file_name='argo_2021_02_02_QC';
data_type='ARGO';
file_name='argo_2024_1_02_QC';
OUTOUT_type='OCO_2023_novert';% could change to 'Karina_2023'
...
max_year_fit=2019;% keep these away from the ends of start_year_mean and end_year mean wo theat you have overlaping years to compute the mean from.
min_year_fit=2010;
