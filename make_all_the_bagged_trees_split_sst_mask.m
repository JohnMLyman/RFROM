...
% 
% make_bagged_tree_ohca_maps_7_day_seasonal_split_mask(TreeSetUp)
% 
% % % % % % make the curve
% 
% bagged_tree_ohca_curve_7_day_with_cycle_combined_split_mask(TreeSetUp)

bagged_tree_ohca_curve_7_day_with_cycle_combined_split_mask_max(TreeSetUp)