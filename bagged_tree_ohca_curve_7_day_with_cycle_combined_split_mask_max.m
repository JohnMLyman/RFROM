function bagged_tree_ohca_curve_7_day_with_cycle_combined_split_mask_max(TreeSetUp)
min_layer=0;
max_layer=2000;
...
for ioff=[50]
    ...
    curve_name=['curve_',tree_prefix,'_0_2000_split_mask_max_',num2str(ioff),'.mat'];
