...
% % % oco_maps_2023_orca_seasonal_heat_karina
% % % 
% % % clearvars
...
% file_name='argo_2024_1_02_QC_karina';
% OUTOUT_type='OCO_2023_karina';% could change to 'Karina_2023'
% 
% path_oisst='D:\oisst\';
...
% var_type='h';
% tree_prefix='tree_heat_vert_karina';% change to 'tree_heat_vert_Karina' if you change the layers
% 
% % tree_prefix='tree_temp_vert_nosshsst';
% path_ERDDAP='H:\erddap\heat_vert';
% path_Figs='H:\Figs\OHC\';
% path_Fig_data='H:\Figs\OHC\data\';
% 
...
% must run multi_write_erddap_file_withcycle(TreeSetUp) first.  It makes
% the netcdffiles that mean is comuted from.
multi_write_erddap_file_withcycle_nomean_v2_realtime(TreeSetUp) 
toc./60./60


'make_1x1xmonth_files_v2'
make_1x1xmonth_files_v2(TreeSetUp)
toc./60./60


% makes the files to send to Karina at the WMO
' karina_wmo_60S_60N_files_2023_orca'
 karina_wmo_60S_60N_files_2023_orca(TreeSetUp)
 toc./60./60
