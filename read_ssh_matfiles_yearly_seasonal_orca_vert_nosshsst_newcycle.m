function read_ssh_matfiles_yearly_seasonal_orca_vert_nosshsst_newcycle(TreeSetUp)
    ...
    for ilayer=2:nlayer
        ...
        for iyear_mod=start_year_mod:.5:end_year_mod
            ...
            if ilayer==2
                ...
                [ht_estimate_a]=bagged_yearly_tree_temp_SSH_SST(iyear_mod,...
                ...
                [ht_estimate_b]=bagged_yearly_tree_temp_SSH_SST(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                ...
                [ht_estimate_c]=bagged_yearly_tree_temp_SSH_SST(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                ...
                [ht_estimate_d]=bagged_yearly_tree_temp_SSH_SST(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                    nfiles,ht_estimate_d,TreePredictInfo,file_big_model,'d') ;

            elseif ilayer<=ilayer_depth_use_sst
                 file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_a]=bagged_yearly_tree_temp_SSH_SST_vert(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                    nfiles,ht_estimate_a,ht_estimate_old,TreePredictInfo,file_big_model,'a') ;
                
                file_big_model=[path_tree_junk,tree_model,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_b]=bagged_yearly_tree_temp_SSH_SST_vert(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                    nfiles,ht_estimate_b,ht_estimate_old,TreePredictInfo,file_big_model,'b') ;
                
                file_big_model=[path_tree_junk,tree_model,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_c]=bagged_yearly_tree_temp_SSH_SST_vert(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                    nfiles,ht_estimate_c,ht_estimate_old,TreePredictInfo,file_big_model,'c') ;
                
                file_big_model=[path_tree_junk,tree_model,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_d]=bagged_yearly_tree_temp_SSH_SST_vert(iyear_mod,...
                    time_aviso,ssh_total,sst_total,...
                    nfiles,ht_estimate_d,ht_estimate_old,TreePredictInfo,file_big_model,'d') ;

            elseif ilayer<=ilayer_depth_use_ssh
                file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_a]=bagged_yearly_tree_temp_SSH_vert(iyear_mod,...
                    time_aviso,ssh_total,...
                    nfiles,ht_estimate_a,ht_estimate_old,TreePredictInfo,file_big_model,'a') ;
                    
                file_big_model=[path_tree_junk,tree_model,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_b]=bagged_yearly_tree_temp_SSH_vert(iyear_mod,...
                    time_aviso,ssh_total,...
                    nfiles,ht_estimate_b,ht_estimate_old,TreePredictInfo,file_big_model,'b') ;
                
                file_big_model=[path_tree_junk,tree_model,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_c]=bagged_yearly_tree_temp_SSH_vert(iyear_mod,...
                    time_aviso,ssh_total,...
                    nfiles,ht_estimate_c,ht_estimate_old,TreePredictInfo,file_big_model,'c') ;
                
                file_big_model=[path_tree_junk,tree_model,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_d]=bagged_yearly_tree_temp_SSH_vert(iyear_mod,...
                    time_aviso,ssh_total,...
                    nfiles,ht_estimate_d,ht_estimate_old,TreePredictInfo,file_big_model,'d') ;
                ...
                file_big_model=[path_tree_junk,tree_model,'_model_a_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_a]=bagged_yearly_tree_temp_vert(iyear_mod,...
                    time_aviso,...
                    nfiles,ht_estimate_a,ht_estimate_old,TreePredictInfo,file_big_model,'a') ;

                file_big_model=[path_tree_junk,tree_model,'_model_b_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_b]=bagged_yearly_tree_temp_vert(iyear_mod,...
                    time_aviso,...
                    nfiles,ht_estimate_b,ht_estimate_old,TreePredictInfo,file_big_model,'b') ;
                    
                file_big_model=[path_tree_junk,tree_model,'_model_c_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_c]=bagged_yearly_tree_temp_vert(iyear_mod,...
                    time_aviso,...
                    nfiles,ht_estimate_c,ht_estimate_old,TreePredictInfo,file_big_model,'c') ;
                
                file_big_model=[path_tree_junk,tree_model,'_model_d_',layer_name,'_',year_file_name,'_split.mat'];
                [ht_estimate_d]=bagged_yearly_tree_temp_vert(iyear_mod,...
                    time_aviso,...
                    nfiles,ht_estimate_d,ht_estimate_old,TreePredictInfo,file_big_model,'d') ;
